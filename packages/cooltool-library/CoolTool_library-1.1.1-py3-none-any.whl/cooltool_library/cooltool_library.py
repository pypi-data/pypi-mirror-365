...
class CTl:
    ...
    @property
    def _letter_collection():
        _letter_collection = ["a", "b", "c", "d", "e", "f", "g", "h", "i",
                                   "j", "k", "l", "m", "n", "o", "p", "q", "r",
                                     "s", "t", "u", "v", "w", "x", "y", "z"]
        return _letter_collection
        ...
        if type == "letter":
            while True:
                try:
                    ...
                    dict_final = {}
                    letter_collection = CTl._letter_collection
    ...
    def generate_password(
        ...
        if "letter" in ammissed_character_type:
            available_chars.extend(CTl._letter_collection)
