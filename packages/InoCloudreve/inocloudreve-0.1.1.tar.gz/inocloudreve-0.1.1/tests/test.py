...
async def main():
    ...
    upload_file_result = await client.upload_file(
        ...
        remote_path=f"Spark/test/test23.zip",
        storage_policy="O8cN"
    )
    print("upload_file_result:", upload_file_result)

    #master_key = ""
