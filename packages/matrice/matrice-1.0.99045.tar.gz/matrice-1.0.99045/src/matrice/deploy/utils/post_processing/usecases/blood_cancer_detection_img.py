...
class BloodCancerDetectionUseCase(BaseProcessor):
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: BloodCancerDetectionConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "blood_cancer_detection System",
    ...
    def _check_alerts(self, summary: dict, config: BloodCancerDetectionConfig) -> List[Dict]:
        """
