...
class FaceEmotionUseCase(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.CASE_TYPE: Optional[str] = 'general'
        self.CASE_VERSION: Optional[str] = '1.3'

        # List of  categories to track
        self.target_categories = ['angry', 'happy', 'sad', 'surprised']
    ...
    def _generate_business_analytics(self, counting_summary: Dict, zone_analysis: Dict, config: FaceEmotionConfig, stream_info: Optional[Dict[str, Any]] = None, is_empty=False) -> List[Dict]:
