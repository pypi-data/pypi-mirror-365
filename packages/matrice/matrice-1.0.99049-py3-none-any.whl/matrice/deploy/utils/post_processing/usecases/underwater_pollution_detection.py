...
class UnderwaterPlasticUseCase(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.CASE_TYPE: Optional[str] = 'environmental'
    ...
    def _generate_business_analytics(self, counting_summary: Dict, zone_analysis: Dict, config: UnderwaterPlasticConfig, stream_info: Optional[Dict[str, Any]] = None, is_empty=False) -> List[Dict]:
