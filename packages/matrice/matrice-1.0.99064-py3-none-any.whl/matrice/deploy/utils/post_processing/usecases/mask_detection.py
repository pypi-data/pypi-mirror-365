...
class MaskDetectionUseCase(BaseProcessor):
    ...
    def _generate_business_analytics(self, counting_summary: Dict, zone_analysis: Dict, config: MaskDetectionConfig, stream_info: Optional[Dict[str, Any]] = None, is_empty=False) -> List[Dict]:
