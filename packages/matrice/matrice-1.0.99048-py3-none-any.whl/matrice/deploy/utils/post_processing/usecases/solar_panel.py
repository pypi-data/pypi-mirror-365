...
class SolarPanelUseCase(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.CASE_TYPE: Optional[str] = 'solar_panel_detection'
    ...
    def _generate_business_analytics(self, counting_summary: Dict, zone_analysis: Dict, config: SolarPanelConfig, stream_info: Optional[Dict[str, Any]] = None, is_empty=False) -> List[Dict]:
