...
class WindmillMaintenanceUseCase(BaseProcessor):
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: WindmillMaintenanceConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "windmill maintenance System",
    ...
    def _generate_insights(self, summary: dict, config: WindmillMaintenanceConfig) -> List[str]:
        """
    ...
    def _check_alerts(self, summary: dict, config: WindmillMaintenanceConfig) -> List[Dict]:
        """
