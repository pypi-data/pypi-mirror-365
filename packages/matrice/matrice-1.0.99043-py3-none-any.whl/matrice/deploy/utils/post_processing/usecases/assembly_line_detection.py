...
class AssemblyLineUseCase(BaseProcessor):
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: AssemblyLineConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "Assembly Line Detection System",
        ...
        for alert in alerts:
            ...
            alert_event = {
                ...
                "application_name": "Assembly Line Alert System",
    ...
    CATEGORY_DISPLAY = {
        ...
        "metal-plate-empty": "Metal Plate Empty",
        "robot-arms": "Robot Arms",
        "robot-arms-3": "Robot Arms 3"
    }

    def _generate_insights(self, summary: dict, config: AssemblyLineConfig) -> List[str]:
        """
    ...
    def _check_alerts(self, summary: dict, config: AssemblyLineConfig) -> List[Dict]:
        """
