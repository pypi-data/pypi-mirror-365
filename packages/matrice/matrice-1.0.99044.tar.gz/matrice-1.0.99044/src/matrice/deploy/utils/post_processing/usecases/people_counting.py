...
class PeopleCountingUseCase(BaseProcessor):
    ...
    def _process_frame_detections(self, frame_data: Any, config: PeopleCountingConfig, frame_id: str, stream_info: Optional[Dict[str, Any]] = None) -> tuple:
        ...
        summary = self._generate_summary(counting_summary, zone_analysis, alerts, frame_id, stream_info)
    ...
    def _generate_business_analytics(self, counting_summary: Dict, zone_analysis: Dict, config: PeopleCountingConfig, stream_info: Optional[Dict[str, Any]] = None, is_empty=True) -> List[Dict]:
