...
class MaskDetectionUseCase(BaseProcessor):
    ...
    def _generate_incidents(self, counting_summary: Dict, alerts: List, config: MaskDetectionConfig,
        ...
        if total_detections > 0:
            ...
            event= self.create_incident(incident_id=self.CASE_TYPE+'_'+str(frame_number), incident_type=self.CASE_TYPE,
                       severity_level=level, human_text=human_text, alerts=alerts, alert_settings=alert_settings,
    ...
    def _generate_tracking_stats(
        ...
        tracking_stat=self.create_tracking_stats(total_counts=total_counts, current_counts=current_counts,
                             detections=detections, human_text=human_text, alerts=alerts, alert_settings=alert_settings,
    ...
    def _generate_business_analytics(self, counting_summary: Dict, alerts: Any, config: MaskDetectionConfig,
                        frame_number: Optional[int] = None, stream_info: Optional[Dict[str, Any]] = None) -> List[Dict]:
        """Generate structured Business Analytics for the output format with frame-based keys."""
        ...
        #                          human_text, alerts=alerts, alert_settings=alert_settings,
        #                          reset_settings)
        return []
