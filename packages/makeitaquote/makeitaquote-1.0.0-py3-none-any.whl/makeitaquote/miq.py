...
class MiQ:
    """
    The MiQ class for creating Discord-style quote images.
    """
    ...
    def set_from_message(self, message: Any, format_text: bool = False) -> 'MiQ':
        """Set properties from Discord message object."""
    ...
    def generate(self, return_raw_image: bool = False) -> Union[str, bytes]:
        ...
        try:
            if return_raw_image:
                response = requests.post(API_URL, json=self.format)
