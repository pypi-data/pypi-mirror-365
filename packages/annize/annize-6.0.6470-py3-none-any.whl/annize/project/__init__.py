...
class Project:  # TODO remove/rename?! what is it for?!
    """
    An Annize project.
    ...
    def __init__(self, node: "ProjectNode", annize_config_rootpath: hallyd.fs.TInputPath):
        ...
        Load a project with :py:mod:`annize.project.loader`. Create a fresh project with TODO.
        """
        self.__node = node
    ...
    def create_new(project_root_path: hallyd.fs.TInputPath, subdirectory_name: str = "-meta") -> "Project":
        ...
        annize_config_root_directory("project.xml").write_text(
            ...
            f'<a:project xmlns:a="annize" xmlns:base="annize:base">\n'
            f'    <base:Data project_name="{project_root_path.name}"/>\n'
            f'</a:project>\n')
