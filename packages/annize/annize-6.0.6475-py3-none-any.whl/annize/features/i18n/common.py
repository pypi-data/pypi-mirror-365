...
class _ProjectDefinedTranslationProvider(annize.i18n.TranslationProvider):
    ...
    def translate(self, string_name, *, culture):
        return self.__translations_for_string_name(string_name).get(culture.iso_639_1_lang_code)
...
class Culture(annize.i18n.Culture):
    ...
    def __init__(self, *, iso_639_1_lang_code: str, subcode: str|None,
        ...
        # TODO weird
        TODO = annize.i18n.culture_by_spec(iso_639_1_lang_code).english_lang_name  # TODO subcode
