...
class DocumentGenerateAllCulturesResult(DocumentGenerateResult):
    ...
    @property
    def languages(self) -> list[str]:#TODO culture
...
class Document(abc.ABC):
    ...
    @abc.abstractmethod
    def available_cultures(self) -> list[annize.i18n.Culture]:
        pass
    ...
    @abc.abstractmethod
    def generate_all_cultures(self, outputspec) -> DocumentGenerateAllCulturesResult:
        pass
...
class GeneratedDocument(annize.fs.FilesystemContent):
    ...
    def __init__(self, *, document: Document, outputspec: OutputSpec, culture: annize.i18n.Culture|None,
                 filename: str|None):
