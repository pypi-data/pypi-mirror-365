...
class TrStr(abc.ABC):
    ...
    def translate(self, culture: TCultureSpec = None) -> str:
        ...
        for culture in culture_by_spec(culture).culture_list():
            result = self.get_variant(culture) if (not isinstance(culture, IdCulture)) else self.string_name  # TODO
...
class Culture:
    ...
    def __set_system_locale_setup(system_locale_setup: "_TSystemLocaleSetup") -> None:
        Culture.__set_env__var("LC_ALL", system_locale_setup.LC_ALL)  # TODO yyy env
...
class UnspecifiedCulture(Culture):
    ...
    def __init__(self):
        super().__init__(english_lang_name="Unspecified", iso_639_1_language_code="", region_code=None, fallback_cultures=())
...
class IdCulture(Culture):
    ...
    def __init__(self):
        super().__init__(english_lang_name="IDs", iso_639_1_language_code="", region_code=None, fallback_cultures=())
