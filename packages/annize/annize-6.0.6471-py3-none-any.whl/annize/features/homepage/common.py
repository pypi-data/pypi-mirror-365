...
class Homepage:
    ...
    def generate(self):
        ...
        for culture in self.cultures:
            document_variant_directory = result(culture.fullname)
            with culture:
        ...
        outputspec = annize.features.documentation.sphinx.output.html.HtmlOutputSpec(short_desc=self.short_desc,
                                                                                     is_homepage=True)
        doc.generate_all_cultures(outputspec).file.path().move_to(result, merge=True)
