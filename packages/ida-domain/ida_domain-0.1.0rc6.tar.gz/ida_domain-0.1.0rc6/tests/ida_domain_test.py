...
def test_hooks():
    ...
    class CustomProcHooks(hooks.ProcessorHooks):
        def __init__(self):
            super().__init__()

    class CustomUIHooks(hooks.UIHooks):
        def __init__(self):
            super().__init__()

    class CustomViewHooks(hooks.ViewHooks):
        def __init__(self):
            super().__init__()

    class CustomDecompHooks(hooks.DecompilerHooks):
        def __init__(self):
            super().__init__()

    class CustomDatabaseHooks(hooks.DatabaseHooks):
        def __init__(self):
            super().__init__()
            self.count = 0
    ...
    proc_hook = CustomProcHooks()
    ui_hook = CustomUIHooks()
    view_hook = CustomViewHooks()
    decomp_hook = CustomDecompHooks()
    custom_hook1 = CustomDatabaseHooks()
    custom_hook2 = CustomDatabaseHooks()
