...
class Xrefs(DatabaseEntity):
    ...
    def get_to(self, ea: int, kind: XrefsKind = XrefsKind.ALL, flow: bool = True) -> Iterator[Any]:
        """
    ...
    def get_from(
        self, ea: int, kind: XrefsKind = XrefsKind.ALL, flow: bool = False
    ) -> Iterator[Any]:
        """
    ...
    def get_calls_to(self, ea: int) -> Iterator[Any]:
        """
    ...
    def get_calls_from(self, ea: int) -> Iterator[Any]:
        """
    ...
    def get_jumps_to(self, ea: int) -> Iterator[Any]:
        """
    ...
    def get_jumps_from(self, ea: int) -> Iterator[Any]:
        """
    ...
    def get_data_reads_of(self, ea: int) -> Iterator[Any]:
        """
    ...
    def get_data_writes_to(self, ea: int) -> Iterator[Any]:
        """
