...
class StarGiftUnique(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "title", "slug", "num", "attributes", "availability_issued", "availability_total", "require_premium", "owner_id", "owner_name", "owner_address", "gift_address", "resell_stars", "released_by"]

    ID = 0xf63778ae
    QUALNAME = "types.StarGiftUnique"

    def __init__(self, *, id: int, title: str, slug: str, num: int, attributes: List["raw.base.StarGiftAttribute"], availability_issued: int, availability_total: int, require_premium: Optional[bool] = None, owner_id: "raw.base.Peer" = None, owner_name: Optional[str] = None, owner_address: Optional[str] = None, gift_address: Optional[str] = None, resell_stars: Optional[int] = None, released_by: "raw.base.Peer" = None) -> None:
        self.id = id  # long
