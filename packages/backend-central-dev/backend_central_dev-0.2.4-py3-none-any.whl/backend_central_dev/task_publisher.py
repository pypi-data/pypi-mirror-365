...
class TaskAndPipelineManager():
    ...
    def tell_executor_to_execute_task(self, task_execution, pipeline_ticket=None, pipeline_execution=None):
        self.task_publisher.mondb.update_one(Mongo.task_execution_col, {
            TaskExecution.task_ticket: task_execution[TaskExecution.task_ticket]
        }, {
            "$set": {
        ...
        if pipeline_ticket is not None and pipeline_execution is None:
