...
class ContextPortalHook:
    ...
    def should_process(self, tool_name: str, tool_input: dict[str, Any]) -> bool:  # noqa: ARG002
    ...
    try:
        ...
        if hook.should_process(tool_name, tool_input):
            ...
            if transformed:
                ...
                print(
                    f"Context Portal: Enhanced {tool_name} with context history",
                    file=sys.stderr,
                )
