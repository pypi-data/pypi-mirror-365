...
class HealthApi(object):
    ...
    def health_get_0(self, **kwargs):  # noqa: E501
        """/health  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.health_get_0(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.health_get_0_with_http_info(**kwargs)  # noqa: E501

    def health_get_0_with_http_info(self, **kwargs):  # noqa: E501
        """/health  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.health_get_0_with_http_info(async_req=True)
        >>> result = thread.get()
