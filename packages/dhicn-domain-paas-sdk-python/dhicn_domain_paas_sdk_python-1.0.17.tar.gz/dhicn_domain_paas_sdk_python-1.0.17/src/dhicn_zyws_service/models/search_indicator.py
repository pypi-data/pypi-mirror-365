...
class SearchIndicator(object):
    ...
    def __init__(self, is_search_measure=None, is_search_simul=None, indicator=None, label=None, show_name=None, unit=None, library_id=None, device_code=None, local_vars_configuration=None):  # noqa: E501
