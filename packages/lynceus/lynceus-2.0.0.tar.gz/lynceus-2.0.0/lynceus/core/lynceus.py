...
class LynceusSession:
    ...
    def get_config(self, section: str, key: str, *, default: str | int | float | object | list = LynceusConfig.UNDEFINED_VALUE) -> str | int | float | object | list:
        """
        ...
        Returns
        -------
        str or int or float or object or list
