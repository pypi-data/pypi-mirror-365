...
class TestVirtualExpertPanel:
    ...
    async def test_solve_problem_basic(self, virtual_panel):
        ...
        with patch.object(
            ...
            mock_decision.return_value = OrchestratorDecision(
...
class TestGraphRAGEnhancedKnowledge:
    ...
    async def test_query_enhanced_knowledge_success(self, virtual_panel_with_graphrag):
        ...
        result = await virtual_panel_with_graphrag._query_enhanced_knowledge("test query")
    ...
    @pytest.mark.asyncio
    async def test_query_enhanced_knowledge_error_response(self, virtual_panel_with_graphrag):
    ...
    @pytest.mark.asyncio
    async def test_query_enhanced_knowledge_exception_handling(self, virtual_panel_with_graphrag):
    ...
    @pytest.mark.asyncio
    async def test_query_enhanced_knowledge_error_patterns(self, virtual_panel_with_graphrag):
        ...
        for error_response in error_responses:
            ...
            assert result == "Legacy knowledge summary", f"Failed for error: {error_response}"

    @pytest.mark.asyncio
    async def test_query_enhanced_knowledge_empty_response(self, virtual_panel_with_graphrag):
