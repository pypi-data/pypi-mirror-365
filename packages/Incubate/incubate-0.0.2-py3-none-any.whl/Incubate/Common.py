...
class Config :
    ...
    Proctitle = dict(
        Main = 'Incubate' ,
        Main_Http = 'Incubate.Http' ,
        Main_Http_Server = 'Incubate.Http.Server' ,
        Main_Http_Worker = 'Incubate.Http.Worker' ,
        Main_Websocket = 'Incubate.Websocket' ,
        Main_Websocket_Server = 'Incubate.Websocket.Server' ,
        Main_Websocket_Worker = 'Incubate.Websocket.Worker' ,
        Main_Journal = 'Incubate.Journal' ,
        Main_Resource = 'Incubate.Resource' ,
    );
    Http = dict(
        Status = True ,
        Journal = True ,
