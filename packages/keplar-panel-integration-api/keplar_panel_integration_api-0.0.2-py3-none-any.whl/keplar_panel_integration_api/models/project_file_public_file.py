...
class ProjectFilePublicFile(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "mimeType", "publicUrl", "publicUrlExpiresAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectFilePublicFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectFilePublicFile from a dict"""
        if obj is None:
            return None
