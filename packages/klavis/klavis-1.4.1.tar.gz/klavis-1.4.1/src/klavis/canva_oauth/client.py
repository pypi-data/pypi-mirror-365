...
from ..types.canva_o_auth_success_response import CanvaOAuthSuccessResponse
...
class CanvaOauthClient:
    ...
    def canva_o_auth_callback(
        ...
        *,
        ...
        """
        _response = self._raw_client.canva_o_auth_callback(
    ...
    def refresh_canva_token(
        ...
        """
        _response = self._raw_client.refresh_canva_token(instance_id=instance_id, request_options=request_options)
        return _response.data
...
class AsyncCanvaOauthClient:
    ...
    async def canva_o_auth_callback(
        self,
        *,
        code: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.canva_oauth.canva_o_auth_callback()


        asyncio.run(main())
        """
        _response = await self._raw_client.canva_o_auth_callback(
            code=code, state=state, error=error, error_description=error_description, request_options=request_options
        )
        return _response.data
    ...
    async def refresh_canva_token(
        ...
        async def main() -> None:
            await client.canva_oauth.refresh_canva_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_canva_token(instance_id=instance_id, request_options=request_options)
        return _response.data
