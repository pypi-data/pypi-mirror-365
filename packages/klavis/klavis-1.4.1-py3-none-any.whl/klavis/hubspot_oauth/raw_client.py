...
class RawHubspotOauthClient:
    ...
    ) -> HttpResponse[HubSpotOAuthSuccessResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=HubSpotOAuthSuccessResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawHubspotOauthClient:
    ...
    async def refresh_hubspot_token(
        self, *, instance_id: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[HubSpotOAuthSuccessResponse]:
        """
        Refresh an expired HubSpot access token using the stored refresh token
