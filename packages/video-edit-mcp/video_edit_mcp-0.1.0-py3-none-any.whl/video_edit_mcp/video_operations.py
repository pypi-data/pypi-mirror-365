...
def register_video_tools(mcp):
    ...
    @mcp.tool(description="Use this tool for resizing the video make sure first whether video needs to be saved directly or just object has to be returned for further processing")
    def resize_video(video_path: str, size: Tuple[int, int], output_name: str, return_path: bool) -> Dict[str, Any]:
        try:
            ...
            output_path = get_output_path(output_name)
            video = VideoStore.load(video_path)
            resized_video = resize(video, size)
    ...
    @mcp.tool(description="Use this tool for cropping the video")
    ...
    @mcp.tool(description="Use this tool for rotating the video, and make sure to provide output name like rotated_video.mp4 , some_hello.mp4 etc. don't pass path just give meaningful names based on video info")
    ...
    @mcp.tool(description="Use this tool for speed up the video, and make sure to provide output name like speed_up_video.mp4 , some_hello.mp4 etc. don't pass path just give meaningful names based on video info")
    ...
    @mcp.tool(description="Use this tool for adding audio to the video , and make sure to provide output file name like added_audio.mp4 etc. make sure mp4 extension is provided and name should be meaningful")
    ...
    @mcp.tool(description="Use this tool for adding fade in effect to video, provide fade_duration in seconds, and output name like fadein_video.mp4")
    ...
    @mcp.tool(description="Use this tool for adding fade out effect to video, provide fade_duration in seconds, and output name like fadeout_video.mp4")
    ...
    @mcp.tool(description="Use this tool for adding text overlay to video, provide text, position coordinates (x,y), font_size, color, and output name")
    ...
    @mcp.tool(description="Use this tool for adding image watermark/overlay to video, provide image_path, position coordinates (x,y), and output name")
    ...
    @mcp.tool(description="Use this tool for converting video to grayscale/black and white, provide output name like grayscale_video.mp4")
    ...
    @mcp.tool(description="Use this tool for creating video from image sequence, provide folder path with images, fps, and output name")
    ...
    @mcp.tool(description="Use this tool for extracting frames from video as images, provide start_time, end_time, and fps for extraction")
    ...
    @mcp.tool(description="Use this tool for mirroring video horizontally, provide output name like mirrored_video.mp4")
    ...
    @mcp.tool(description="Use this tool for splitting video into multiple parts at specific timestamps, provide list of split times in seconds")
    ...
    @mcp.tool(description="Use this tool for converting video format with codec and quality control, provide codec, fps, bitrate")
    ...
    @mcp.tool(description="Use this tool for adding video overlay with transparency, provide overlay video, position, and opacity (0-1)")
