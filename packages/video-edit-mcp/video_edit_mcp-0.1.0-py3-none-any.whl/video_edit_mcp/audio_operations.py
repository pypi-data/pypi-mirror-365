...
def register_audio_tools(mcp):
    ...
    @mcp.tool(description="Use this tool for extracting audio from the video , and make sure only give output name like extracted_audio.mp3 , some_hello.mp3 etc.. don't pass path just give meaningful names based on audio info")
    ...
    @mcp.tool(description="Trim audio file, make sure to provide proper start and end time, and make sure to provide output name like trimmed_audio.mp3, some_hello.mp3 etc. don't pass path just give meaningful names based on audio info")
    ...
    @mcp.tool(description="Use this tool to concatenate two audios")
    ...
    @mcp.tool(description="Use this tool to loop the audio, after looping make sure to provide output name like looped_audio.mp3, some_hello.mp3 etc. don't pass path just give meaningful names based on audio info and also make sure to provide duration in seconds")
    ...
    @mcp.tool(description="Adjust volume of an audio")
    ...
    @mcp.tool(description="Use this tool for audio fade in effect, provide fade_duration in seconds, and output name like fadein_audio.mp3")
    ...
    @mcp.tool(description="Use this tool for audio fade out effect, provide fade_duration in seconds, and output name like fadeout_audio.mp3")
    ...
    @mcp.tool(description="Use this tool for mixing multiple audio tracks together, provide list of audio paths and output name")
