...
sample_rate:        {self.sample_rate / 1e6:.2f}       MHz, Baseband Sample Rate
    ...
    def tx_gain(self):
        ...
        """
        return int((self.tx_hardwaregain_chan0 + 70) / 40 * 100)
    ...
    def tx_gain(self, value):
        ...
        self.tx_hardwaregain_chan0 = -70 + (value / 100) * 40
    ...
    def rx_gain(self):
        ...
        """
        return int((self.rx_hardwaregain_chan0) / 40 * 100)
    ...
    def rx_gain(self, value):
        ...
        self.rx_hardwaregain_chan0 = (value / 100) * 40
