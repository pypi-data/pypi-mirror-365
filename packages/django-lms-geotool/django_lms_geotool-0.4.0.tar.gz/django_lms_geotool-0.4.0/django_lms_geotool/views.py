...
def convert_html(request):
    if request.method == "GET":
        context = {}
        return render(request, "geotool/convert.html", context=context)
...
def matrix_html(request):
    ...
    return render(request, "geotool/matrix.html", context=context)
...
def dimsum_html(request):
    if request.method == "GET":
        context = {}
        return render(request, "geotool/dimsum.html", context=context)
    elif request.method == "POST":
        input_choose = request.POST.get("input_choose")
        input_area = request.POST.get("input_area")
        input_list = input_area.split("\r\n")
...
def translation_html(request):
    if request.method == "GET":
        ...
        return render(request, "geotool/translation.html", context=context)
    elif request.method == "POST":
