...
class StateTracker:
    ...
    def get_phase_status(self, feature_name: str, phase: PhaseType) -> Optional[PhaseStatus]:
    ...
    def get_all_phase_statuses(self, feature_name: str) -> Optional[Dict[PhaseType, PhaseStatus]]:
    ...
    def get_completion_percentage(self, feature_name: str) -> float:
        ...
        completed_phases = sum(
            1 for status in workflow.phase_status.values()
    ...
    def record_approval(self, feature_name: str, phase: PhaseType, approved: bool) -> None:
    ...
    def get_approval_history(self, feature_name: str) -> List[Tuple[PhaseType, datetime, bool]]:
    ...
    def get_last_approval(self, feature_name: str, phase: PhaseType) -> Optional[Tuple[datetime, bool]]:
    ...
    def get_workflow_summary(self, feature_name: str) -> Optional[Dict]:
        ...
        return {
            ...
            'next_phase': self.get_next_phase(feature_name).value if self.get_next_phase(feature_name) else None,
            'previous_phase': self.get_previous_phase(feature_name).value if self.get_previous_phase(feature_name) else None,
        }
