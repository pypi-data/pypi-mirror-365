...
class HealthMonitor:
    ...
    async def perform_health_check(self) -> bool:
        ...
        try:
            ...
            self.metrics.validation_system_healthy = await self._check_validation_system()
            
            # Overall health
            self.metrics.is_healthy = (
                self.metrics.content_system_healthy and
                self.metrics.workflow_system_healthy and
    ...
    def get_health_report(self) -> Dict:
        ...
        return {
            ...
            "components": {
                "content_system": "healthy" if self.metrics.content_system_healthy else "unhealthy",
                "workflow_system": "healthy" if self.metrics.workflow_system_healthy else "unhealthy", 
                "validation_system": "healthy" if self.metrics.validation_system_healthy else "unhealthy",
            },
