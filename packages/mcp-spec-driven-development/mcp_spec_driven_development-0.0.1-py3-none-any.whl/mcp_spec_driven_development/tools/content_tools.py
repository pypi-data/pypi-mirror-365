...
class ContentAccessTools:
                    ...
                    "properties": {
                        "topic": {
                            ...
                            "enum": [
                                ...
                                "ears_format", "phase_transitions", "best_practices", "troubleshooting"
                            ],
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "category": {
                            "type": "string",
                            "enum": ["requirements", "design", "tasks", "validation", "pitfalls", "complete_specs"],
    ...
    async def handle_get_template(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(type="text", text=f"Error retrieving template: {str(e)}")]
    
    async def handle_get_methodology_guide(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(type="text", text=f"Error retrieving methodology guide: {str(e)}")]
    
    async def handle_list_available_content(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            if content_type in ["methodology", "all"]:
                available_guides = self.methodology_guides.list_available_guides(language)
                if language == "zh":
                    result["方法论主题"] = [guide.replace("-zh", "") for guide in available_guides]
                else:
            ...
            if content_type == "all":
                if language == "zh":
                    result["示例类别"] = [
                        "需求示例", "设计示例", "任务示例", "验证示例", "常见陷阱", "完整规范"
                    ]
                else:
                    result["examples_categories"] = [
                        "requirements", "design", "tasks", "validation", "pitfalls", "complete_specs"
                    ]
    ...
    async def handle_get_examples_and_case_studies(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(type="text", text=f"Error retrieving examples: {str(e)}")]
    
    def _get_examples_content(self, category: str, specific_topic: Optional[str] = None) -> str:
