...
from HDF5DataModel.Model.subclasses import Dataset, AcqTrace, AcqSig
...
class H5Widget(QWidget):
    ...
    def setup(self):
        ...
        self.widget.paramsLayout.addWidget(self.widget.paramsWidget)
    ...
    def load_files(self, files: str):
        for filename in files:
            if filename.endswith('.h5'):
                ...
                raise ValueError(f"{filename} is not a .h5 file")
