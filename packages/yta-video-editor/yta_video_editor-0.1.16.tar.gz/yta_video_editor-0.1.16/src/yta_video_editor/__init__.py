...
class _UseTransformFactor(ABC):
    ...
    def _validate_factor_type(
        ...
        """
        Check if the 'factor' provided is a number or
        a list of numbers and raise an exception if
        not.
        """
        if (
    ...
    def validate_and_process_transform_factor(
        ...
        The 'factor' provided must be a valid
        number or list of numbers and within the
        'limit' if this is also provided.
        """
...
class _Color(_UseTransformFactor):
    ...
    def temperature(
        ...
        - `[-50, 50]`
        """
        from yta_video_editor.change.transform import ColorTemperatureTransform

        # TODO: Why are we accepting 'list[int]' (?)
        # TODO: If this below works, remove the other code
        # because this instance allows us storing it as
        # part of effects to be applied all together at
        # the end
        return ColorTemperatureTransform(factor).apply(self.editor._video)
    ...
    def _apply_color_transform(
        ...
        *For internal use only*.
        ...
        Validate the 'factor' provided according to
        the 'limit' also provided, and call the
        'transform_fn'.
        """
