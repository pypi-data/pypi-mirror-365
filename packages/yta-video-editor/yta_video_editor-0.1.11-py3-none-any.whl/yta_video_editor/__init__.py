...
class VideoEditor:
    ...
    def process_test(
        ...
        self._video = self.video.with_subclip(0, 0.5)
        ...
        t_array = T.get_frame_time_moments(self.video.duration, self.video.fps)
        ...
        # TODO: To do this I have to wrap it, without
        # the 'position' parameter the 'put_video...'
        # method has
        put_video_over_black_background(self.video, lambda t: positions[T.frame_time_to_frame_index(t, self.video.fps)]).write_videofile(filename)
