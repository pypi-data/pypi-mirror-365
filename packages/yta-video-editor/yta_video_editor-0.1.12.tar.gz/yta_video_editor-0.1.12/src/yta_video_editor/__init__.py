    ...
    def process_test(
        ...
        class _SetPosition:
            ...
            def values(
                ...
                """
                The list of the positions in which the center
                of the video should be placed according to the
                'position' changer provider for all the 'ts'
                time frame moments of this instance.
                """
                return [
        ...
        ts = T.get_frame_time_moments(self.video.duration, self.video.fps)

        # This must exist if we want to change it
        video_position = _SetPosition(
            position = PositionChange(
        ...
        self._video = (
            video_position.apply_to_video(self.video)
            if video_position is not None else
            self._video
        )
