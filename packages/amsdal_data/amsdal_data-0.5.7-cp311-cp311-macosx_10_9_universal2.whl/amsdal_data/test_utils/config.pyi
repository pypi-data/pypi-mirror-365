...
@contextmanager
def postgres_config(lakehouse_database: str | None = None, state_database: str | None = None) -> Iterator[AmsdalConfig]: ...
@contextmanager
def postgres_async_config(lakehouse_database: str | None = None, state_database: str | None = None) -> Iterator[AmsdalConfig]: ...
@contextmanager
def postgres_lakehouse_only_config(lakehouse_database: str | None = None) -> Iterator[AmsdalConfig]: ...
@contextmanager
def postgres_async_lakehouse_only_config(lakehouse_database: str | None = None) -> Iterator[AmsdalConfig]: ...
