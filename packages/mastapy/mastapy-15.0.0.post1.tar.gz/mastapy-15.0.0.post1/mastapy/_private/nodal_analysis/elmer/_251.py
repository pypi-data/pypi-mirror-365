...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _252, _253
...
class _Cast_ElmerResults:
    ...
    def elmer_results_from_electromagnetic_analysis(
        self: "CastSelf",
    ) -> "_252.ElmerResultsFromElectromagneticAnalysis":
        from mastapy._private.nodal_analysis.elmer import _252

        return self.__parent__._cast(_252.ElmerResultsFromElectromagneticAnalysis)

    @property
    def elmer_results_from_mechanical_analysis(
        self: "CastSelf",
    ) -> "_253.ElmerResultsFromMechanicalAnalysis":
        from mastapy._private.nodal_analysis.elmer import _253

        return self.__parent__._cast(_253.ElmerResultsFromMechanicalAnalysis)
