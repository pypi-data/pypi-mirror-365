...
class ListWithSelectedItem_GearSet(_2769.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2769.GearSet.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2769.GearSet":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2769.GearSet]":
