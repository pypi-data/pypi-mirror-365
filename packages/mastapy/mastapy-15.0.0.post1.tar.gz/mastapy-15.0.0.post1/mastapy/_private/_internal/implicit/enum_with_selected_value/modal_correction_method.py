...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6078
...
class EnumWithSelectedValue_ModalCorrectionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _6078.ModalCorrectionMethod
        """
        return _6078.ModalCorrectionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6078.ModalCorrectionMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6078.ModalCorrectionMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6078.ModalCorrectionMethod]":
