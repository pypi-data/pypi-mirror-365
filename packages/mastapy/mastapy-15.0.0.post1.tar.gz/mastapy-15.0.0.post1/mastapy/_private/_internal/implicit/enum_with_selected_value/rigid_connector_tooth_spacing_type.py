...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2836.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2836.RigidConnectorToothSpacingType
        """
        return _2836.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2836.RigidConnectorToothSpacingType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2836.RigidConnectorToothSpacingType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2836.RigidConnectorToothSpacingType]":
