...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2595.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2595.ElectricMachineDataSet.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2595.ElectricMachineDataSet":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2595.ElectricMachineDataSet]":
