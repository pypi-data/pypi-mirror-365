...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _2106.BearingToleranceClass
        """
        return _2106.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2106.BearingToleranceClass.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2106.BearingToleranceClass":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2106.BearingToleranceClass]":
