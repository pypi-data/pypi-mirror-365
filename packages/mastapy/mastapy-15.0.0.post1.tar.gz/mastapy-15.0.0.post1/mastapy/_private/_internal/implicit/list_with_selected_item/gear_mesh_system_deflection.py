...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _3000.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _3000.GearMeshSystemDeflection.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_3000.GearMeshSystemDeflection":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_3000.GearMeshSystemDeflection]":
