...
class Overridable_HelicalGearMicroGeometryOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _601.HelicalGearMicroGeometryOption
        """
        return _601.HelicalGearMicroGeometryOption
    ...
    def implicit_type(cls: "Type[Overridable_HelicalGearMicroGeometryOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _601.HelicalGearMicroGeometryOption.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_601.HelicalGearMicroGeometryOption":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_601.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_601.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
