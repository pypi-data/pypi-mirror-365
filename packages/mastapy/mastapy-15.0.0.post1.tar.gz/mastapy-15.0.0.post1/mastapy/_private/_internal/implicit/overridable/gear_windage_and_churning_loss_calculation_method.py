...
class Overridable_GearWindageAndChurningLossCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[Overridable_GearWindageAndChurningLossCalculationMethod]",
    ) -> "_422.GearWindageAndChurningLossCalculationMethod":
        ...
        Returns:
            _422.GearWindageAndChurningLossCalculationMethod
        """
        return _422.GearWindageAndChurningLossCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _422.GearWindageAndChurningLossCalculationMethod.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_422.GearWindageAndChurningLossCalculationMethod":
