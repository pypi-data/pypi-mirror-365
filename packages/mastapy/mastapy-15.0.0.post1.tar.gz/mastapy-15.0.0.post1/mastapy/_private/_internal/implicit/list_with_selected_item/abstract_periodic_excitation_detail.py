...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5968.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5968.AbstractPeriodicExcitationDetail.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5968.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5968.AbstractPeriodicExcitationDetail]":
