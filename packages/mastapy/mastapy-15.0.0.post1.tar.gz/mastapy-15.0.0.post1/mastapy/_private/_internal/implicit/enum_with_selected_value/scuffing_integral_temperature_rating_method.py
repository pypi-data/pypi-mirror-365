...
class EnumWithSelectedValue_ScuffingIntegralTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _573.ScuffingIntegralTemperatureRatingMethod
        """
        return _573.ScuffingIntegralTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _573.ScuffingIntegralTemperatureRatingMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_573.ScuffingIntegralTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_573.ScuffingIntegralTemperatureRatingMethod]":
