...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _748.MicroGeometryDefinitionMethod
        """
        return _748.MicroGeometryDefinitionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _748.MicroGeometryDefinitionMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_748.MicroGeometryDefinitionMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_748.MicroGeometryDefinitionMethod]":
