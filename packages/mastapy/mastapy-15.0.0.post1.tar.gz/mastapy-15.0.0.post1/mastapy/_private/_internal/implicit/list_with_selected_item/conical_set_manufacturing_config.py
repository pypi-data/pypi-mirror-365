...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _894.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _894.ConicalSetManufacturingConfig.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_894.ConicalSetManufacturingConfig":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_894.ConicalSetManufacturingConfig]":
