...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7846.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7846.TorqueSpecificationForSystemDeflection
        """
        return _7846.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7846.TorqueSpecificationForSystemDeflection.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7846.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7846.TorqueSpecificationForSystemDeflection]":
