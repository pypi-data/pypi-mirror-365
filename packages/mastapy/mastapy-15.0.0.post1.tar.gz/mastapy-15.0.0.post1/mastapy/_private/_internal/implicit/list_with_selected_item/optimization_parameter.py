...
class ListWithSelectedItem_OptimizationParameter(
    _2444.OptimizationParameter, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_OptimizationParameter]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2444.OptimizationParameter.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2444.OptimizationParameter":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2444.OptimizationParameter]":
