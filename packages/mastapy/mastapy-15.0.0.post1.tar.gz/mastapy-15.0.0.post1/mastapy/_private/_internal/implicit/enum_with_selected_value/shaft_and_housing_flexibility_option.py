...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5769.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5769.ShaftAndHousingFlexibilityOption
        """
        return _5769.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5769.ShaftAndHousingFlexibilityOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5769.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5769.ShaftAndHousingFlexibilityOption]":
