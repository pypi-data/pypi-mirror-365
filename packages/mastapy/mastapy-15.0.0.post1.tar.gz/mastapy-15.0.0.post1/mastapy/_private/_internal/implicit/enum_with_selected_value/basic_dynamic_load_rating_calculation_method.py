...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_2073.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _2073.BasicDynamicLoadRatingCalculationMethod
        """
        return _2073.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2073.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2073.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2073.BasicDynamicLoadRatingCalculationMethod]":
