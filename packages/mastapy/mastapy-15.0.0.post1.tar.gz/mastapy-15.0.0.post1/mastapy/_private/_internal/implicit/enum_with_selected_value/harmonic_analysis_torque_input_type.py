...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_6059.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _6059.HarmonicAnalysisTorqueInputType
        """
        return _6059.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6059.HarmonicAnalysisTorqueInputType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6059.HarmonicAnalysisTorqueInputType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6059.HarmonicAnalysisTorqueInputType]":
