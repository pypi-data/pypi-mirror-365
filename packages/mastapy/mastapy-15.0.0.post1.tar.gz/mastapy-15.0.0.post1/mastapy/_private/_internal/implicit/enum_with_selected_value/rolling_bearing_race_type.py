...
from mastapy._private.bearings import _2098
...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2098.RollingBearingRaceType
        """
        return _2098.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2098.RollingBearingRaceType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2098.RollingBearingRaceType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2098.RollingBearingRaceType]":
