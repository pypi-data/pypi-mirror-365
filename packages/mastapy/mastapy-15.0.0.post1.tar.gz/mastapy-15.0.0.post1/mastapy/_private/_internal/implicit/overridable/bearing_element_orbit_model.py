...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5667.BearingElementOrbitModel":
        ...
        Returns:
            _5667.BearingElementOrbitModel
        """
        return _5667.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5667.BearingElementOrbitModel.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_5667.BearingElementOrbitModel":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_5667.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_5667.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
