...
class EnumWithSelectedValue_ElectricMachineAnalysisPeriod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ElectricMachineAnalysisPeriod]",
    ) -> "_249.ElectricMachineAnalysisPeriod":
        ...
        Returns:
            _249.ElectricMachineAnalysisPeriod
        """
        return _249.ElectricMachineAnalysisPeriod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _249.ElectricMachineAnalysisPeriod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_249.ElectricMachineAnalysisPeriod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_249.ElectricMachineAnalysisPeriod]":
