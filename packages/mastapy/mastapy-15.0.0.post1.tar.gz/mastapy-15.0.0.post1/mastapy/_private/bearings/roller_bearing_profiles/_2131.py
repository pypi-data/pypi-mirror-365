...
class ProfileSet(_0.APIBase):
    ...
    @property
    @exception_bridge
    def active_profile_type(self: "Self") -> "_2094.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2094", "RollerBearingProfileTypes"
        )(value)
    ...
    def active_profile_type(
        self: "Self", value: "_2094.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    @exception_bridge
    def active_profile(self: "Self") -> "_2141.RollerBearingProfile":
