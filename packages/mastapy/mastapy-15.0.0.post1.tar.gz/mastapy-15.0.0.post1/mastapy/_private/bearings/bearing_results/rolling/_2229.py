...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2232, _2237, _2241
...
class LoadedNeedleRollerBearingResults(_2217.LoadedCylindricalRollerBearingResults):
    """LoadedNeedleRollerBearingResults
