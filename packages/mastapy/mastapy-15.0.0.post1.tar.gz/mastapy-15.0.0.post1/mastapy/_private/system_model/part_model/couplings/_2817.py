...
class Clutch(_2823.Coupling):
    ...
    @property
    @exception_bridge
    def spring_type(self: "Self") -> "_5685.ClutchSpringType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5685",
            "ClutchSpringType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def spring_type(self: "Self", value: "_5685.ClutchSpringType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType",
        )
