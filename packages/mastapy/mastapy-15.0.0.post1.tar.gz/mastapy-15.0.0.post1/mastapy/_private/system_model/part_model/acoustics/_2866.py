...
class AcousticAnalysisOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def initial_guess(self: "Self") -> "_7663.InitialGuessOption":
    ...
    @exception_bridge
    @enforce_parameter_types
    def initial_guess(self: "Self", value: "_7663.InitialGuessOption") -> None:
    ...
    @property
    @exception_bridge
    def m2l_cache_type(self: "Self") -> "_7664.M2LHfCacheType":
    ...
    @exception_bridge
    @enforce_parameter_types
    def m2l_cache_type(self: "Self", value: "_7664.M2LHfCacheType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.M2LHfCacheType",
        )
    ...
    def near_field_integrals_cache_type(
        self: "Self",
    ) -> "_7665.NearFieldIntegralsCacheType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7665",
    ...
    @enforce_parameter_types
    def near_field_integrals_cache_type(
        self: "Self", value: "_7665.NearFieldIntegralsCacheType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.NearFieldIntegralsCacheType",
    ...
    @property
    @exception_bridge
    def octree_creation_method(self: "Self") -> "_7666.OctreeCreationMethod":
    ...
    def octree_creation_method(
        self: "Self", value: "_7666.OctreeCreationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.OctreeCreationMethod",
    ...
    @property
    @exception_bridge
    def preconditioner(self: "Self") -> "_7659.AcousticPreconditionerType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7659",
    ...
    @exception_bridge
    @enforce_parameter_types
    def preconditioner(self: "Self", value: "_7659.AcousticPreconditionerType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.AcousticPreconditionerType",
        )
