...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2760, _2767
...
class KlingelnbergCycloPalloidHypoidGear(_2773.KlingelnbergCycloPalloidConicalGear):
    """KlingelnbergCycloPalloidHypoidGear
