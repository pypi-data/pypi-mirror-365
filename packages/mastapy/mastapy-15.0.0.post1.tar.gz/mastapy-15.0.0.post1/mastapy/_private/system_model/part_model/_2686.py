...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2663, _2704
...
class _Cast_InternalClearanceTolerance:
    ...
    def radial_internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2704.RadialInternalClearanceTolerance":
        from mastapy._private.system_model.part_model import _2704

        return self.__parent__._cast(_2704.RadialInternalClearanceTolerance)
