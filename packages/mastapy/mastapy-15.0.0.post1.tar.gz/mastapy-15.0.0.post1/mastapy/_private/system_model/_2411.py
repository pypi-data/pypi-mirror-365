...
class Design(_0.APIBase):
    ...
    @property
    @exception_bridge
    def design_states(self: "Self") -> "List[_5952.DesignState]":
    ...
    @property
    @exception_bridge
    def duty_cycles(self: "Self") -> "List[_5953.DutyCycle]":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5960.TimeSeriesLoadCaseGroup]":
    ...
    @exception_bridge
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5952.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @exception_bridge
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5953.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def save_load_case_results(
        self: "Self", file_name: "PathLike", load_cases: "List[_7670.LoadCase]"
    ) -> None:
        """Method does not return.
