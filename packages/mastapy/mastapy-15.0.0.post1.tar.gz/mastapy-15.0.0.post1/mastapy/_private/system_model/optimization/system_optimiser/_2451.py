...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5953.DutyCycle"
    ) -> None:
        generic_type = (
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5957.SystemOptimisationGearSet]":
    ...
    @property
    @exception_bridge
    def system_optimiser_duty_cycle(self: "Self") -> "_5953.DutyCycle":
    ...
    @exception_bridge
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5953.DutyCycle") -> None:
