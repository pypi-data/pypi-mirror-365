...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7526.ZerolBevelGearSetAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7655.ZerolBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7656.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]":
