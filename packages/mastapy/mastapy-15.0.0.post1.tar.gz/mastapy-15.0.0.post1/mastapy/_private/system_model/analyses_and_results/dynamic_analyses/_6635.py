...
class CylindricalGearSetDynamicAnalysis(_6648.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    def gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6633.CylindricalGearDynamicAnalysis]":
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6634.CylindricalGearMeshDynamicAnalysis]":
