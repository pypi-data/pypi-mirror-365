...
class ConicalGearSetCriticalSpeedAnalysis(_6919.GearSetCriticalSpeedAnalysis):
    """ConicalGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6888.ConicalGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6889.ConicalGearMeshCriticalSpeedAnalysis]":
