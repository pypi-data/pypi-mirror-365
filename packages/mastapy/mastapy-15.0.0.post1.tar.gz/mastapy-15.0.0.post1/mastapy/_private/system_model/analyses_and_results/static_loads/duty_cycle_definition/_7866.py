...
class PointLoadInputOptions(_2050.ColumnInputOptions):
    ...
    @property
    @exception_bridge
    def conversion_to_load_case(self: "Self") -> "_7857.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7857",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7857.AdditionalForcesObtainedFrom"
    ) -> None:
