...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_6149.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_6149.ExcitationSourceSelectionBase)
...
class ExcitationSourceSelectionGroup(_6149.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    @exception_bridge
    def sub_items(self: "Self") -> "List[_6149.ExcitationSourceSelectionBase]":
