...
class CylindricalGearSetCompoundModalAnalysis(_5060.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5047.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5048.CylindricalGearMeshCompoundModalAnalysis]":
