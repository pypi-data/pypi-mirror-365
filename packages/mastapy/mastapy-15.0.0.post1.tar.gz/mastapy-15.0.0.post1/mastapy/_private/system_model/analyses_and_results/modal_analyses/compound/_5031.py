...
class ConceptGearSetCompoundModalAnalysis(_5060.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def concept_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5029.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5030.ConceptGearMeshCompoundModalAnalysis]":
