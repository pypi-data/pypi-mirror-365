...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5444.CylindricalGearSetModalAnalysisAtASpeed]":
    ...
    def cylindrical_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5574.CylindricalGearCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5575.CylindricalGearMeshCompoundModalAnalysisAtASpeed]":
