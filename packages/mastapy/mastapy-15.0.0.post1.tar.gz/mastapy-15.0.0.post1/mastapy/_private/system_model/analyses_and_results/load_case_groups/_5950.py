...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5954.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5954.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5954.GenericClutchEngagementStatus[_2563.ClutchConnection]
):
    """ClutchEngagementStatus
