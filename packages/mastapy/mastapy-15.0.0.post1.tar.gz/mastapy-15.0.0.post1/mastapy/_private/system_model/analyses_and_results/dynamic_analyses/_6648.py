...
class GearSetDynamicAnalysis(_6688.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6646.GearDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def meshes_dynamic_analysis(self: "Self") -> "List[_6647.GearMeshDynamicAnalysis]":
