...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    @exception_bridge
    def excel_file_details(self: "Self") -> "_6852.ExcelFileDetails":
    ...
    @property
    @exception_bridge
    def masta_file_details(self: "Self") -> "_6855.MASTAFileDetails":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6854.ExcelSheetDesignStateSelector]":
