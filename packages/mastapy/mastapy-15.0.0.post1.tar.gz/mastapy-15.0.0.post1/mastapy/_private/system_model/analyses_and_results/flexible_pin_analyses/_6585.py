...
class WindTurbineCertificationReport(_6577.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def extreme_load_case(self: "Self", value: "_7671.StaticLoadCase") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def ldd(self: "Self", value: "_5953.DutyCycle") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def nominal_load_case(self: "Self", value: "_7671.StaticLoadCase") -> None:
        generic_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.implicit_type()
        )
        value = promote_to_list_with_selected_item(value)
