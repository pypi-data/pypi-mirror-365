...
class SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6418.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gears_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6547.SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_meshes_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6548.SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
