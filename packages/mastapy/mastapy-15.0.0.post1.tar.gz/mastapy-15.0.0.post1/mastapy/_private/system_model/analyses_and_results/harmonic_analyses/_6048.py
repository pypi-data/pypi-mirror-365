...
class GearSetHarmonicAnalysis(_6103.SpecialisedAssemblyHarmonicAnalysis):
    """GearSetHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def gears_harmonic_analysis(self: "Self") -> "List[_6043.GearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6045.GearMeshHarmonicAnalysis]":
