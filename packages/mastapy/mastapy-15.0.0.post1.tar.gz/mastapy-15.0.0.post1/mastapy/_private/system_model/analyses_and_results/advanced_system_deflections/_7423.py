...
class ConceptGearSetAdvancedSystemDeflection(_7454.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7421.ConceptGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7422.ConceptGearMeshAdvancedSystemDeflection]":
