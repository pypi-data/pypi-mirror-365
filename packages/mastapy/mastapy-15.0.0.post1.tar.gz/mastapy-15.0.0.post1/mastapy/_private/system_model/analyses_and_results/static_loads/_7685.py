...
class BearingLoadCase(_7716.ConnectorLoadCase):
    """BearingLoadCase
    ...
    def bearing_element_orbit_model(
        self: "Self",
        value: "Union[_5667.BearingElementOrbitModel, Tuple[_5667.BearingElementOrbitModel, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def bearing_stiffness_model(self: "Self") -> "_5669.BearingStiffnessModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5669",
