...
class AssemblyCriticalSpeedAnalysis(_6856.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_6864.BearingCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_6866.BeltDriveCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6869.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_6876.BoltedJointCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_6875.BoltCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_6900.CVTCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_6878.ClutchCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6883.ConceptCouplingCriticalSpeedAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_6887.ConceptGearSetCriticalSpeedAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6902.CycloidalAssemblyCriticalSpeedAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6908.CylindricalGearSetCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_6915.FEPartCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_6914.FaceGearSetCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6916.FlexiblePinAssemblyCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6923.HypoidGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6930.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6933.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_6934.MassDiscCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6935.MeasurementComponentCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_6937.MicrophoneCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_6939.OilSealCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6942.PartToPartShearCouplingCriticalSpeedAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6946.PlanetCarrierCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_6947.PointLoadCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_6948.PowerLoadCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_6950.RingPinsCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6952.RollingRingAssemblyCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6957.ShaftHubConnectionCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_6956.ShaftCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6962.SpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_6964.SpringDamperCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6968.StraightBevelDiffGearSetCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6971.StraightBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_6974.SynchroniserCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6979.TorqueConverterCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_6986.WormGearSetCriticalSpeedAnalysis]":
