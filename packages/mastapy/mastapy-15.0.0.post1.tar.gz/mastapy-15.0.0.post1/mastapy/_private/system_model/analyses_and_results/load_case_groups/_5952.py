...
class DesignState(_5947.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5950.ClutchEngagementStatus]":
    ...
    def concept_synchro_mounted_gears(
        self: "Self",
    ) -> "List[_5951.ConceptSynchroGearEngagementStatus]":
    ...
    ) -> "_5951.ConceptSynchroGearEngagementStatus":
