...
class _Cast_HarmonicAnalysisOptions:
    ...
    def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_7188.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
        from mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
            _7188,
        )
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def damping_specification(
        self: "Self", value: "_6020.DampingSpecification"
    ) -> None:
    ...
    @enforce_parameter_types
    def modal_correction_method(
        self: "Self", value: "_6078.ModalCorrectionMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def response_cache_level(self: "Self") -> "_6092.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._6092",
            "ResponseCacheLevel",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_6092.ResponseCacheLevel") -> None:
    ...
    @property
    @exception_bridge
    def excitation_selection(self: "Self") -> "_6150.ExcitationSourceSelectionGroup":
    ...
    @property
    @exception_bridge
    def modal_analysis_options(self: "Self") -> "_4929.ModalAnalysisOptions":
    ...
    @property
    @exception_bridge
    def stiffness_options(self: "Self") -> "_6111.StiffnessOptionsForHarmonicAnalysis":
