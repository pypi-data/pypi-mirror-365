...
class FaceGearSetDynamicAnalysis(_6648.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6641.FaceGearDynamicAnalysis]":
    ...
    def face_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6641.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6642.FaceGearMeshDynamicAnalysis]":
