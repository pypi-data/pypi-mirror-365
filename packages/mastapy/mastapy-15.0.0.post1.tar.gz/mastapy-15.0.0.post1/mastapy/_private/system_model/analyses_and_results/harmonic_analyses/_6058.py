...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6053
...
class _Cast_HarmonicAnalysisShaftExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_6053.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_6053.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisShaftExportOptions(
    _6053.HarmonicAnalysisExportOptions[_2897.IHaveShaftHarmonicResults, _2714.Shaft]
):
    """HarmonicAnalysisShaftExportOptions
