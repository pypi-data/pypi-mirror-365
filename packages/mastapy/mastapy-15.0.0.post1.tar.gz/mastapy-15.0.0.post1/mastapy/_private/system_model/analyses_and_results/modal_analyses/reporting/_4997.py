...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4990.ComponentPerModeResult":
        return self.__parent__._cast(_4990.ComponentPerModeResult)
...
class ShaftPerModeResult(_4990.ComponentPerModeResult):
    """ShaftPerModeResult
