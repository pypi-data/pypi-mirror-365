...
class TimeSeriesImporter(_0.APIBase):
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: "Self", value: "_7860.DestinationDesignState"
    ) -> None:
    ...
    @property
    @exception_bridge
    def import_type(self: "Self") -> "_7774.ImportType":
    ...
    @exception_bridge
    @enforce_parameter_types
    def import_type(self: "Self", value: "_7774.ImportType") -> None:
    ...
    @property
    @exception_bridge
    def design_state_options(self: "Self") -> "_7859.DesignStateOptions":
    ...
    @property
    @exception_bridge
    def gear_ratio_options(self: "Self") -> "_7862.GearRatioInputOptions":
    ...
    @property
    @exception_bridge
    def load_case_name_inputs(self: "Self") -> "_7863.LoadCaseNameOptions":
    ...
    @property
    @exception_bridge
    def time_step_input(self: "Self") -> "_7871.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: "Self",
    ) -> "List[_7858.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    @exception_bridge
    def file_inputs(self: "Self") -> "List[_7865.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    @exception_bridge
    def force_inputs(self: "Self") -> "List[_7861.ForceInputOptions]":
    ...
    @property
    @exception_bridge
    def moment_inputs(self: "Self") -> "List[_7864.MomentInputOptions]":
    ...
    @property
    @exception_bridge
    def speed_inputs(self: "Self") -> "List[_7869.SpeedInputOptions]":
    ...
    @property
    @exception_bridge
    def torque_inputs(self: "Self") -> "List[_7872.TorqueInputOptions]":
