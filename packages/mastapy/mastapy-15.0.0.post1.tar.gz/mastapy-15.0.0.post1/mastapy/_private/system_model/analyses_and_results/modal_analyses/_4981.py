...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    @exception_bridge
    def connected_component_type(self: "Self") -> "_6147.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._6147",
    ...
    def connected_component_type(
        self: "Self", value: "_6147.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4931.MultipleExcitationsSpeedRangeOption":
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4931.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4980.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4980",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4980.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    @exception_bridge
    def order_cuts_chart_settings(self: "Self") -> "_4933.OrderCutsChartSettings":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_6155.ResultLocationSelectionGroups":
    ...
    @property
    @exception_bridge
    def selected_excitations(self: "Self") -> "_6150.ExcitationSourceSelectionGroup":
    ...
    @property
    @exception_bridge
    def waterfall_chart_settings(self: "Self") -> "_4979.WaterfallChartSettings":
    ...
    @property
    @exception_bridge
    def active_result_locations(self: "Self") -> "List[_6156.ResultNodeSelection]":
