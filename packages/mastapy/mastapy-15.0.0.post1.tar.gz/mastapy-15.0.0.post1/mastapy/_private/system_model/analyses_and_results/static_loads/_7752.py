...
class FaceGearSetLoadCase(_7761.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7750.FaceGearLoadCase]":
    ...
    @property
    @exception_bridge
    def face_gears_load_case(self: "Self") -> "List[_7750.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7751.FaceGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def face_meshes_load_case(self: "Self") -> "List[_7751.FaceGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearMeshLoadCase]
