...
class ZerolBevelGearSetCompoundModalAnalysis(_5018.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5128.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5129.ZerolBevelGearMeshCompoundModalAnalysis]":
