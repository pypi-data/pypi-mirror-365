...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7498.SpiralBevelGearSetAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7628.SpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7629.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
