...
class StaticLoadCase(_7670.LoadCase):
    """StaticLoadCase
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7394.AdvancedSystemDeflectionOptions":
    ...
    @property
    @exception_bridge
    def clutch_engagements(self: "Self") -> "List[_5950.ClutchEngagementStatus]":
    ...
    @property
    @exception_bridge
    def advanced_system_deflection(self: "Self") -> "_7393.AdvancedSystemDeflection":
    ...
    @property
    @exception_bridge
    def critical_speed_analysis(self: "Self") -> "_6896.CriticalSpeedAnalysis":
    ...
    @property
    @exception_bridge
    def design_state_load_case_group(self: "Self") -> "_5952.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5952.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
