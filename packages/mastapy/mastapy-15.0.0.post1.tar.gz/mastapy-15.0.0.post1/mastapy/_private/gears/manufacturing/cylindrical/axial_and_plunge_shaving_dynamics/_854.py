...
class _Cast_ConventionalShavingDynamics:
    ...
    @property
    def shaving_dynamics(self: "CastSelf") -> "_868.ShavingDynamics":
        return self.__parent__._cast(_868.ShavingDynamics)
...
class ConventionalShavingDynamics(_868.ShavingDynamics):
    """ConventionalShavingDynamics
