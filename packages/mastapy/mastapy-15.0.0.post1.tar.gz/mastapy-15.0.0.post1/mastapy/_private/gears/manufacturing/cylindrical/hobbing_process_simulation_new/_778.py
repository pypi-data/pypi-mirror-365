...
class HobbingProcessTotalModificationCalculation(_769.HobbingProcessCalculation):
    """HobbingProcessTotalModificationCalculation
    ...
    @property
    @exception_bridge
    def total_errors_chart_left_flank(self: "Self") -> "_2068.ThreeDChartDefinition":
    ...
    @property
    @exception_bridge
    def total_errors_chart_right_flank(self: "Self") -> "_2068.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
