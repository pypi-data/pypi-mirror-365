...
class _Cast_ShavingDynamics:
    ...
    def conventional_shaving_dynamics(
        ...
        return self.__parent__._cast(_854.ConventionalShavingDynamics)

    @property
    def plunge_shaver_dynamics(self: "CastSelf") -> "_858.PlungeShaverDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _858,
        )

        return self.__parent__._cast(_858.PlungeShaverDynamics)
