...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1996, _1999
...
class _Cast_GearOrderForTE:
    ...
    @property
    def order_for_te(self: "CastSelf") -> "_1999.OrderForTE":
        return self.__parent__._cast(_1999.OrderForTE)
...
class GearOrderForTE(_2001.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    @exception_bridge
    def position(self: "Self") -> "_1996.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._1996", "GearPositions"
        )(value)

    @property
    @exception_bridge
    def additional_orders_and_harmonics(self: "Self") -> "List[_1999.OrderForTE]":
