...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2749.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2749.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2749.ActiveGearSetDesignSelectionGroup":
