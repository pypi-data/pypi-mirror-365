...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _728.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _728.CylindricalSetManufacturingConfig.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_728.CylindricalSetManufacturingConfig":
