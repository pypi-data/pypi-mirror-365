...
from mastapy._private.bearings.tolerances import _2105
...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _2105.InternalClearanceClass
        """
        return _2105.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2105.InternalClearanceClass.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2105.InternalClearanceClass":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2105.InternalClearanceClass]":
