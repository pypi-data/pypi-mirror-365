...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2833.RigidConnectorStiffnessType":
        ...
        Returns:
            _2833.RigidConnectorStiffnessType
        """
        return _2833.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2833.RigidConnectorStiffnessType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2833.RigidConnectorStiffnessType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2833.RigidConnectorStiffnessType]":
