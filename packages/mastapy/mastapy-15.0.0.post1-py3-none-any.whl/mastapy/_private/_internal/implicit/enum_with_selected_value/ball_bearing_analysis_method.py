...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2172.BallBearingAnalysisMethod":
        ...
        Returns:
            _2172.BallBearingAnalysisMethod
        """
        return _2172.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2172.BallBearingAnalysisMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2172.BallBearingAnalysisMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2172.BallBearingAnalysisMethod]":
