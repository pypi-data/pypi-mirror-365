...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2168.LoadedBallElementPropertyType":
        ...
        Returns:
            _2168.LoadedBallElementPropertyType
        """
        return _2168.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2168.LoadedBallElementPropertyType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2168.LoadedBallElementPropertyType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2168.LoadedBallElementPropertyType]":
