...
from mastapy._private.bearings import _2095
...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_2095.RollingBearingArrangement":
        ...
        Returns:
            _2095.RollingBearingArrangement
        """
        return _2095.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2095.RollingBearingArrangement.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2095.RollingBearingArrangement":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2095.RollingBearingArrangement]":
