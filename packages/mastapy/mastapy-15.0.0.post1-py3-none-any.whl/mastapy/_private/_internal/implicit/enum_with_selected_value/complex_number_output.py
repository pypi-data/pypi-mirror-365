...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput]",
    ) -> "_6054.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        Returns:
            _6054.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
        """
        return _6054.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6054.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_6054.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":
