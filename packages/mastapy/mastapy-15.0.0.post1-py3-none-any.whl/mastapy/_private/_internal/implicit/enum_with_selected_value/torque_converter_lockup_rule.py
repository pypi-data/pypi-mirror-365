...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5795.TorqueConverterLockupRule":
        ...
        Returns:
            _5795.TorqueConverterLockupRule
        """
        return _5795.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5795.TorqueConverterLockupRule.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5795.TorqueConverterLockupRule":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5795.TorqueConverterLockupRule]":
