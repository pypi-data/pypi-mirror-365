...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _6020.DampingSpecification
        """
        return _6020.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6020.DampingSpecification.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6020.DampingSpecification":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6020.DampingSpecification]":
