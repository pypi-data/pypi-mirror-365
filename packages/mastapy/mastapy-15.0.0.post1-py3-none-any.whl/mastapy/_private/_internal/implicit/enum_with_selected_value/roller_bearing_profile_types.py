...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_2094.RollerBearingProfileTypes":
        ...
        Returns:
            _2094.RollerBearingProfileTypes
        """
        return _2094.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2094.RollerBearingProfileTypes.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2094.RollerBearingProfileTypes":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2094.RollerBearingProfileTypes]":
