...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7763.HarmonicExcitationType
        """
        return _7763.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7763.HarmonicExcitationType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7763.HarmonicExcitationType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7763.HarmonicExcitationType]":
