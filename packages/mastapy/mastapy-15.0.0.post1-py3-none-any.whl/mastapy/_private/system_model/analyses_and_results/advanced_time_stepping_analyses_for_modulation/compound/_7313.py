...
class FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7181.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7311.FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7312.FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
