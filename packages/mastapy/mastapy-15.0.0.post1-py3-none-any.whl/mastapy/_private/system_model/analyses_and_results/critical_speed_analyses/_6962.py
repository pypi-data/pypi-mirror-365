...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6874.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def bevel_gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6960.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def bevel_meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6961.SpiralBevelGearMeshCriticalSpeedAnalysis]":
