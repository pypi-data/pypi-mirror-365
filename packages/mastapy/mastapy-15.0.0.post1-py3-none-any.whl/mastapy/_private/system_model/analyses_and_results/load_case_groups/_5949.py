...
class _Cast_AbstractStaticLoadCaseGroup:
    ...
    @property
    def abstract_load_case_group(self: "CastSelf") -> "_5948.AbstractLoadCaseGroup":
        return self.__parent__._cast(_5948.AbstractLoadCaseGroup)

    @property
    def abstract_design_state_load_case_group(
        self: "CastSelf",
    ) -> "_5947.AbstractDesignStateLoadCaseGroup":
        return self.__parent__._cast(_5947.AbstractDesignStateLoadCaseGroup)

    @property
    def design_state(self: "CastSelf") -> "_5952.DesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5952,
        )

        return self.__parent__._cast(_5952.DesignState)

    @property
    def duty_cycle(self: "CastSelf") -> "_5953.DutyCycle":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5953,
        )

        return self.__parent__._cast(_5953.DutyCycle)

    @property
    def sub_group_in_single_design_state(
        self: "CastSelf",
    ) -> "_5956.SubGroupInSingleDesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5956,
        )

        return self.__parent__._cast(_5956.SubGroupInSingleDesignState)
...
class AbstractStaticLoadCaseGroup(_5948.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    def bearings(
        ...
        "List[_5962.ComponentStaticLoadCaseGroup[_2664.Bearing, _7685.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5965.GearSetStaticLoadCaseGroup[_2763.CylindricalGearSet, _2762.CylindricalGear, _7727.CylindricalGearLoadCase, _2530.CylindricalGearMesh, _7729.CylindricalGearMeshLoadCase, _7731.CylindricalGearSetLoadCase]]":
    ...
    @property
    @exception_bridge
    def design_states(self: "Self") -> "List[_5947.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_5962.ComponentStaticLoadCaseGroup[_2680.FEPart, _7753.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: "Self",
    ) -> "List[_5965.GearSetStaticLoadCaseGroup[_2769.GearSet, _2767.Gear, _7756.GearLoadCase, _2534.GearMesh, _7758.GearMeshLoadCase, _7761.GearSetLoadCase]]":
    ...
    @property
    @exception_bridge
    def parts_with_excitations(self: "Self") -> "List[_5966.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5962.ComponentStaticLoadCaseGroup[_2702.PointLoad, _7806.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5962.ComponentStaticLoadCaseGroup[_2703.PowerLoad, _7807.PowerLoadLoadCase]]":
    ...
    @property
    @exception_bridge
    def static_loads(self: "Self") -> "List[_7671.StaticLoadCase]":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: "Self", analysis_type: "_7683.AnalysisType"
