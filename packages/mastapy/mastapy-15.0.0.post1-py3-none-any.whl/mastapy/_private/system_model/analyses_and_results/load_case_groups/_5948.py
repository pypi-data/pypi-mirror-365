...
class _Cast_AbstractLoadCaseGroup:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5949.AbstractStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5949,
        )

        return self.__parent__._cast(_5949.AbstractStaticLoadCaseGroup)
    ...
    def time_series_load_case_group(
        self: "CastSelf",
    ) -> "_5960.TimeSeriesLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5960,
        )

        return self.__parent__._cast(_5960.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    @exception_bridge
    def load_case_root_assemblies(self: "Self") -> "List[_7816.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7898.TaskProgress"
    ) -> "List[_7670.LoadCase]":
    ...
    @exception_bridge
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7898.TaskProgress") -> None:
        """Method does not return.
