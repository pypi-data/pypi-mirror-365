...
class BevelGearSetDynamicAnalysis(_6592.AGMAGleasonConicalGearSetDynamicAnalysis):
    """BevelGearSetDynamicAnalysis
    ...
    def agma_gleason_conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6602.BevelGearDynamicAnalysis]":
    ...
    def agma_gleason_conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6603.BevelGearMeshDynamicAnalysis]":
