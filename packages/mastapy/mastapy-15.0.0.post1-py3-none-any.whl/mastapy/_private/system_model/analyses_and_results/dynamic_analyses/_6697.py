...
class StraightBevelDiffGearSetDynamicAnalysis(_6604.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6695.StraightBevelDiffGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6696.StraightBevelDiffGearMeshDynamicAnalysis]":
