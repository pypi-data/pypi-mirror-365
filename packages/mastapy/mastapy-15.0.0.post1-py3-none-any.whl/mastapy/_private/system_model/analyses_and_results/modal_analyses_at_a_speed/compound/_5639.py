...
class StraightBevelGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5508.StraightBevelGearSetModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5637.StraightBevelGearCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5638.StraightBevelGearMeshCompoundModalAnalysisAtASpeed]":
