...
class ConicalGearSetModalAnalysisAtASpeed(_5455.GearSetModalAnalysisAtASpeed):
    """ConicalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5428.ConicalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5427.ConicalGearMeshModalAnalysisAtASpeed]":
