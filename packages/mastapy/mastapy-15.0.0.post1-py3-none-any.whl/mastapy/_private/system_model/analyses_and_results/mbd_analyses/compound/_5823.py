...
class AssemblyCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5666.AssemblyMultibodyDynamicsAnalysis]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_5824.BearingCompoundMultibodyDynamicsAnalysis]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_5826.BeltDriveCompoundMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5829.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5836.BoltedJointCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5835.BoltCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5857.CVTCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5837.ClutchCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5842.ConceptCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5847.ConceptGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5859.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5861.CycloidalDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5865.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5872.FEPartCompoundMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5871.FaceGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5873.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5880.HypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5887.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5890.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_5891.MassDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5892.MeasurementComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_5894.MicrophoneCompoundMultibodyDynamicsAnalysis]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_5896.OilSealCompoundMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5898.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5903.PlanetCarrierCompoundMultibodyDynamicsAnalysis]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5904.PointLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5905.PowerLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_5907.RingPinsCompoundMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5909.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5914.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5913.ShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5919.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5920.SpringDamperCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5925.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5928.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5931.SynchroniserCompoundMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5935.TorqueConverterCompoundMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5939.UnbalancedMassCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5943.WormGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5946.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]":
