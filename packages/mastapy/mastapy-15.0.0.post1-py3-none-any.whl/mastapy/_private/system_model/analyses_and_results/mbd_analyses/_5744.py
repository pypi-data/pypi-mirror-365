...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_type(self: "Self") -> "_5665.AnalysisTypes":
    ...
    def analysis_type(self: "Self", value: "_5665.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def bearing_stiffness_model(
        self: "Self", value: "_5669.BearingStiffnessModel"
    ) -> None:
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5728.InertiaAdjustedLoadCasePeriodMethod":
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5728.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5729.InertiaAdjustedLoadCaseResultsToCreate":
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5729.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5815.DynamicExternalInterfaceOptions":
    ...
    @property
    @exception_bridge
    def run_up_analysis_options(self: "Self") -> "_5745.MBDRunUpAnalysisOptions":
    ...
    @property
    @exception_bridge
    def spline_damping_options(self: "Self") -> "_5778.SplineDampingOptions":
