...
class _Cast_AbstractAssemblyCompoundAdvancedSystemDeflection:
    ...
    def assembly_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7534.AssemblyCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7534,
        )

        return self.__parent__._cast(_7534.AssemblyCompoundAdvancedSystemDeflection)
...
class AbstractAssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases(
        self: "Self",
    ) -> "List[_7389.AbstractAssemblyAdvancedSystemDeflection]":
