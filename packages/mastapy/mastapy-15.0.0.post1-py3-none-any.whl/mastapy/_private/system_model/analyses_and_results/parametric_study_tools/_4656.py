...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_7683.AnalysisType") -> None:
    ...
    @property
    @exception_bridge
    def parametric_study_type(self: "Self") -> "_7795.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7795",
            "ParametricStudyType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7795.ParametricStudyType") -> None:
