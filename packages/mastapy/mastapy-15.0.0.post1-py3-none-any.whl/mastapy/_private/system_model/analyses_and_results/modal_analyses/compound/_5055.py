...
class FaceGearSetCompoundModalAnalysis(_5060.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def face_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5053.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5054.FaceGearMeshCompoundModalAnalysis]":
