...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6130
...
class MeasurementComponentHarmonicAnalysis(_6130.VirtualComponentHarmonicAnalysis):
    """MeasurementComponentHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7788.MeasurementComponentLoadCase":
