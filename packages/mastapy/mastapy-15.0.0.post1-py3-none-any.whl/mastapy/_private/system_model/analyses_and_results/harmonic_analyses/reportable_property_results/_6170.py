...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_6169.ResultsForMultipleOrders":
        return self.__parent__._cast(_6169.ResultsForMultipleOrders)
...
class ResultsForMultipleOrdersForFESurface(_6169.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
    ...
    def default_fe_surface(
        self: "Self",
    ) -> "_6167.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic":
