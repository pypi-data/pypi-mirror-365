...
class RootAssemblyHarmonicAnalysis(
    _5975.AssemblyHarmonicAnalysis, _2896.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6057.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    @exception_bridge
    def harmonic_analysis_inputs(self: "Self") -> "_6051.HarmonicAnalysis":
