...
class ShaftHarmonicAnalysis(
    _5969.AbstractShaftHarmonicAnalysis, _2897.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4951.ShaftModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6058.HarmonicAnalysisShaftExportOptions":
