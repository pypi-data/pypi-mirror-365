...
class StraightBevelGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6117.StraightBevelGearSetHarmonicAnalysis]":
    ...
    def straight_bevel_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6292.StraightBevelGearCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6293.StraightBevelGearMeshCompoundHarmonicAnalysis]":
