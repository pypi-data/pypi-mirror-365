...
class StraightBevelDiffGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6114.StraightBevelDiffGearSetHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6289.StraightBevelDiffGearCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_diff_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6290.StraightBevelDiffGearMeshCompoundHarmonicAnalysis]":
