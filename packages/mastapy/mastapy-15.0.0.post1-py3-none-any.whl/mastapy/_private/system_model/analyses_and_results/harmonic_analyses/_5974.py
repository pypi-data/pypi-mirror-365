...
class AGMAGleasonConicalGearSetHarmonicAnalysis(_6003.ConicalGearSetHarmonicAnalysis):
    """AGMAGleasonConicalGearSetHarmonicAnalysis
    ...
    def conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5972.AGMAGleasonConicalGearHarmonicAnalysis]":
    ...
    def conical_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5973.AGMAGleasonConicalGearMeshHarmonicAnalysis]":
