...
class KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6070.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6251.KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6252.KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis]":
