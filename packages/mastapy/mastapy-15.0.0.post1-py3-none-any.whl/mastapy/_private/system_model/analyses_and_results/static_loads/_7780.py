...
class KlingelnbergCycloPalloidConicalGearSetLoadCase(_7714.ConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7778.KlingelnbergCycloPalloidConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7779.KlingelnbergCycloPalloidConicalGearMeshLoadCase]":
