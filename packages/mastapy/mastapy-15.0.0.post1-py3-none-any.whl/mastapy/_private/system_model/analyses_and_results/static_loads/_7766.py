...
from mastapy._private.system_model.analyses_and_results.static_loads import _7745, _7764
...
class _Cast_HarmonicLoadDataFluxImport:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7767.HarmonicLoadDataImportBase":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7767,
        )

        return self.__parent__._cast(_7767.HarmonicLoadDataImportBase)
...
class HarmonicLoadDataFluxImport(
    _7764.HarmonicLoadDataCSVImport[_7745.ElectricMachineHarmonicLoadFluxImportOptions]
):
    """HarmonicLoadDataFluxImport
    ...
    @property
    @exception_bridge
    def inner_diameter_reference(self: "Self") -> "_7776.InnerDiameterReference":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7776",
    ...
    def inner_diameter_reference(
        self: "Self", value: "_7776.InnerDiameterReference"
    ) -> None:
