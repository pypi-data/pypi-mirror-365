...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2393, _2394, _2395
...
class PlainOilFedJournalBearing(_2402.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    @exception_bridge
    def feed_type(self: "Self") -> "_2090.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2090", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @exception_bridge
    @enforce_parameter_types
    def feed_type(self: "Self", value: "_2090.JournalOilFeedType") -> None:
    ...
    @property
    @exception_bridge
    def axial_groove_oil_feed(self: "Self") -> "_2393.AxialGrooveJournalBearing":
    ...
    @property
    @exception_bridge
    def axial_hole_oil_feed(self: "Self") -> "_2394.AxialHoleJournalBearing":
    ...
    def circumferential_groove_oil_feed(
        self: "Self",
    ) -> "_2395.CircumferentialFeedJournalBearing":
