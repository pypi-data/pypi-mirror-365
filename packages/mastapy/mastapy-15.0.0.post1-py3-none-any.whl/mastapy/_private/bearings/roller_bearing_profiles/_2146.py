...
class _Cast_UserSpecifiedRollerRaceProfilePoint:
    ...
    @property
    def roller_race_profile_point(self: "CastSelf") -> "_2144.RollerRaceProfilePoint":
        return self.__parent__._cast(_2144.RollerRaceProfilePoint)
...
class UserSpecifiedRollerRaceProfilePoint(_2144.RollerRaceProfilePoint):
    """UserSpecifiedRollerRaceProfilePoint
