...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel import _486, _487
...
class StraightBevelGearSetRating(_647.BevelGearSetRating):
    """StraightBevelGearSetRating
    ...
    def straight_bevel_gear_ratings(
        self: "Self",
    ) -> "List[_487.StraightBevelGearRating]":
    ...
    def straight_bevel_mesh_ratings(
        self: "Self",
    ) -> "List[_486.StraightBevelGearMeshRating]":
