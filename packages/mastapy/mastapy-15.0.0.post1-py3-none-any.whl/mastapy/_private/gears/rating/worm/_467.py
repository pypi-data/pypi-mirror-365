...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.worm import _464, _465
...
class WormGearSetRating(_454.GearSetRating):
    """WormGearSetRating
    ...
    @property
    @exception_bridge
    def gear_ratings(self: "Self") -> "List[_465.WormGearRating]":
    ...
    @property
    @exception_bridge
    def worm_gear_ratings(self: "Self") -> "List[_465.WormGearRating]":
        """List[mastapy.gears.rating.worm.WormGearRating]
    ...
    @property
    @exception_bridge
    def gear_mesh_ratings(self: "Self") -> "List[_464.WormGearMeshRating]":
    ...
    @property
    @exception_bridge
    def worm_mesh_ratings(self: "Self") -> "List[_464.WormGearMeshRating]":
        """List[mastapy.gears.rating.worm.WormGearMeshRating]
