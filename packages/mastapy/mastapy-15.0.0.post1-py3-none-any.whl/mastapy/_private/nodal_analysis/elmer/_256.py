...
class MechanicalContactSpecification(_0.APIBase):
    ...
    @property
    @exception_bridge
    def contact_type(self: "Self") -> "_248.ContactType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._248", "ContactType"
        )(value)

    @contact_type.setter
    @exception_bridge
    @enforce_parameter_types
    def contact_type(self: "Self", value: "_248.ContactType") -> None:
