    ...
    def test_cli_help(self):
        ...
        result = subprocess.run(
            [
                sys.executable,
                "-m",
                "ai_subtitle_translator.translate_subtitles",
                "--help",
            ],
            capture_output=True,
            text=True,
        ...
        assert "--extract-monolingual" in result.stdout
        assert "Extract monolingual subtitles" in result.stdout

    def test_cli_extract_flag_present(self):
        """Test that extract-monolingual flag is available."""
        result = subprocess.run(
            [
                sys.executable,
                "-m",
