...
def create_provider_table() -> Table:
    ...
    table.add_row("OpenAI", Emojis.OPENAI, "gpt-4, gpt-3.5-turbo")
    table.add_row("Gemini", Emojis.GEMINI, "gemini-pro, gemini-pro-vision")
    table.add_row("DeepSeek", Emojis.DEEPSEEK, "deepseek-chat, deepseek-coder")
