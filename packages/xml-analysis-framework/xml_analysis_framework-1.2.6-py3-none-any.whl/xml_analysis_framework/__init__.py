...
def analyze_enhanced(file_path: str, **kwargs):
    ...
    Returns:
        Dict containing analysis results with document type detection,
...
def chunk(file_path: str, strategy: str = "auto", **kwargs):
    ...
    specialized_analysis = {
        'document_type': {
            'type_name': analysis_result['document_type'].type_name,
            'confidence': analysis_result['document_type'].confidence
        },
        'analysis': analysis_result['analysis']
    }
    
    orchestrator = _get_chunking_orchestrator()
    return orchestrator.chunk_document(file_path, specialized_analysis, strategy=strategy, **kwargs)
