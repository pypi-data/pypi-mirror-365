...
class AwsStorageConfigInfo(StorageConfigInfo):
    ...
    endpoint: Optional[StrictStr] = Field(default=None, description="endpoint for S3 requests (optional)")
    sts_endpoint: Optional[StrictStr] = Field(default=None, description="endpoint for STS requests (optional). If not set, defaults to 'endpoint'.", alias="stsEndpoint")
    ...
    __properties: ClassVar[List[str]] = ["storageType", "allowedLocations", "roleArn", "externalId", "userArn", "region", "endpoint", "stsEndpoint", "pathStyleAccess"]
