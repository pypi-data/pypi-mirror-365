...
from typing import Generator, Callable, Any, Self, Iterator
...
class PostgreSQLPool:
    ...
    def get_stats(self) -> dict[str, dict[str, float | int]]:
        ...
        Returns:
            dict[str, dict[str, float | int]]:
                Query statistics, keyed by query name AND Pool stats if available.
    ...
    def connection(
        ...
        Yields:
            tuple[psycopg.Connection, psycopg.Cursor]: Active connection.
        """
    ...
    def read_in_chunks(
        ...
        query_name: str | None = None,
    ) -> Iterator[list[dict[str, Any]], None, None]:
        """
