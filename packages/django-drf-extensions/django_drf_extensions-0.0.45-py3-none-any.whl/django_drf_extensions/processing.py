    ...
    try:
        ...
        if valid_updates:
            ...
            with transaction.atomic():
                ...
                updated_count = safe_bulk_update(
                    model_class, instances_to_update, fields_list, batch_size=1000
                )
    ...
    try:
        ...
        if valid_replacements:
            ...
            with transaction.atomic():
                ...
                replaced_count = safe_bulk_update(
                    model_class, instances_to_replace, fields_list, batch_size=1000
                )
    ...
    try:
        ...
        if instances_to_update:
            ...
            with transaction.atomic():
                ...
                if fields_to_update:
                    updated_count = safe_bulk_update(
                        model_class, update_instances, fields_to_update, batch_size=1000
                    )
