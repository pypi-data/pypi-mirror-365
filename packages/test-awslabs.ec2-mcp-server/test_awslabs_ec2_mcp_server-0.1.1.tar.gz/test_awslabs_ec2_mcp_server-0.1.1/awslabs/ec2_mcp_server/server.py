...
mcp = FastMCP(
    ...
    * Must specify storage_method: "secrets_manager", "s3_encrypted", or "parameter_store" (required)
    ...
    * Automatic rollback if storage fails
    ...
    2. `create_key_pair` with storage_method="secrets_manager" (private key stored securely)
    ...
    - Choose from: "secrets_manager", "s3_encrypted", "parameter_store" (required parameter)
