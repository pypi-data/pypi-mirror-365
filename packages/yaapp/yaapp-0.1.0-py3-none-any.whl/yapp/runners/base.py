"""
Base runner class for yapp runners.
"""
...
class BaseRunner(ABC):
    """Base class for all yapp runners."""
    ...
    def _show_current_context_info(self) -> None:
        ...
        if self.core._current_context:
            print(f"Current context: {':'.join(self.core._current_context)}")
        else:
    ...
    def _show_contextual_help(self) -> None:
        ...
        if self.core._current_context:
            ...
            current_commands = self.core._registry
    ...
    def _handle_contextual_command(self, command: str) -> bool:
        ...
        if not self.core._is_leaf_command(command_name):
            if self.core._enter_context(command_name):
                print(f"Entered {':'.join(self.core._current_context)} context")
