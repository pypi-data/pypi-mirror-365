...
def async_compatible(func: Callable) -> Callable:
    ...
    if hasattr(func, '__self__'):
        print(f"Warning: Bound method {func} cannot be made async compatible. Use wrapper approach.")
        return func
    
    # Handle built-in functions and other non-modifiable types
    if hasattr(func, '__module__') and func.__module__ == 'builtins':
        print(f"Warning: Built-in function {func} cannot be made async compatible. Use wrapper approach.")
        return func
