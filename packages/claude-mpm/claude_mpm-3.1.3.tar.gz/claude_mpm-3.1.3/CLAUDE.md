...
3. **Check imports**: Ensure all imports use the full package name: `from claude_mpm.module import ...`
   - Use `safe_import` utility for fallback support - see [Import Standards](docs/developer/import_standards.md)
   - Migration guide available at [Safe Import Migration](docs/developer/06-internals/migrations/safe_import_migration_guide.md)
