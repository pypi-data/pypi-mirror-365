				...
				<view class="form-content">
					...
					<view class="input-container">
						<view class="input-wrapper" :class="{ 'input-focused': phoneFocused }">
							...
							<input type="number" v-model="phone" placeholder="请输入手机号" maxlength="11" class="input-field"
					...
					<view class="input-container">
						<view class="input-wrapper" :class="{ 'input-focused': codeFocused }">
							...
							<input type="number" v-model="code" placeholder="请输入验证码" maxlength="6" class="input-field"
								@focus="codeFocused = true" @blur="codeFocused = false" />
							<button class="code-btn" :class="{ 'code-btn-disabled': codeBtnDisabled }" @click="getCode"
