...
class Form1099MiscListItemResponse(BaseModel):
    ...
    medical_and_health_care: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Medical and health care payments", alias="medicalAndHealthCare")
    ...
    excess_golden_parachute: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(Legacy field) Excess golden parachute payments", alias="excessGoldenParachute")
    gross_amount_paid_attorney: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross proceeds paid to an attorney", alias="grossAmountPaidAttorney")
    ...
    section409_a_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Nonqualified deferred compensation", alias="section409AIncome")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "federalEfileStatus": Form1099StatusDetailResponse.from_dict(obj["federalEfileStatus"]) if obj.get("federalEfileStatus") is not None else None,
            ...
            "postalMailStatus": Form1099StatusDetailResponse.from_dict(obj["postalMailStatus"]) if obj.get("postalMailStatus") is not None else None,
            "tinMatch": obj.get("tinMatch"),
            "tinMatchStatus": Form1099StatusDetailResponse.from_dict(obj["tinMatchStatus"]) if obj.get("tinMatchStatus") is not None else None,
            "addressVerification": obj.get("addressVerification"),
            "addressVerificationStatus": Form1099StatusDetailResponse.from_dict(obj["addressVerificationStatus"]) if obj.get("addressVerificationStatus") is not None else None,
