...
from .list_pomes import (
    ...
    list_remove_duplicates, list_flatten, list_unflatten,
    list_get_coupled, list_elem_starting_with, list_elem_with_attr,
    list_transform, list_prune_duplicates, list_prune_in, list_prune_not_in,
