...
async def get_dividends(
    ...
    try:
        ...
        # print(f"ERROR in get_dividends for {symbol}: {e} (type: {type(e)})") # Removed
        return {"error": str(e)}


async def get_splits(symbol: str, period: str = "5y") -> dict:
    ...
    try:
        ...
        # print(f"ERROR in get_splits for {symbol}: {e} (type: {type(e)})") # Removed
        return {"error": str(e)}
