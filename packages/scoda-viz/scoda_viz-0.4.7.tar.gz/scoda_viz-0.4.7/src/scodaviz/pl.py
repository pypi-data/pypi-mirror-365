...
def get_gene_expression_mean( adata, genes = [], group_col = 'sample_ext' ): 
    ...
    if show:
        ...
        with warnings.catch_warnings():
            ...
            dp = sc.pl.dotplot(adata_t, mkrs_dict, groupby = Type_level, 
                               ...
                               standard_scale = standard_scale, cmap = cmap, # mean_only_expressed = True,
...
def plot_marker_exp(adata, markers = None, celltype_selection = None, var_group_col = None, cell_group_col = None,
                    ...
                    legend = False, figsize = (20, 4), swap_ax = False, add_rect = True, 
                    cmap = 'Reds', linecolor = 'royalblue' ):
