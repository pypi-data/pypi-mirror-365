...
class FcntConfiguration(object):
    ...
    def configure_averaging(
        ...
        Args:
            ...
            averaging_enabled (FcntAveragingEnabled):
            ...
            averaging_type (FcntAveragingType):
    ...
    def configure_rbw_filter(self, selector_string, rbw, rbw_filter_type, rrc_alpha):
        ...
        Args:
            ...
            rbw_filter_type (FcntRbwFilterType):
    ...
    def configure_threshold(
        ...
        Args:
            ...
            threshold_enabled (FcntThresholdEnabled):
            ...
            threshold_type (FcntThresholdType):
