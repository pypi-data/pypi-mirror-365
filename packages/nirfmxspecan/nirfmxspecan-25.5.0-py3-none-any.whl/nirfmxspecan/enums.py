...
class IQMeasurementMode(Enum):
    ...
    needs to be retrieved using ` RFmxInstr Fetch Raw IQ <rfmxinstrvi.chm/RFmxInstr_Fetch_Raw_IQ_(1Rec).html>`_ method
    instead of :py:meth:`fetch_data` method. ` RFmxInstr Fetch Raw IQ
    <rfmxinstrvi.chm/RFmxInstr_Fetch_Raw_IQ_(1Rec).html>`_ directly fetches the data from the hardware.
