...
def example(resource_name, option_string):
    ...
    power_units = nirfmxspecan.AcpPowerUnits.DBM.value
    noise_compensation_enabled = nirfmxspecan.AcpNoiseCompensationEnabled.FALSE.value

    sweep_time_auto = nirfmxspecan.AcpSweepTimeAuto.TRUE.value
    sweep_time_interval = 1.00e-3  # seconds

    rbw_filter_type = nirfmxspecan.AcpRbwFilterType.GAUSSIAN.value
    rbw_auto = nirfmxspecan.AcpRbwAutoBandwidth.TRUE.value
    rbw = 10.0e3  # Hz
    ...
    averaging_enabled = nirfmxspecan.AcpAveragingEnabled.FALSE.value
    averaging_count = 10
    averaging_type = nirfmxspecan.AcpAveragingType.RMS.value
    ...
    try:
        ...
        specan.select_measurements("", nirfmxspecan.MeasurementTypes.ACP.value, True)
