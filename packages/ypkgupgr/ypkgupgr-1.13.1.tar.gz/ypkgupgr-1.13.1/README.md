...
## What's Changed
* Exit alternate buffer when no packages are outdated by @yesseruser in https://github.com/yesser-studios/ypkgupgr/pull/71


**Full Changelog**: https://github.com/yesser-studios/ypkgupgr/compare/1.13.0...1.13.1
