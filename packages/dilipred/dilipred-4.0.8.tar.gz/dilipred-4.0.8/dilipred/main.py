...
def standardized_smiles(smiles):
    ...
    try:
        ...
        for _ in range(5):
            ...
            # mol = standardizer.charge_parent(mol) # [OLD] rdkit-pypi
            # mol = standardizer.isotope_parent(mol) # [OLD] rdkit-pypi
            # mol = standardizer.stereo_parent(mol) # [OLD] rdkit-pypi

            # Normalize tautomers
            # Method 1
            # normalizer = MolStandardize.rdMolStandardize.TautomerEnumerator()
            ...
            # standardizer.tautomer_parent(mol) #  [OLD] rdkit-pypi

            # Final Rules
            # mol = standardizer.standardize(mol) # [OLD] rdkit-pypi
