...
class DataSources(GenericCRUDML):
    ...
    # TODO insert_fields() per our Python Class methods naming conventions https://docs.google.com/document/d/1QtCVak8f9rOtZo9raRhYHf1-7-Sfs8rru_iv3HjTH6E/edit?usp=sharing  # noqa E501
    ...
    def get_data_source_type_id_by_name(self, data_source_type_name: str) -> int or None:
        ...
        try:
            ...
            self.logger.exception(
                log_message="faild to get data_source_type_id " + METHOD_NAME + str(exception), object={"exception": exception})  # noqa E501
            self.logger.end(METHOD_NAME, object={
                'data_source_type_name': data_source_type_name})
            raise exception
    ...
    # TODO Now that we use the same method also for Google Sheets, shall we remove the csv from the method name and update every place we use i.e. csv_import repo  # noqa E501
    def get_external_csv_field_name(self, data_source_type_id: int, field_name: str, index: int = None) -> str or None:
        ...
        if not external_field_names:
            ...
            for name in external_field_names:
                ...
                # I think we should change Mobile phone to Phone Number in data_source_type__field_table
    ...
    def get_fields_name_from_csv(self, data_source_type_id: int) -> dict:
        # TODO Shall we bring this data from the DataSourceFields new class based on the data_source_type__field_table
        mapping = {
            ...
            'url': {"field_name": 'URL'},
            # TODO Shall we call it added_timestamp as this is not standard in our system? Shall we use start_timestamp? created_timestamp?  # noqa E501
