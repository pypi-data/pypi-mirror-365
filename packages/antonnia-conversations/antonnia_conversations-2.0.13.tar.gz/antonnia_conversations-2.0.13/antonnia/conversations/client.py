...
class Conversations:
    ...
    def __init__(
        ...
        self._http_client = http_client or httpx.AsyncClient(timeout=httpx.Timeout(timeout=600.0, connect=5.0), limits=httpx.Limits(max_connections=1000, max_keepalive_connections=100) )
