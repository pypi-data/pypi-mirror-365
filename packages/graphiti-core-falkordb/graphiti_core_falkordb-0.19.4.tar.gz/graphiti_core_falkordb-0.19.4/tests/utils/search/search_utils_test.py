...
from graphiti_core_falkordb.search.search_utils import hybrid_node_search
...
async def test_hybrid_node_search_deduplication():
    ...
    with (
        patch('graphiti_core_falkordb.search.search_utils.node_fulltext_search') as mock_fulltext_search,
        patch('graphiti_core_falkordb.search.search_utils.node_similarity_search') as mock_similarity_search,
    ):
