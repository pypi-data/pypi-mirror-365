...
try:
    from graphiti_core_falkordb.driver.falkordb_driver import FalkorDriver, FalkorDriverSession
...
class TestFalkorDriver:
    ...
    def setup_method(self):
        ...
        with patch('graphiti_core_falkordb.driver.falkordb_driver.FalkorDB'):
    ...
    def test_init_with_connection_params(self):
        ...
        with patch('graphiti_core_falkordb.driver.falkordb_driver.FalkorDB') as mock_falkor_db:
            driver = FalkorDriver(
    ...
    def test_init_with_falkor_db_instance(self):
        ...
        with patch('graphiti_core_falkordb.driver.falkordb_driver.FalkorDB') as mock_falkor_db_class:
    ...
    async def test_execute_query_handles_index_already_exists_error(self):
        ...
        with patch('graphiti_core_falkordb.driver.falkordb_driver.logger') as mock_logger:
...
class TestDatetimeConversion:
    ...
    def test_convert_datetime_dict(self):
        ...
        from graphiti_core_falkordb.driver.falkordb_driver import convert_datetimes_to_strings
