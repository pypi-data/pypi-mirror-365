...
from graphiti_core_falkordb.graph_queries import get_recent_date_filter, get_nodes_query
...
async def get_entities_paginated(
    ...
    if search and search.strip():
        ...
        try:
            ...
            # Get name matches directly from database using database-agnostic query
            name_query = (
                get_nodes_query(graphiti.driver.provider, 'node_name_and_summary', '$name_query')
                + """
