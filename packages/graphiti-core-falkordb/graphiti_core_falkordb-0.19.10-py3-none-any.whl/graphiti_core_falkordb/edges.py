...
from graphiti_core_falkordb.errors import EdgeNotFoundError, GroupsEdgesNotFoundError
...
from graphiti_core_falkordb.graph_queries import get_entity_edge_save_query
from graphiti_core_falkordb.nodes import Node
...
class EntityEdge(Edge):
    ...
    async def save(self, driver: GraphDriver):
        ...
        query = get_entity_edge_save_query(driver.provider)
        result = await driver.execute_query(
            query,
            edge_data=edge_data,
        )
