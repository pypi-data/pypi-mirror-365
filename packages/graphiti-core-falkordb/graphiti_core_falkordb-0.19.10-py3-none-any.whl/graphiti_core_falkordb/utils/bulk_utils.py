...
from graphiti_core_falkordb.driver.driver import GraphDriver, GraphDriverSession
from graphiti_core_falkordb.edges import Edge, EntityEdge, EpisodicEdge, create_entity_edge_embeddings
from graphiti_core_falkordb.embedder import EmbedderClient
from graphiti_core_falkordb.graph_queries import (
    get_entity_edge_save_bulk_query,
    get_entity_node_save_bulk_query,
)
from graphiti_core_falkordb.graphiti_types import GraphitiClients
from graphiti_core_falkordb.helpers import normalize_l2, semaphore_gather
...
from graphiti_core_falkordb.nodes import EntityNode, EpisodeType, EpisodicNode, create_entity_node_embeddings
...
async def add_nodes_and_edges_bulk_tx(
    ...
    # Handle FalkorDB's list of queries vs Neo4j's single query
    if isinstance(entity_node_save_bulk, list):
        # FalkorDB returns a list of (query, params) tuples
        for query, params in entity_node_save_bulk:
            await tx.run(query, **params)
    else:
        # Neo4j returns a single query string
