...
class FalkorDriver(GraphDriver):
    ...
    async def execute_query(self, cypher_query_, **kwargs: Any):
        ...
        # Extract params from kwargs if provided (for compatibility with search functions)
        params_dict = kwargs.pop('params', {})

        # Merge params with other kwargs, giving priority to direct kwargs
        all_params = {**params_dict, **kwargs}

        # Convert datetime objects to ISO strings (FalkorDB does not support datetime objects directly)
        params = convert_datetimes_to_strings(all_params)
        ...
        try:
            ...
            if 'already indexed' in str(e):
                ...
                return None
            logger.error(f'Error executing FalkorDB query: {e}' + cypher_query_ + str(params))
            raise
