...
from graphiti_core_falkordb.edges import EntityEdge, get_entity_edge_from_record
...
from graphiti_core_falkordb.nodes import (
    ENTITY_NODE_RETURN,
    CommunityNode,
    EntityNode,
    EpisodicNode,
...
from graphiti_core_falkordb.search.search_filters import (
    SearchFilters,
...
async def edge_fulltext_search(
    ...
    # Add remaining parameters to filter_params to avoid conflicts
...
async def edge_similarity_search(
    ...
    # Add remaining parameters to query_params to avoid conflicts
    query_params.update({
