...
async def get_entities_paginated(
    ...
    if search and search.strip():
        ...
        try:
            ...
            from graphiti_core.search.search_config import EdgeSearchMethod, NodeSearchMethod, EdgeReranker, NodeReranker
            from graphiti_core.search.search_filters import SearchFilters

            # First, do a direct name-only search using database query
            from graphiti_core.search.search_utils import lucene_sanitize
