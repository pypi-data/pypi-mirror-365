...
MESSAGES: Dict[str, Dict[str, str]] = {
    'zh': {
        ...
        'help_lang': '切换语言',
        'help_tools': '工具管理',
        'help_tools_install': '安装必需工具',
        'help_tools_mihomo': '安装 Mihomo 内核',
        'help_tools_yq': '安装 YQ 工具',
        'help_tools_update': '更新工具',
        'help_tools_download_guide': '显示手动下载指导',
    },
    'en': {
        # 代理状态消息
        ...
        # 帮助信息
        'help_init': 'Initialize clash-cli environment',
        ...
        'help_tools': 'Tool management',
        'help_tools_install': 'Install required tools',
        'help_tools_mihomo': 'Install Mihomo kernel',
        'help_tools_yq': 'Install YQ tool',
        'help_tools_update': 'Update tools',
        'help_tools_download_guide': 'Show manual download guide',
    }
}
...
Commands:
    init                 Initialize clash-cli environment
