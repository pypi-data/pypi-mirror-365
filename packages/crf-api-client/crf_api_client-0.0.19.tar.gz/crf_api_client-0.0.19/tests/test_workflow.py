...
def test_data_dir():
    ...
    base_dir = os.getenv("CRF_TEST_DATA_DIR", "tests/data")
    return Path(base_dir)


@pytest.fixture
def input_pdfs_dir(test_data_dir):
    """Fixture to provide the input PDFs directory path."""
    pdf_dir = test_data_dir / "input_pdfs"
...
def test_complete_workflow(client, input_pdfs_dir):
    ...
    try:
        ...
        chunks_data = chunks_table.get_data(limit=100)
