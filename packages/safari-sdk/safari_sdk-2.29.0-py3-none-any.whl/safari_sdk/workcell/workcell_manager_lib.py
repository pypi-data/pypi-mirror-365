...
class WorkcellManager:
  ...
  def __init__(
    ...
    elif robotics_platform in ergo_lib.robotics_platform_to_ergo_parameters_map:
      self._ergo_parameters = (
          ergo_lib.robotics_platform_to_ergo_parameters_map[robotics_platform]
      )
