...
atari_ergo_parameters = ErgoParameters(
...
aloha_ergo_parameters = ErgoParameters(
...
omega_star_ergo_parameters = ErgoParameters(
    alert_delay_seconds=30.0 * 60.0,
    popup_delay_seconds=30.0 * 60.0,
    requirements_list_minutes=[
        BreakRequirement(
...
robotics_platform_to_ergo_parameters_map: dict[str, ErgoParameters] = {
    "aloha": aloha_ergo_parameters,
    "omega_star": omega_star_ergo_parameters,
    "atari": atari_ergo_parameters,
}
