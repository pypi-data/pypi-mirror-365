...
DB_URL = "mysql+pymysql://root:unieai2025@192.168.240.1:3306/testdb"
...
def main():
    ...
    @mcp.tool()
    def add_booking(room_name: str, reserved_by: str, start_time: str, end_time: str) -> str:
    ...
    @mcp.tool()
    def update_booking(booking_id: int, room_name: str = None, reserved_by: str = None,
