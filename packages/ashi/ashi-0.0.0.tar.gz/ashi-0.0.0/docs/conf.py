...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("ashi")
...
html_title = "ashi"
# html_favicon = "../logo/ashi-favicon-color.png"
# html_logo = "../logo/ashi-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://ashi.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/ashi",
    "repo_name": "bernardodionisi/ashi",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/ashi",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/ashi/",
        },
    ],
    "edit_uri": "",
...
#     member for member in dir(ashi.Array) if inspect.isdatadescriptor(getattr(type(ashi.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(ashi._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(ashi._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(ashi.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(ashi._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(ashi.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(ashi.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(ashi._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(ashi._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(ashi._domains._meta.ArrayMeta, p)
#     delattr(ashi._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(ashi.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(ashi._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(ashi._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)
