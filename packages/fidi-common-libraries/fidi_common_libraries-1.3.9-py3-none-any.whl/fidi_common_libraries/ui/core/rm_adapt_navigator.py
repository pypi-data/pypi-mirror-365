...
class RMAdaptNavigator:
    ...
    def navigate_to_element(
        ...
        Localiza e clica em um elemento usando os critérios fornecidos,
        ...
        Returns:
            HwndWrapper: Elemento encontrado e clicado.
        ...
        try:
            logger.info(f"Navegando para elemento - Title: {title}, AutoID: {auto_id}, Type: {control_type}")
            ...
            self._wait_for_element_ready(element, timeout, retry_interval, max_retries)
