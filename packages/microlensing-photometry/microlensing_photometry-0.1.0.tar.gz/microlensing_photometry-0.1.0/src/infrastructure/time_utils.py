...
def calc_hjd(dateobs, RA, Dec, tel_code, exp_time, debug=False):
    ...
    Parameters:
        ...
        RA       str  RA of the target or frame center in decimal degrees, J2000.0
        Dec      str  Dec of the target or frame center in decimal degrees, J2000.0
    ...
    star = SkyCoord(RA, Dec, unit=(u.degree, u.degree), frame='icrs')
...
if __name__ == '__main__':
    ...
    print('Calculated HJD=' + str(hjd) + ' and LTT helio=' + str(ltt_helio))