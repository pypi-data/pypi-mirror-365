...
extras_require = \
{':python_version == "2.7" or python_version >= "3.5" and python_version < "3.9" or python_version >= "3.12" and python_version < "4.0"': ['pyx-core>=1.23'],
 ':python_version >= "3.7" and python_version < "4.0"': ['pyx-webservice>=1.23'],
 ':python_version >= "3.9" and python_version < "3.12"': ['pyx-core'],
 'all:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.23',
                                                                                       'pyc-core>=1.11'],
 'all:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>=1.23'],
 'client:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>=1.23'],
 'confluence:python_version >= "3.7"': ['atlassian-python-api>=3.14'],
 'core:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.23',
                                                                                        'poetry-core>=1.0'],
 'core:python_version >= "3.8"': ['poetry-dynamic-versioning>=1.8'],
 'devel:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.23',
                                                                                         'pyc-core>=1.11'],
 ...
 'lint:python_version >= "3.8" and python_version < "4.0"': ['black>=24.1',
                                                             'black>=24.1'],
 'meson:python_version >= "3.8"': ['meson>=1.8'],
 'poetry:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>=1.23']}
