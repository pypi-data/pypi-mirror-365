...
from range_tools import canonicalize_range, slice_to_offset_range
...
class ReplaceOffsetRange(SliceAssignmentAction):
    ...
    def __new__(cls, offset_start, offset_stop, offset_step):
        ...
        instance.offset_start, instance.offset_stop, instance.offset_step = canonicalize_range(
            offset_start, offset_stop, offset_step
        )
        return instance
