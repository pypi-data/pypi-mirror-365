...
def needle_jacobian(Jx_needle, x_needle: dqrobotics._dqrobotics.DQ, ps_vessel: list[dqrobotics._dqrobotics.DQ], ns_vessel: list[dqrobotics._dqrobotics.DQ]):
    ...
    """
def needle_w(x_needle: dqrobotics._dqrobotics.DQ, ps_vessel: list[dqrobotics._dqrobotics.DQ], ns_vessel: list[dqrobotics._dqrobotics.DQ], needle_radius: float, vfi_gain_planes: float, vfi_gain_radius: float, vfi_gain_angles: float, d_safe_planes: float, d_safe_radius: float, verbose: bool):
    """
