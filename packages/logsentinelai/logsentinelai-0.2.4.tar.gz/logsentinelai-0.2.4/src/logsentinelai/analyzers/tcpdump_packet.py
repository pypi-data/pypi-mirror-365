...
from ..core.models import GeoIPInfo, IPStatistic
...
class SecurityEvent(BaseModel):
    ...
    source_ip: GeoIPInfo = Field(description="Source IP address with GeoIP information")
    dest_ip: GeoIPInfo = Field(description="Destination IP address with GeoIP information")
...
class Statistics(BaseModel):
    ...
    top_source_addresses: list[IPStatistic] = Field(description="Top source IP addresses with packet counts and GeoIP information", default_factory=list)
    top_destination_addresses: list[IPStatistic] = Field(description="Top destination IP addresses with packet counts and GeoIP information", default_factory=list)
