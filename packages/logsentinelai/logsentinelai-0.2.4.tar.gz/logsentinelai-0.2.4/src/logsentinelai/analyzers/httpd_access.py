...
class SecurityEvent(BaseModel):
    ...
    source_ips: list[GeoIPInfo] = Field(description="Source IP list with GeoIP information")
...
class Statistics(BaseModel):
    ...
    top_source_ips: list[IPStatistic] = Field(default_factory=list, description="Top requesting IPs with GeoIP information")
