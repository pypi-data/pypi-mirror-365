...
GEOIP_CONFIG = {
    ...
    # database_path uses City database by default (includes country + city + coordinates):
    # - GeoLite2-City.mmdb: provides country, city, latitude, longitude (recommended)
    # - GeoLite2-Country.mmdb: provides country information only (legacy)
