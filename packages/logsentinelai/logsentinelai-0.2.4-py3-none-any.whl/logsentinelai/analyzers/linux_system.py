...
class SecurityEvent(BaseModel):
    ...
    source_ip: Optional[GeoIPInfo] = Field(description="Source IP with GeoIP information")
...
class Statistics(BaseModel):
    ...
    top_event_ips: list[IPStatistic] = Field(default_factory=list, description="Top source IPs with GeoIP information")
