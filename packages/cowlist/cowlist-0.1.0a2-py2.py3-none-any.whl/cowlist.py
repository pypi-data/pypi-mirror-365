...
def handle_replace_offset_range(items, replaced_offset_range, replacements):
    # type: (Iterable[T], range, Sequence[T]) -> Iterator[T]
...
class COWList(Sequence[T]):
    ...
    def _new_instance_with_new_physical_offsets(self, new_physical_offsets):
        # type: (SelfCOWList, range) -> SelfCOWList
    ...
    def _new_instance_from_in_order_physical_implementation(cls, in_order_physical_implementation):
        ...
        physical_offsets = range(len(in_order_physical_implementation))
    ...
    def delete(self, index_or_slice):
        ...
        physical_offsets = self.physical_offsets  # type: range
        ...
        if -length <= index <= length:
            ...
            if not sequence_length:
                ...
                if not physical_offsets_right:
                    ...
                    if extended_by == range(physical_length, physical_length + sequence_length):
