...
class TestAPIBasedCategorization:
    ...
    @pytest.mark.api
    @pytest.mark.asyncio
    async def test_test_files_skip_tdd(self, tdd_validator_with_api: TDDValidator) -> None:
    ...
    @pytest.mark.api
    @pytest.mark.asyncio
    async def test_fallback_behavior(self, tdd_validator_no_api: TDDValidator) -> None:
        """Test categorization without API key."""
        result = await tdd_validator_no_api.categorize_file(
