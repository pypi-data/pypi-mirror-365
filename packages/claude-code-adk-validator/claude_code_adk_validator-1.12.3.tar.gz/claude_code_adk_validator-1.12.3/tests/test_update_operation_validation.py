...
@pytest.mark.skipif(not os.environ.get("GEMINI_API_KEY"), reason="Requires GEMINI_API_KEY for TDD validation")
...
"""
        ...
        assert "2" in result["reason"]  # Should mention 2 new tests
