...
setup(
    ...
    install_requires=[
        ...
        "toml",
        "auto-argparse",
        #        "rlpyt @ git+https://github.com/astooke/rlpyt.git", # SIC:
        #        cannot be included in pypi distribution. Need to add to
        #        README and in code that this should be installed manually. 
        "gym",
    ],
