...
def run_clustering(graph, size=60, max_generations=500, workers=-1, seed=None):
...
if __name__ == "__main__":
    run_clustering(graph='synthetic.graph', size=60, max_generations=200, workers=16, seed=None)
