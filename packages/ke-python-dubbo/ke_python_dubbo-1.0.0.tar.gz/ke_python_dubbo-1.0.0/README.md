copy from https://github.com/RitterHou/python-dubbo
 **基于python3 版本的修改** 
...
zk = ZkRegister(hosts='zkserver1:2181,zkserver2:2181,zkserver3:2181', path='/path/dubbo', user='user', password='pass', application_name='my-python-app)
dubbo = DubboClient(interface='com.test.demo.DemoFacade', zk_register=zk, version='1.0.0')

params = Object('com.test.demo.Param')
params['user_id'] = 12233344455
        
# 创建 CustomerTypeEnum 枚举对象，使用 NO_LIMIT
typeParams = Object('com.test.demo.XXTypeEnum', values={
    'name': 'NO_LIMIT'
})

dubbo.call('searchCustomerList', [params, typeParams])
```
