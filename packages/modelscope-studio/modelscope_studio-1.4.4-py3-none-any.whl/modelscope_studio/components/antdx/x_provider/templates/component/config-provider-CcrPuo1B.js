import { Z as L, g as vt, a as Be, c as xt } from "./XProvider-Cc8sbsFV.js";
import { a as Ct, b as de, r as kt, c as Et } from "./Index-DzEZ0Y4f.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-CRrhmLCT.js").then((e) => e.a), import("./ar-BEy1EZEC.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-C8bRCRTR.js").then((e) => e.a), import("./az-Crm1hvrO.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-BOEVyk0F.js").then((e) => e.b), import("./bg-6bc-RhtV.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-B7qr_50W.js").then((e) => e.b), import("./bn-D7uVxeAq.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-sy5EHPm-.js").then((e) => e.b),
      import("./be-Dp4MWFsZ.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-DmmI_Z3g.js").then((e) => e.c), import("./ca-Bs9-_TPf.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-CW60MU3K.js").then((e) => e.c), import("./cs-D0b1YKpQ.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-BWGzT2xV.js").then((e) => e.d), import("./da-CBGwKmWV.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-0zaTc6B_.js").then((e) => e.d), import("./de-Ca0wsycq.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-DUpTyfyZ.js").then((e) => e.e), import("./el-BZd0t2UX.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-BtGXDD3t.js").then((e) => e.e), import("./en-gb-nXqL5E-S.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-CAgFIqQq.js").then((e) => e.e), import("./es-msnvXVV4.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-DM3lsVW9.js").then((e) => e.e), import("./et-C3E8uEop.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-BXJ0mm7E.js").then((e) => e.e),
      import("./eu-DLk0fb3z.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-DZ4rGtDs.js").then((e) => e.f), import("./fa-BdJnHbnI.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-DH_Mf4zq.js").then((e) => e.f), import("./fi-DG5dp1T9.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-1wgq_HyM.js").then((e) => e.f), import("./fr-fWMvcxSU.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-CJioLt9d.js").then((e) => e.f), import("./fr-ca-B4MuwSsY.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-BL6F_Rf_.js").then((e) => e.f), import("./fr-fWMvcxSU.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-BPqWFlUQ.js").then((e) => e.g),
      import("./ga-uIk6xD-2.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-CjZm5Exn.js").then((e) => e.g),
      import("./gl-QtfNAs95.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-fDA8xoNB.js").then((e) => e.h), import("./he-DYZek5X2.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-DNzSoxOp.js").then((e) => e.h), import("./hi-CJNnx6tD.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-DWe_26CE.js").then((e) => e.h), import("./hr-BeUnGNlJ.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-CSWAMheG.js").then((e) => e.h), import("./hu-ihi4a4JS.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-m54sSKg3.js").then((e) => e.h),
      import("./am-hvlufKIH.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-DBTc3qjb.js").then((e) => e.i), import("./id-Cd-OITob.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-2UmhB8nx.js").then((e) => e.i), import("./is-DzabjNSg.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-B_mS3_wO.js").then((e) => e.i), import("./it-BZMql0ca.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-DQ4VUd9E.js").then((e) => e.j), import("./ja-BOfWBt3k.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-Be6WyIqO.js").then((e) => e.k),
      import("./ka-3B5176Bg.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-wCb5lrGN.js").then((e) => e.k),
      import("./kk-CLQY6hEo.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-BpoW02RF.js").then((e) => e.k),
      import("./km-q6bHkqFP.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-oG9D-pQc.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-DYlvDCay.js").then((e) => e.k),
      import("./kn-Dl5psj2Q.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-BIqYjFwG.js").then((e) => e.k), import("./ko-B3fyqW5U.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-C5v_v8uU.js").then((e) => e.k),
      import("./ku-DLhJNeeb.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-HQh1xI9E.js").then((e) => e.l), import("./lt-4SSTvKQC.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-DKVb2Rhi.js").then((e) => e.l), import("./lv-VRaBsJdx.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-DvGjzowN.js").then((e) => e.m),
      import("./mk-Byj4u-4g.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-CqghA4ir.js").then((e) => e.m),
      import("./ml-D_Gm_jQ3.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-BvzPYL25.js").then((e) => e.m),
      import("./mn-6_g6zepL.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-BTtWVjx8.js").then((e) => e.m), import("./ms-BMmQDXW7.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-CZd3e2oj.js").then((e) => e.m),
      import("./my-CCFPVEJW.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-DAcObBa0.js").then((e) => e.n),
      import("./nb-DF1j0N0F.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-BzT2NT0J.js").then((e) => e.n),
      import("./ne-D2S1qNQ9.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-BG5ZDr46.js").then((e) => e.n),
      import("./nl-be-DBxr7Gnk.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-aJ7t3Uch.js").then((e) => e.n),
      import("./nl-H8uK4Lwy.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-BdThFRo3.js").then((e) => e.p), import("./pl-xy4vm_f3.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-CYzeProH.js").then((e) => e.p),
      import("./pt-br-C8Suk6HM.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-gnUh4GzF.js").then((e) => e.p),
      import("./pt-D7WYvK_u.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-aEBQC5Ut.js").then((e) => e.r), import("./ro-BBgsezb3.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-DQFy5cYA.js").then((e) => e.r), import("./ru-B4GQx6av.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-BVdqJceK.js").then((e) => e.s),
      import("./si-DzKhjE-C.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-B3KI5C6g.js").then((e) => e.s), import("./sk-CcK6BNkU.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-V01Nrrjx.js").then((e) => e.s), import("./sl-B_B1BYzy.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-RLpCVXJF.js").then((e) => e.s),
      import("./sr-C39KR9zG.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-BnA-dej7.js").then((e) => e.s), import("./sv-CM0Wigpw.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-kSlfqTFp.js").then((e) => e.t),
      import("./ta-D0EdB-Qo.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-CB9MuyMz.js").then((e) => e.t), import("./th-C-uzLfRj.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-6fb_sClM.js").then((e) => e.t),
      import("./tk--86WURo4.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-BbC8EPaU.js").then((e) => e.t), import("./tr-Dxe4NJRO.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-BkJxhSnZ.js").then((e) => e.u),
      import("./uk-DlhuM2LU.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-B_3anPi4.js").then((e) => e.u),
      import("./ur-UQNgTXRZ.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-C5nkA3yO.js").then((e) => e.u),
      import("./uz-Cgez13ga.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-COsa8785.js").then((e) => e.v), import("./vi-uwH2I-Zb.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-KCWLbtJ0.js").then((e) => e.z),
      import("./zh-cn-Dy6vTLN1.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-DxD8cydI.js").then((e) => e.z),
      import("./zh-hk-B7b7pj1-.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-BXntyJv6.js").then((e) => e.z),
      import("./zh-tw-sj06DAWL.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
