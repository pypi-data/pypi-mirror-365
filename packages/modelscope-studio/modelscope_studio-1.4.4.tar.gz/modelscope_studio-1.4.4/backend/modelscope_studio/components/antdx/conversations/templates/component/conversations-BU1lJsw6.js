import { i as rr, a as ke, r as nr, Z as te, g as or, c as Q, b as wt } from "./Index-DHoH0y15.js";
...
function _r(t, e, n) {
  ...
  function g(S) {
    var P = o, O = r;
    return o = r = void 0, c = S, s = t.apply(O, P), s;
  }
  function m(S) {
    return c = S, a = setTimeout(v, e), f ? g(S) : s;
  }
  function y(S) {
    var P = S - l, O = S - c, E = e - P;
    return u ? Cr(E, i - O) : E;
  }
  function h(S) {
    var P = S - l, O = S - c;
    return l === void 0 || P >= e || P < 0 || u && O >= i;
  }
  function v() {
    var S = Ce();
    if (h(S))
 ...
 */
var wr = x, Tr = Symbol.for("react.element"), Pr = Symbol.for("react.fragment"), Mr = Object.prototype.hasOwnProperty, Or = wr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Er = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
function Ot(t, e, n) {
  ...
  for (o in e) Mr.call(e, o) && !Er.hasOwnProperty(o) && (r[o] = e[o]);
...
function Ur(t) {
  ...
  return {
    c() {
      e = It("react-portal-target"), n = Br(), i && i.c(), o = rt(), this.h();
    },
    l(s) {
...
var At = /* @__PURE__ */ le(function t() {
  ae(this, t);
}), zt = "CALC_UNIT", bn = new RegExp(zt, "g");
function we(t) {
...
var yn = /* @__PURE__ */ function(t) {
  ...
  function n(o, r) {
    var i;
    ae(this, n), i = e.call(this), M(q(i), "result", ""), M(q(i), "unitlessCssVar", void 0), M(q(i), "lowPriority", void 0);
    var s = A(o);
  ...
  function n(o) {
    var r;
    return ae(this, n), r = e.call(this), M(q(r), "result", 0), o instanceof n ? r.result = o.result : typeof o == "number" && (r.result = o), r;
  }
  return le(n, [{
    key: "add",
    value: function(r) {
...
var dt = Sn() ? F.useLayoutEffect : F.useEffect, Cn = function(e, n) {
  var o = F.useRef(!0);
  dt(function() {
    return e(o.current);
  }, n), dt(function() {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var Xe = Symbol.for("react.element"), Fe = Symbol.for("react.portal"), ce = Symbol.for("react.fragment"), ue = Symbol.for("react.strict_mode"), fe = Symbol.for("react.profiler"), de = Symbol.for("react.provider"), he = Symbol.for("react.context"), wn = Symbol.for("react.server_context"), ge = Symbol.for("react.forward_ref"), me = Symbol.for("react.suspense"), pe = Symbol.for("react.suspense_list"), be = Symbol.for("react.memo"), ye = Symbol.for("react.lazy"), Tn = Symbol.for("react.offscreen"), Bt;
...
w.isValidElementType = function(t) {
  return typeof t == "string" || typeof t == "function" || t === ce || t === fe || t === ue || t === me || t === pe || t === Tn || typeof t == "object" && t !== null && (t.$$typeof === ye || t.$$typeof === be || t.$$typeof === de || t.$$typeof === he || t.$$typeof === ge || t.$$typeof === Bt || t.getModuleId !== void 0);
};
w.typeOf = H;
Number(tr.split(".")[0]);
function mt(t, e, n, o) {
...
var Xt = typeof CSSINJS_STATISTIC < "u", ze = !0;
function Ve() {
...
var En = 1e3 * 60 * 10, jn = /* @__PURE__ */ function() {
  function t() {
    ae(this, t), M(this, "map", /* @__PURE__ */ new Map()), M(this, "objectIDMap", /* @__PURE__ */ new WeakMap()), M(this, "nextID", 0), M(this, "lastAccessBeat", /* @__PURE__ */ new Map()), M(this, "accessBeat", 0);
  }
  return le(t, [{
    key: "set",
    value: function(n, o) {
...
function Ln(t) {
  ...
  function l(d, g, m, y) {
    ...
    var p = (y == null ? void 0 : y.unitless) || {}, T = typeof a == "function" ? a(d) : {}, b = L(L({}, T), {}, M({}, v("zIndexPopup"), !0));
    ...
    return function(O) {
      var E = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : O, R = S(O, E), z = N(R, 2), _ = z[1], B = P(E), k = N(B, 2), $ = k[0], D = k[1];
      return [$, _, D];
    };
  }
  function c(d, g, m) {
    var y = m.unitless, h = m.injectStyle, v = h === void 0 ? !0 : h, p = m.prefixToken, T = m.ignore, b = function(P) {
      var O = P.rootCls, E = P.cssVar, R = E === void 0 ? {} : E, z = o(), _ = z.realToken;
      return cr({
        path: [d],
        prefix: R.prefix,
        key: R.key,
  ...
  function f(d, g, m) {
    ...
    return function(C) {
      var S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : C, P = o(), O = P.theme, E = P.realToken, R = P.hashId, z = P.token, _ = P.cssVar, B = r(), k = B.rootPrefixCls, $ = B.iconPrefixCls, D = n(), W = _ ? "css" : "js", Ne = In(function() {
        var V = /* @__PURE__ */ new Set();
        return _ && Object.keys(y.unitless || {}).forEach(function(Y) {
          V.add(Se(Y, _.prefix)), V.add(Se(Y, ut(p, _.prefix)));
        }), xn(W, V);
      }, [W, p, _ == null ? void 0 : _.prefix]), ve = On(W), Ge = ve.max, xe = ve.min, Ue = {
        theme: O,
        token: z,
        hashId: R,
        nonce: function() {
      ...
      var Ut = Qe(L(L({}, Ue), {}, {
        ...
        if (y.injectStyle === !1)
          return [];
        var V = Mn(z), Y = V.token, Wt = V.flush, G = bt(p, E, m), Kt = ".".concat(C), We = mt(p, E, G, {
...
const {
  ...
  const {
    ...
    getPrefixCls: T,
    direction: b
  } = He(), C = T("conversations", e), S = un("conversations"), [P, O, E] = Kn(C), R = Q(C, S.className, u, n, O, E, {
    [`${C}-rtl`]: b === "rtl"
  }), z = (_) => {
    h(_.key), s && s(_.key);
  };
...
const lo = qr(Yn(["menu.items"], to(["default", "items"], ({
  ...
  const {
    ...
    items: u
  } = eo(), d = u.items.length > 0 ? u.items : u.default, g = je(() => o || Be(d, {
    clone: !0
  }), [o, d]);
