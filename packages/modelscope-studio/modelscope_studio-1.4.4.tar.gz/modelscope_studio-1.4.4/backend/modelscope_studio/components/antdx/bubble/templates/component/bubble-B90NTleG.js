...
function Br(t) {
  ...
  return {
    ...
    p(s, [a]) {
      ...
      16 && de(i, 1)) : (i = ot(s), i.c(), de(i, 1), i.m(o.parentNode, o)) : i && (Mr(), ze(i, 1, 1, () => {
        i = null;
      }), Sr());
    },
    i(s) {
...
const Ar = ["animationIterationCount", "borderImageOutset", "borderImageSlice", "borderImageWidth", "boxFlex", "boxFlexGroup", "boxOrdinalGroup", "columnCount", "columns", "flex", "flexGrow", "flexPositive", "flexShrink", "flexNegative", "flexOrder", "gridArea", "gridColumn", "gridColumnEnd", "gridColumnStart", "gridRow", "gridRowEnd", "gridRowStart", "lineClamp", "lineHeight", "opacity", "order", "orphans", "tabSize", "widows", "zIndex", "zoom", "fontWeight", "letterSpacing", "lineHeight"];
function Fr(t) {
...
function Xr(t, e) {
  return typeof e == "number" && !Ar.includes(t) ? e + "px" : e;
}
function Ae(t) {
...
const U = At(({
  ...
  return Nt(() => {
    ...
    function d() {
      let p = u;
      if (u.tagName.toLowerCase() === "svelte-slot" && u.children.length === 1 && u.children[0] && (p = u.children[0], p.tagName.toLowerCase() === "react-portal-target" && p.children[0] && (p = p.children[0])), Nr(i, p), n && p.classList.add(...n.split(" ")), o) {
        const y = Fr(o);
...
var Lt = typeof CSSINJS_STATISTIC < "u", Xe = !0;
function We() {
...
function wn(t) {
  ...
  function c(d, x, b, S) {
    ...
    return function(P) {
      var I = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : P, E = m(P, I), k = he(E, 2), L = k[1], O = _(I), M = he(O, 2), $ = M[0], z = M[1];
      return [$, L, z];
    };
  }
  function l(d, x, b) {
  ...
  function f(d, x, b) {
    ...
    return function(v) {
      var m = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : v, _ = o(), P = _.theme, I = _.realToken, E = _.hashId, k = _.token, L = _.cssVar, O = r(), M = O.rootPrefixCls, $ = O.iconPrefixCls, z = n(), A = L ? "css" : "js", V = Cn(function() {
        var W = /* @__PURE__ */ new Set();
        return L && Object.keys(S.unitless || {}).forEach(function(q) {
          W.add(Ie(q, L.prefix)), W.add(Ie(q, ut(C, L.prefix)));
        }), fn(A, W);
      }, [A, C, L == null ? void 0 : L.prefix]), K = vn(A), ee = K.max, se = K.min, Y = {
        theme: P,
        token: k,
        hashId: E,
        nonce: function() {
      ...
      var Re = Ye(H(H({}, Y), {}, {
        ...
        if (S.injectStyle === !1)
          return [];
        var W = yn(k), q = W.token, te = W.flush, N = gt(C, I, b), re = ".".concat(v), Ge = dt(C, I, N, {
          deprecatedTokens: S.deprecatedTokens
        });
        L && N && X(N) === "object" && Object.keys(N).forEach(function(qe) {
          N[qe] = "var(".concat(Ie(qe, ut(C, L.prefix)), ")");
        });
        var Ke = We(q, {
          componentCls: re,
          prefixCls: v,
        ...
        te(C, Ge);
        var zt = typeof s == "function" ? s(Ke, v, m, S.resetFont) : null;
        return [S.resetStyle === !1 ? null : zt, Ht];
      });
      return [Re, E];
    };
  }
...
const Dn = ({
  ...
  const {
    direction: P,
    getPrefixCls: I
  } = me(), E = I("bubble", n), k = en("bubble"), [L, O, M, $] = Bn(d), [z, A] = $n(x, L, O, M);
  h.useEffect(() => {
    m == null || m();
  }, [z]);
  const V = h.useRef(!1);
  h.useEffect(() => {
    !A && !f ? V.current || (V.current = !0, y == null || y()) : V.current = !1;
  }, [A, f]);
  const [K, ee, se] = Bt(E), Y = Q(E, r, k.className, o, ee, se, `${E}-${l}`, {
    [`${E}-rtl`]: P === "rtl",
    [`${E}-typing`]: A && !f && !b && !$
  }), Re = h.useMemo(() => /* @__PURE__ */ h.isValidElement(c) ? c : /* @__PURE__ */ h.createElement(Zt, c), [c]), W = h.useMemo(() => b ? b(z) : z, [z, b]), q = (re) => typeof re == "function" ? re(z, {
    key: g
  }) : re;
  let te;
  f ? te = u ? u() : /* @__PURE__ */ h.createElement(Dn, {
    prefixCls: E
  }) : te = /* @__PURE__ */ h.createElement(h.Fragment, null, W, A && $);
  let N = /* @__PURE__ */ h.createElement("div", {
    style: {
      ...k.styles.content,
      ...a.content
    },
  ...
  return (C || j) && (N = /* @__PURE__ */ h.createElement("div", {
  ...
  }, q(C)), N, j && /* @__PURE__ */ h.createElement("div", {
    ...
    scrollTo: ({
      ...
      if (typeof M == "number")
        ...
        if (A) {
          ...
          _(V === v.length - 1), A.nativeElement.scrollIntoView({
            behavior: $,
            block: z
          });
        }
