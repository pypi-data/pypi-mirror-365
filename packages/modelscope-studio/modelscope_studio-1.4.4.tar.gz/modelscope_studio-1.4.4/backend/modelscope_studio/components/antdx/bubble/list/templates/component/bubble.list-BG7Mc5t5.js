import { i as Kt, a as J, r as qt, Z as ce, g as Yt, c as Y, b as Xe } from "./Index-CC6MGoiO.js";
...
var Nr = `accept acceptCharset accessKey action allowFullScreen allowTransparency
    ...
    onLoadStart onPause onPlay onPlaying onProgress onRateChange onSeeked onSeeking onStalled onSuspend onTimeUpdate onVolumeChange onWaiting onLoad onError`, Wr = "".concat(Nr, " ").concat(Vr).split(/[\s\n]+/), Ur = "aria-", Gr = "data-";
function ut(t, e) {
...
var Ht = typeof CSSINJS_STATISTIC < "u", Ae = !0;
function We() {
...
function Sn(t) {
  ...
  function d(f, h, m) {
    ...
    return function(C) {
      var S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : C, w = o(), P = w.theme, k = w.realToken, E = w.hashId, j = w.token, L = w.cssVar, O = r(), M = O.rootPrefixCls, $ = O.iconPrefixCls, D = n(), z = L ? "css" : "js", V = vn(function() {
        var W = /* @__PURE__ */ new Set();
        return L && Object.keys(y.unitless || {}).forEach(function(K) {
          W.add(Ie(K, L.prefix)), W.add(Ie(K, dt(x, L.prefix)));
        }), ln(z, W);
      }, [z, x, L == null ? void 0 : L.prefix]), G = pn(z), ee = G.max, ie = G.min, q = {
        theme: P,
        token: j,
        hashId: E,
        nonce: function() {
      ...
      var Oe = Je(H(H({}, q), {}, {
        ...
        if (y.injectStyle === !1)
          return [];
        var W = mn(j), K = W.token, te = W.flush, N = pt(x, k, m), re = ".".concat(C), Ke = gt(x, k, N, {
          deprecatedTokens: y.deprecatedTokens
        });
        L && N && X(N) === "object" && Object.keys(N).forEach(function(Ye) {
          N[Ye] = "var(".concat(Ie(Ye, dt(x, L.prefix)), ")");
        });
        var qe = We(K, {
          componentCls: re,
          prefixCls: C,
        ...
        te(x, Ke);
        var Xt = typeof i == "function" ? i(qe, C, S, y.resetFont) : null;
        return [y.resetStyle === !1 ? null : Xt, Ft];
      });
      return [Oe, E];
    };
  }
...
const Ln = ({
  ...
  const e = We(t, {});
  return [An(e), Hn(e), $n(e), Bn(e)];
}, Fn), At = /* @__PURE__ */ g.createContext({}), Xn = (t, e) => {
  const {
    prefixCls: n,
    className: o,
    rootClassName: r,
    ...
    onUpdate: S
  } = g.useContext(At), w = g.useRef(null);
  ...
  const {
    direction: P,
    getPrefixCls: k
  } = ge(), E = k("bubble", n), j = Qr("bubble"), [L, O, M, $] = jn(f), [D, z] = kn(h, L, O, M);
  g.useEffect(() => {
    S == null || S();
  }, [D]);
  const V = g.useRef(!1);
  g.useEffect(() => {
    !z && !d ? V.current || (V.current = !0, v == null || v()) : V.current = !1;
  }, [z, d]);
  const [G, ee, ie] = zt(E), q = Y(E, r, j.className, o, ee, ie, `${E}-${u}`, {
    [`${E}-rtl`]: P === "rtl",
    [`${E}-typing`]: z && !d && !m && !$
  ...
  d ? te = c ? c() : /* @__PURE__ */ g.createElement(Ln, {
    prefixCls: E
  }) : te = /* @__PURE__ */ g.createElement(g.Fragment, null, W, z && $);
...
const Vn = ({
  ...
  const {
    ...
    getPrefixCls: h
  } = ge(), m = h("bubble", n), y = `${m}-list`, [p, v, x] = zt(m), [R, b] = _.useState(!1);
  _.useEffect(() => (b(!0), () => {
    b(!1);
  }), []);
  const C = Nn(s, a), [S, w] = _.useState(!0), [P, k] = _.useState(0), E = (O) => {
    const M = O.target;
    ...
    scrollTo: ({
      ...
      if (typeof M == "number")
        ...
        if (z) {
          ...
          w(V === C.length - 1), z.nativeElement.scrollIntoView({
            behavior: $,
            block: D
          });
        }
  ...
  if (o.length !== 0)
    return o.map((r, s) => {
      ...
      Object.keys(r.slots).forEach((c) => {
        ...
        h instanceof Element ? m = h : (m = h.el, y = h.callback, p = h.clone ?? p, v = h.forceClone ?? v), v = v ?? !!y, a[f[f.length - 1]] = m ? y ? (...x) => (y(f[f.length - 1], x), /* @__PURE__ */ A.jsx(Qe, {
          ...r.ctx,
          params: x,
          forceClone: v,
...
const bo = Ar(oo(["roles"], ro(["items", "default"], ({
  items: t,
  roles: e,
  children: n,
  ...o
