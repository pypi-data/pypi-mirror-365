import { i as vt, a as de, r as xt, Z as L, g as St, b as jt, c as Be, d as Ct } from "./Index-CaoofIso.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-Cvw8gwpb.js").then((e) => e.a), import("./ar-DbAvYm7m.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-McU-8loA.js").then((e) => e.a), import("./az-bzSVpw0F.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-Bq0r4fAC.js").then((e) => e.b), import("./bg-D4UGI7oy.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-BmXCI1Pv.js").then((e) => e.b), import("./bn-B16g0o50.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-DsmyyIhc.js").then((e) => e.b),
      import("./be-Br_24-jp.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-C01O5E5Y.js").then((e) => e.c), import("./ca-BkurKeX7.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-BK22YAFF.js").then((e) => e.c), import("./cs-DfLor5uC.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-Dst-IGXZ.js").then((e) => e.d), import("./da-CmBBi1rc.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-DxKQE9qV.js").then((e) => e.d), import("./de-ysVqbmau.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-BIu_sD5d.js").then((e) => e.e), import("./el-oufTZGhg.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-7Sw5cJKe.js").then((e) => e.e), import("./en-gb-Nz5Zl1Cx.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-Bx3t7vFd.js").then((e) => e.e), import("./es-CSgBxt1o.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-BrBKFZ5i.js").then((e) => e.e), import("./et-CpN_nitU.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-Cbng6x6n.js").then((e) => e.e),
      import("./eu-BqNaQ_uH.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-CGTxfkJU.js").then((e) => e.f), import("./fa-j4VyukKt.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-CznzTtY5.js").then((e) => e.f), import("./fi-C5yW2xEY.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-DXvxY4po.js").then((e) => e.f), import("./fr-BFliFaGu.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-b19l_8Ql.js").then((e) => e.f), import("./fr-ca-46kpfjkh.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-CJNaNZq2.js").then((e) => e.f), import("./fr-BFliFaGu.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-CaVegqMw.js").then((e) => e.g),
      import("./ga-BCXiO8Lm.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-BmbEru0r.js").then((e) => e.g),
      import("./gl--Wkd7yK6.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-BoPYkLgB.js").then((e) => e.h), import("./he-BusVaGua.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-32yshS5T.js").then((e) => e.h), import("./hi-BG0PfaGx.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-D0FLqIst.js").then((e) => e.h), import("./hr-DLDQBMJC.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-NpWj_qFE.js").then((e) => e.h), import("./hu-B9fA7zvz.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-CQdvMbHT.js").then((e) => e.h),
      import("./am-DSiEvEEU.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-CVoqw3Ni.js").then((e) => e.i), import("./id-nql7RsCP.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-CowqlO6I.js").then((e) => e.i), import("./is-d5mE9T4J.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-CJ1tW2wu.js").then((e) => e.i), import("./it-D87RSCAP.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-B6ScAotN.js").then((e) => e.j), import("./ja-DBFZYEz6.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-Ca8E0ZGN.js").then((e) => e.k),
      import("./ka-D1HwuOOC.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-BqecEOvH.js").then((e) => e.k),
      import("./kk-B4Pg3ksA.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-CTDFZtfq.js").then((e) => e.k),
      import("./km-Cj_62Tbf.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-BZLtdbdX.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-Ds3kMzts.js").then((e) => e.k),
      import("./kn-CnfdLc4e.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-Ce3gsloP.js").then((e) => e.k), import("./ko-xTGMpWYB.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-B0PuVXyi.js").then((e) => e.k),
      import("./ku-CUX8iN8j.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-DYB0txIh.js").then((e) => e.l), import("./lt-DmiasIBJ.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-U4VcABXc.js").then((e) => e.l), import("./lv-m1QG8Xo_.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-DW_hJNYt.js").then((e) => e.m),
      import("./mk-T4ojB1HL.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-CyC06lHJ.js").then((e) => e.m),
      import("./ml-DR8_v-HE.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-DnCV2SRR.js").then((e) => e.m),
      import("./mn-DBLimFw6.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-Cu9CC5Fh.js").then((e) => e.m), import("./ms-BqdaCli0.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-DvxWdC9a.js").then((e) => e.m),
      import("./my-CmKuzxHD.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-CGrGbe_L.js").then((e) => e.n),
      import("./nb-DQEynXD5.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-BUjMH-Dh.js").then((e) => e.n),
      import("./ne-DCEXb2Iv.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-BfUQfhX8.js").then((e) => e.n),
      import("./nl-be-DAFml3p3.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-bHOqAO-i.js").then((e) => e.n),
      import("./nl-02eGHilH.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-D7dvHogh.js").then((e) => e.p), import("./pl-DGfplwfn.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-Ch-ckq0F.js").then((e) => e.p),
      import("./pt-br-TstmquzI.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-MbOUNh4Q.js").then((e) => e.p),
      import("./pt-CiScdDAF.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-DZlIJ1_D.js").then((e) => e.r), import("./ro-CAbBwlOA.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-35JmnMAZ.js").then((e) => e.r), import("./ru-Cy9Fugwn.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-D_qzsFMZ.js").then((e) => e.s),
      import("./si-sDC4AK6u.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK--NpiHGyq.js").then((e) => e.s), import("./sk-ZP3upEHg.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-NEGFpmO8.js").then((e) => e.s), import("./sl-BYNuLzNs.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-Cxu4Krru.js").then((e) => e.s),
      import("./sr-CwcPNl4o.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-BSuJzVHO.js").then((e) => e.s), import("./sv-B9v5-KMv.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-B7lk59nD.js").then((e) => e.t),
      import("./ta-ChFKDlIR.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-DqA4MIDQ.js").then((e) => e.t), import("./th-BlSCkHEW.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-DDGlQGWz.js").then((e) => e.t),
      import("./tk-PP4rKJqR.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-Dj2EsJUD.js").then((e) => e.t), import("./tr-ulmk22Av.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-E1VewacG.js").then((e) => e.u),
      import("./uk-Tj3SpYpc.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-CvTW3uJj.js").then((e) => e.u),
      import("./ur-DB5M3fET.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-DuV6fzaU.js").then((e) => e.u),
      import("./uz-CcRF6zz0.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-B-3dSjPG.js").then((e) => e.v), import("./vi-B1OKoHsX.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-Bh_-0Pvp.js").then((e) => e.z),
      import("./zh-cn-CoYrVbaM.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-B3nMD68s.js").then((e) => e.z),
      import("./zh-hk-Bgupxv8L.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-B6QTuEVj.js").then((e) => e.z),
      import("./zh-tw-1qd9t92w.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
