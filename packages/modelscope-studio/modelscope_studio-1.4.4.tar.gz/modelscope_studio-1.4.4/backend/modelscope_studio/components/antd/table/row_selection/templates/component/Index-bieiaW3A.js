...
function Un(e, t, n, r) {
  ...
  for (var o = -1, a = t.length; ++o < a; ) {
    var s = t[o], l = void 0;
    l === void 0 && (l = e[s]), i ? we(n, s, l) : vt(n, s, l);
  }
  return n;
}
var Be = Math.max;
...
var Pt = Object.prototype, Jn = Pt.hasOwnProperty, qn = Pt.propertyIsEnumerable, Ae = ze(/* @__PURE__ */ function() {
  return arguments;
}()) ? ze : function(e) {
...
var At = typeof exports == "object" && exports && !exports.nodeType && exports, X = At && typeof module == "object" && module && !module.nodeType && module, wr = X && X.exports === At, fe = wr && dt.process, B = function() {
  try {
...
function St(e, t) {
  var n = S(e), r = !n && Ae(e), i = !n && !r && ne(e), o = !n && !r && !i && $t(e), a = n || r || i || o, s = a ? Hn(e.length, String) : [], l = s.length;
  for (var u in e)
...
function k(e, t, n, r, i, o) {
  ...
  return Rn(f || e, function(p, d) {
    f && (d = p, p = e[d]), vt(a, d, k(p, t, n, d, e, o));
  }), a;
}
...
function Kt(e, t, n, r, i, o) {
  ...
  if (u && c)
    return u == t && c == e;
  var h = -1, f = !0, p = n & ko ? new ie() : void 0;
...
var na = 1, ra = 2, ia = "[object Boolean]", oa = "[object Date]", aa = "[object Error]", sa = "[object Map]", la = "[object Number]", ua = "[object RegExp]", ca = "[object Set]", fa = "[object String]", pa = "[object Symbol]", ga = "[object ArrayBuffer]", da = "[object DataView]", st = O ? O.prototype : void 0, pe = st ? st.valueOf : void 0;
...
function Aa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new C(), h;
      if (!(h === void 0 ? Me(u, l, Pa | Oa, r, c) : h))
        return !1;
    }
  }
  return !0;
...
var Ja = 1, qa = 2, Wa = 4, Bt = bi(function(e, t) {
  ...
  }), Un(e, Rt(e), n), r && (n = k(n, Ja | qa | Wa, Xa));
...
function Bs(e, t, n) {
  ...
  const f = Qa(() => import("./table.row-selection-QRxSAmwQ.js"));
  let {
    gradio: p
  } = t, {
    props: d = {}
  ...
  V(e, Re, (_) => n(0, s = _));
  const Le = cs(), De = as();
  return V(e, De, (_) => n(16, a = _)), e.$$set = (_) => {
    ...
    65537 && n(1, r = {
      props: {
        ...
        onCell: ge(s.props.onCell || s.restProps.onCell),
        getCheckboxProps: ge(s.props.getCheckboxProps || s.restProps.getCheckboxProps),
        renderCell: ge(s.props.renderCell || s.restProps.renderCell),
  ...
  }, [s, r, u, f, y, Fe, Re, De, p, d, g, v, T, P, x, A, a, l, c, h];
}
class Xs extends ms {
  constructor(t) {
