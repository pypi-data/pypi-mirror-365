...
class StartTriggerType(Enum):
    ...
    `RFmxInstr Send Software Edge Trigger <fmxinstrvi.chm/RFmxInstr_Send_Software_Edge_Trigger.html>`_ method."""
...
class AdvanceTriggerType(Enum):
    ...
    `RFmxInstr Send Software Edge Trigger <rfmxinstrvi.chm/RFmxInstr_Send_Software_Edge_Trigger.html>`_ method."""
