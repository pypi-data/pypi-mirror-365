...
class _SessionBase(object):
    ...
    def __init__(self, resource_name, option_string="", instrument_handle=None):
        ...
        if instrument_handle:
            ...
            _, _ = self._interpreter.get_attribute_i32("", attributes.AttributeID.PRESELECTOR_PRESENT.value)  # type: ignore
        else:
            ...
            if session_unique_identifier not in Session._instr_map._data:
                ...
                handle_out, is_new_session, error_code = self._interpreter.initialize(comma_seperated_resource_name, option_string)  # type: ignore
    ...
    def get_device_temperature(self, selector_string):
        ...
        can use the `RFmxInstr Build Port String <rfmxinstrvi.chm/RFmxInstr_Build_Port_String.html>`_ method to build the
        selector string. For PXIe-5830/5831/5832, you must specify the context in the selector string input as
        port::<deviceName>/<channelNumber>/module::<moduleName>.
    ...
    def get_digitizer_temperature(self, selector_string):
        ...
        `RFmxInstr Build Port String <rfmxinstrvi.chm/RFmxInstr_Build_Port_String.html>`_ method to build the selector string.
    ...
    def get_recommended_acquisition_type(self, selector_string):
        ...
        - :py:meth:`nirfmxinstr.session.Session.initialize` method or the :py:meth:`initialize` method is called with option string "AnalysisOnly=1", or

        - `RFmxInstr Initialize NIRFSA (Array) <rfmxinstrvi.chm/RFmxInstr_Initialize_NIRFSA_(Array).html>`_ method is called with option string "AnalysisOnly=1;MaxNumWfms:<n>". Use "*instr<n>*" as the selector string to read this attribute.
    ...
    def check_acquisition_status(self):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            acquisition_done, error_code = self._interpreter.check_acquisition_status()  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_external_attenuation_table(
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            ...
            error_code = self._interpreter.configure_external_attenuation_table(selector_string, table_name, frequency, external_attenuation)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def select_active_external_attenuation_table(self, selector_string, table_name):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.select_active_external_attenuation_table(selector_string, table_name)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def delete_external_attenuation_table(self, selector_string, table_name):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.delete_external_attenuation_table(selector_string, table_name)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def delete_all_external_attenuation_tables(self, selector_string):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.delete_all_external_attenuation_tables(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def disable_calibration_plane(self, selector_string):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.disable_calibration_plane(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def check_if_signal_exists(self, signal_name):
        ...
        try:
            ...
            signal_configuration_exists, personality, error_code = self._interpreter.check_if_signal_exists(signal_name)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def load_s_parameter_external_attenuation_table_from_s2p_file(
        ...
        **Supported devices**: PXIe-5830/5831/5832/5840/5841/5842/5860
        ...
        Args:
            ...
            s_parameter_orientation (SParameterOrientation):
        ...
        try:
            ...
            error_code = self._interpreter.load_s_parameter_external_attenuation_table_from_s2p_file(selector_string, table_name, s2p_file_path, s_parameter_orientation)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_external_attenuation_interpolation_nearest(self, selector_string, table_name):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.configure_external_attenuation_interpolation_nearest(selector_string, table_name)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_external_attenuation_interpolation_linear(
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        Args:
            ...
            format (LinearInterpolationFormat):
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.configure_external_attenuation_interpolation_linear(selector_string, table_name, format)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_external_attenuation_interpolation_spline(self, selector_string, table_name):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.configure_external_attenuation_interpolation_spline(selector_string, table_name)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_s_parameter_external_attenuation_type(self, selector_string, s_parameter_type):
        ...
        **Supported devices**: PXIe-5830/5831/5832/5840/5841/5842/5860
        ...
        Args:
            ...
            s_parameter_type (SParameterType):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.configure_s_parameter_external_attenuation_type(selector_string, s_parameter_type)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_frequency_reference(
        ...
        try:
            ...
            error_code = self._interpreter.configure_frequency_reference(selector_string, frequency_reference_source, frequency_reference_frequency)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_mechanical_attenuation(
        ...
        **Supported devices:** PXIe-5663/5663E, PXIe-5665, PXIe-5668
        ...
        Args:
            ...
            mechanical_attenuation_auto (MechanicalAttenuationAuto):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.configure_mechanical_attenuation(selector_string, mechanical_attenuation_auto, mechanical_attenuation_value)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def configure_rf_attenuation(self, selector_string, rf_attenuation_auto, rf_attenuation_value):
        ...
        **Supported devices:** PXIe-5663/5663E, PXIe-5665, PXIe-5668
        ...
        Args:
            ...
            rf_attenuation_auto (RFAttenuationAuto):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.configure_rf_attenuation(selector_string, rf_attenuation_auto, rf_attenuation_value)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def reset_attribute(self, selector_string, attribute_id):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.reset_attribute(selector_string, attribute_id)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def export_signal(self, export_signal_source, export_signal_output_terminal):
        ...
        Args:
            export_signal_source (ExportSignalSource):
        ...
        try:
            ...
            error_code = self._interpreter.export_signal(export_signal_source, export_signal_output_terminal)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def self_calibrate(self, selector_string, steps_to_omit):
        ...
        **Supported devices**: PXIe-5663/5663E/5665/5668, PXIe-5644/5645/5646, PXIe-5820/5830/5831/5832/5840/5841/5842/5860
        ...
        Args:
            ...
            steps_to_omit (SelfCalibrateSteps):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.self_calibrate(selector_string, steps_to_omit)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def self_calibrate_range(
        ...
        **Supported devices:** PXIe-5644/5645/5646, PXIe-5820/5830/5831/5832/5840/5841/5842
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            error_code = self._interpreter.self_calibrate_range(selector_string, steps_to_omit, minimum_frequency, maximum_frequency, minimum_reference_level, maximum_reference_level)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def is_self_calibrate_valid(self, selector_string):
        ...
        **Supported devices:** PXIe-5663/5663E/5665/5668
        ...
        Returns:
            ...
            valid_steps (SelfCalibrateSteps):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            self_calibrate_valid, valid_steps, error_code = self._interpreter.is_self_calibrate_valid(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_s_parameter_external_attenuation_type(self, selector_string):
        ...
        **Supported devices**: PXIe-5830/5831/5832/5840/5841/5842/5860
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            s_parameter_type, error_code = self._interpreter.get_s_parameter_external_attenuation_type(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_external_attenuation_table_actual_value(self, selector_string):
        ...
        **Supported devices**: PXIe-5663/5663E, PXIe-5665, PXIe-5668, PXIe-5644/5645/5646,
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            external_attenuation, error_code = self._interpreter.get_external_attenuation_table_actual_value(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_available_ports(self, selector_string):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            available_ports, error_code = self._interpreter.get_available_ports(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_self_calibrate_last_temperature(self, selector_string, self_calibrate_step):
        ...
        **Supported Devices:** PXIe-5644/5645/5646, PXIe-5663/5663E/5665/5668, PXIe-5820/5830/5831 (IF only)/5832 (IF
        ...
        Args:
            ...
            self_calibrate_step (SelfCalibrateSteps):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            temperature, error_code = self._interpreter.get_self_calibrate_last_temperature(selector_string, self_calibrate_step)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_available_paths(self, selector_string):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            available_paths, error_code = self._interpreter.get_available_paths(selector_string)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def build_calibration_plane_string(calibration_plane_name):
        ...
        return _helper.build_calibration_plane_name_string(calibration_plane_name)  # type: ignore
    ...
    def build_port_string(selector_string, port_name, device_name, channel_number):
        ...
        return _helper.build_port_string(selector_string, port_name, device_name, channel_number)  # type: ignore
    ...
    def configure_s_parameter_external_attenuation_table(
        ...
        **Supported devices**: PXIe-5830/5831/5832/5840/5841/5860
        ...
        try:
            ...
            _helper.validate_not_none(selector_string, "selector_string")
            _helper.validate_not_none(table_name, "table_name")
            error_code = self._interpreter.configure_s_parameter_external_attenuation_table(selector_string, table_name, frequency, s_parameters, s_parameter_orientation)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_signal_configuration_names(self, selector_string, personality_filter):
        ...
        Args:
            ...
            personality_filter (Personalities):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            signal_names, personality, error_code = self._interpreter.get_signal_configuration_names(selector_string, personality_filter)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def fetch_raw_iq_data(self, selector_string, timeout, records_to_fetch, samples_to_read, data):
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            x0, dx, error_code = self._interpreter.fetch_raw_iq_data(selector_string, timeout, records_to_fetch, samples_to_read, data)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_self_calibrate_last_date_and_time(self, selector_string, self_calibrate_step):
        ...
        **Supported Devices:** PXIe-5644/5645/5646, PXIe-5663/5663E/5665/5668, PXIe-5820/5830/5831/5832/5840/5841/5842/5860
        ...
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
            timestamp, error_code = self._interpreter.get_self_calibrate_last_date_and_time(selector_string, self_calibrate_step)  # type: ignore
        finally:
            self._session_function_lock.exit_read_lock()
...
class Session(_SessionBase):
    ...
    def _get_session_unique_identifier(resource_name: str, option_string: str) -> Any:
        ...
        try:
            session_unique_identifier, _ = LibraryInterpreter.get_session_unique_identifier(comma_seperated_resource_name, option_string)  # type: ignore
    ...
    def specan_clear_noise_calibration_database(self, selector_string):
        ...
        specan_signal = nirfmxspecan._SpecAnSignalConfiguration.get_specan_signal_configuration(self)  # type: ignore
        try:
            self._session_function_lock.enter_read_lock()
            _helper.validate_not_none(selector_string, "selector_string")
