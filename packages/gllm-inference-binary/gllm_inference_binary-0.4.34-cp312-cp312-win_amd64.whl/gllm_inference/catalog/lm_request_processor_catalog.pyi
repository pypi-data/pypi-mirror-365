...
class LMRequestProcessorCatalog(BaseCatalog[LMRequestProcessor]):
    ...
    Template Format Example:
        ...
        see: https://docs.google.com/spreadsheets/d/1Mmqk8xVz7iJ8MVEwistKr9ENP1ctSH1D3BMw7NoHizI/edit?usp=drive_link

        # Example 2: CSV
        For an example of how a CSV file can be formatted to be loaded using LMRequestProcessorCatalog, see:
        https://drive.google.com/file/d/1gkvHK7R54leZx50HG1SaWzI5bAXKJE7X/view?usp=drive_link

    Template Explanation:
        The required columns are:
            1. name (str): The name of the LM request processor.
            2. prompt_builder_system_template (str): The system template of the prompt builder.
            3. prompt_builder_user_template (str): The user template of the prompt builder.
            4. lm_invoker_model_id (str): The model ID of the LM invoker.
            5. lm_invoker_credentials (str | json_str): The credentials of the LM invoker.
            6. lm_invoker_config (json_str): The additional configuration of the LM invoker.
            7. output_parser_type (str): The type of the output parser.

        Important Notes:
        1. At least one of `prompt_builder_system_template` or `prompt_builder_user_template` must be filled.
        2. `lm_invoker_model_id` must be filled with the model ID of the LM invoker. For available model IDs, see:
            https://gdplabs.gitbook.io/sdk/supported-models
        3. `lm_invoker_credentials` is optional. If it is filled, it can either be:
        ...
        4. `lm_invoker_config` is optional. When this column is empty, the LM invoker will use the
