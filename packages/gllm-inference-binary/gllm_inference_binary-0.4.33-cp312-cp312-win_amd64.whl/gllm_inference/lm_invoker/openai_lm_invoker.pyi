...
from gllm_inference.schema import Attachment as Attachment, AttachmentType as AttachmentType, CodeExecResult as CodeExecResult, LMOutput as LMOutput, ModelId as ModelId, ModelProvider as ModelProvider, MultimodalPrompt as MultimodalPrompt, PromptRole as PromptRole, Reasoning as Reasoning, ResponseSchema as ResponseSchema, TokenUsage as TokenUsage, ToolCall as ToolCall, ToolResult as ToolResult
...
class OpenAILMInvoker(BaseLMInvoker):
    ...
    Code interpreter:
        ...
        Streaming output example:
        ```python
        {"type": "data", "value": "import matplotlib", ...}  # Executed code
        {"type": "data", "value": ".pyplot as plt...", ...}  # Executed code
        {"type": "response", "value": "The histogram ", ...}  # Response token
        {"type": "response", "value": "is attached.", ...}  # Response token
        ```
    ...
    Output types:
        ...
        2. `LMOutput`: A Pydantic model with the following attributes if any additional output is needed:
            ...
            2.8. code_exec_results (list[CodeExecResult]): The code execution results, if the code interpreter is
                set to `True` and the language model decides to execute any codes. Defaults to an empty list.
    '''
    client: Incomplete
    def __init__(self, model_name: str, api_key: str | None = None, model_kwargs: dict[str, Any] | None = None, default_hyperparameters: dict[str, Any] | None = None, tools: list[Tool] | None = None, response_schema: ResponseSchema | None = None, output_analytics: bool = False, retry_config: RetryConfig | None = None, reasoning_effort: ReasoningEffort | None = None, reasoning_summary: ReasoningSummary | None = None, code_interpreter: bool = False, bind_tools_params: dict[str, Any] | None = None, with_structured_output_params: dict[str, Any] | None = None) -> None:
