...
from Osdental.Handlers.Instances import aes, audit_flow
...
async def enqueue_response(data: Any, batch: int, headers: Dict[str,str], msg_info: str = None):
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                if request:
                    ...
                    await audit_flow.enqueue(await custom_request.message_to_queue())
                ...
                await enqueue_response(data, batch, headers, msg_info)
