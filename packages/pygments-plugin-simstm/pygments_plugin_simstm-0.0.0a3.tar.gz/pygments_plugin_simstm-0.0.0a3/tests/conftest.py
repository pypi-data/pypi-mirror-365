...
def pytest_addoption(parser):
    ...
    parser.addoption('--gen', help='generate test reference file')
...
class LexerTestItem(pytest.Item):
    ...
    def runtest(self):
        ...
        elif self.config.getoption('--gen'):
            with open(str(self.path.absolute()) + ".gen.output", "w", encoding="utf-8") as file:
                file.write(self.actual)
