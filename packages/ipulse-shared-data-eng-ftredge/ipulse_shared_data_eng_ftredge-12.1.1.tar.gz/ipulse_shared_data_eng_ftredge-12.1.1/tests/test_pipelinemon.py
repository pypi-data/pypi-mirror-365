...
class TestPipelinemon(unittest.TestCase):
    ...
    def test_event_and_event_count(self):
        ...
        log2 = StructLog(level=LogLevel.WARNING,  description="Test Event 2", action=Action.PERSIST_WRITE, resource=DataResource.DB, q=10, q_unit=DataUnit.RECORD)
        log3= StructLog(level=LogLevel.WARNING, description="Test Event 3", action=Action.PERSIST_WRITE,resource=DataResource.DB, q=55, q_unit=DataUnit.RECORD)
