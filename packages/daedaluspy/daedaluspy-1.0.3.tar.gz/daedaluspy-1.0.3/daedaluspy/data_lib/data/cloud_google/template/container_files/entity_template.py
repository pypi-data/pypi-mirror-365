TEMPLATE_ENTITY_GOOGLE = '''from datetime import datetime
from {lib_name}.data.base import BaseEntity, DataLayerOptions, HandlerFactory, GoogleStorageProvider
{imports}
...
{columns}
    ...
    def __init__(self):
        ...
        self.storage_provider = GoogleStorageProvider()    
