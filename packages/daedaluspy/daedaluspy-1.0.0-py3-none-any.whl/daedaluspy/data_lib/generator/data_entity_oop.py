...
class DataEntityGenerator:
    ...
    def generate(self):
        ...
        # Sempre gera dentro do pacote Python detectado
        output_path = self.output_path or str(lib_root / lib_name / "data" / self.data_layer)
        os.makedirs(output_path, exist_ok=True)
        output_file = os.path.join(output_path, f"{self.classname.lower()}.py")
