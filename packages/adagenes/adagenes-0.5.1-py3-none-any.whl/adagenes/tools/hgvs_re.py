...
# CNV
exp_cnv_del = "([cC][hH][rR])([XYNMxy0-9]+):([0-9]+)([A-Z]?)(>)([0-9]?)(<DEL>)"
exp_cnv_dup = "([cC][hH][rR])([XYNMxy0-9]+):([0-9]+)([A-Z]?)(>)([0-9]?)(<DUP>)"
exp_cnv_cnv = "([cC][hH][rR])([XYNMxy0-9]+):([0-9]+)([A-Z]?)(>)([0-9]?)(<CNV>)"

# Chromosomal position only
chrom_position = "^([cC][hH][rR])([XYNMxy0-9]+):([0-9]+)$"
