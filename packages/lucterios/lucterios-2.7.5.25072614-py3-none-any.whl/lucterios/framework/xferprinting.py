...
from lucterios.framework.xfercomponents import XferCompSelect, XferCompFloat, XferCompEdit, XferCompMemo, XferCompCheck, XferCompLabelForm, XferCompDownLoad
...
class XferContainerPrint(XferContainerAbstract):
    ...
    def _get_zipextract(self):
        ...
        gui.add_action(WrapAction(TITLE_CLOSE, short_icon='mdi:mdi-close'))
        return gui
...
""" % self.PRINT_REGENERATE_CODE
        ...
        gui.add_action(self.return_action(_("Print"), short_icon='mdi:mdi-printer-pos-edit-outline'), modal=FORMTYPE_MODAL, close=CLOSE_YES)
        gui.add_action(WrapAction(TITLE_CLOSE, short_icon='mdi:mdi-close'))
        return gui
