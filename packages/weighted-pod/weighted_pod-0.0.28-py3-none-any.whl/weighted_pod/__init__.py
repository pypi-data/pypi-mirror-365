...
from .visualization import plot_modes, plot_energy_spectrum, plot_reconstruction ,plot_temporal_cofficient_snapshots, plot_allModes_snapshots
from .visualization import plot_reconstructionError_snapshots, plot_AllCoff_once
