...
This document outlines our procedures for reporting vulnerabilities and the security practices for **divine-async-runner**.
...
- Create a [security advisory](https://github.com/divinescreener/divine-async-runner/security/advisories) on GitHub.
