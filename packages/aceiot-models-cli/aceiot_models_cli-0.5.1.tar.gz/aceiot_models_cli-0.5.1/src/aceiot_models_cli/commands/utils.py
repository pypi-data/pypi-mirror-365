...
class OutputFormatterMixin:
    ...
    def _format_plain_output(self, data: Any, title: Optional[str] = None) -> None:
...
class ErrorHandlerMixin:
    ...
    def handle_api_error(self, error: Exception, ctx: click.Context, operation: Optional[str] = None) -> None:
