...
class CommandMetadata:
    ...
    command_class: Optional[Type["BaseCommand"]] = None
...
class ContextAwareCommand(BaseCommand):
    ...
    def __init__(self, context: Optional[ReplContext] = None, **kwargs):
    ...
    @property
    def current_gateway(self) -> Optional[str]:
...
class CommandRegistry:
    ...
    def get_command_instance(self, name: str, context: Optional[ReplContext] = None) -> Optional[BaseCommand]:
    ...
    def get_all_commands(self, scope: Optional[CommandScope] = None) -> list[CommandMetadata]:
