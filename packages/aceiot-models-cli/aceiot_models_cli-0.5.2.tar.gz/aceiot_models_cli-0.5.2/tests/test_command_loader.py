...
class TestCommandLoader:
    ...
    def test_load_module_with_decorated_class(self):
        ...
        setattr(test_module, "DiscoveredCommand", DiscoveredCommand)
        setattr(test_module, "RegularClass", RegularClass)
        setattr(test_module, "some_function", some_function)
    ...
    def test_load_module_with_repl_function(self):
        ...
        setattr(test_module, "discovered_func", discovered_func)
        setattr(test_module, "regular_func", regular_func)
    ...
    def test_load_module_multiple_commands(self):
        ...
        setattr(test_module, "Command1", Command1)
        setattr(test_module, "Command2", Command2)
    ...
    def test_load_module_already_loaded(self):
        ...
        setattr(test_module, "LoadedCommand", LoadedCommand)
...
""")
    ...
    def test_load_module_without_name_attribute(self):
        ...
        setattr(test_module, "NoNameCommand", NoNameCommand)
    ...
    def test_command_without_metadata(self):
        ...
        setattr(test_module, "NoMetaCommand", NoMetaCommand)
