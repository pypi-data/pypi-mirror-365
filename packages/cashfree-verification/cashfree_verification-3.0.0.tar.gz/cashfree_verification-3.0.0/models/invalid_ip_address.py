...
class InvalidIpAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidIpAddress:
        """Create an instance of InvalidIpAddress from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> InvalidIpAddress:
        """Create an instance of InvalidIpAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidIpAddress:
        """Create an instance of InvalidIpAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidIpAddress.parse_obj(obj)

        _obj = InvalidIpAddress.parse_obj({
            "type": obj.get("type"),
            "code": obj.get("code"),
