...
def batch_to_images(batch: cp.ndarray, size: int | tuple[int, int] | None = None, std: float | tuple[float, float, float] | None = None, mean: float | tuple[float, float, float] | None = None, swap_rb: bool = True, layout: Layout = 'NCHW') -> list[cp.ndarray]:
    """
