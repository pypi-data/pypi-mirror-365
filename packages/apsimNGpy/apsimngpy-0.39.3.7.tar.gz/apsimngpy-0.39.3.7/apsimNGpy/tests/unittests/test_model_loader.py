...
class TestCoreModel(BaseTester):
    ...
    def test_load_model_from_dict(self):
        ...
        node_or_model = load_from_dict(mocked_dict, out=os.path.realpath('mock_model_from_dict.apsimx'))
    ...
    def test_load_load_apsim_model_dict(self):
        ...
        out = load_apsim_model(dict_data, out=os.path.realpath('maizex.apsimx'))
    ...
    def test_load_load_apsim_model_path(self):
        ...
        out = load_apsim_model(MODEL_PATH, out=os.path.realpath('maize_from_fp.apsimx'))
        sims = cast(out.IModel)
    ...
    def test_load_load_apsim_model_pathlib_path(self):
        ...
        fp = Path(MODEL_PATH)
        out = load_apsim_model(fp, out=os.path.realpath('maize_from_fp.apsimx'))
        sims = cast(out.IModel)
    ...
    def test_save_model_to_disk(self):
        import pathlib
        def test(mod_p):
            mod = load_apsim_model(mod_p, out=os.path.realpath('../maize_from_fp.apsimx'))
        ...
        # test from default
        mod = load_apsim_model("Maize", out=os.path.realpath('../maize_from_fp.apsimx'))
        test('Maize')
        # test from disk
