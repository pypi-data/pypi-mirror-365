...
def begin_span(
        ...
        log_duration_level: DurationLevel | None = "info",
        **kwargs
) -> Iterator[Span]:
    """
    ...
    :param log_duration_level: Whether to log the duration of the span and at which level. If None, no logging will be performed.
    ...
    if log_duration_level:
        duration_level = _map_duration_level(log_duration_level)
