...
from bear_utils.logger_manager import INFO, VERBOSE, ConsoleLogger
...
class IgnoreHandler:
    ...
    def __init__(self, ignore_file: Path | None = None, combine: bool = False, verbose: bool = False) -> None:
        ...
        self.logger.set_base_level(VERBOSE if verbose else INFO)
    ...
    def _print(self, files: list[Path], rel: bool = True, color: str = "white") -> None:
        ...
        try:
            for path in files:
                ...
                self.logger.print(p, style=color) if self.logger.level == VERBOSE else None
...
#     answer = ask_question(
#         "Do you want to print the ignored or non-ignored files? (ignored/non-ignored/both)",
#         expected_type="str",
#         default="both",
#     )
#     if answer == "both":
...
#         directory_handler.print_report("non-ignored")
#     else:
