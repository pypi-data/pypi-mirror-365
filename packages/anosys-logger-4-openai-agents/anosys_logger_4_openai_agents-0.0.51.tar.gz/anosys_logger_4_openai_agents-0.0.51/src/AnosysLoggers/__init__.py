...
def span2json(span):
    ...
    base = {
        ...
        "cvs52": user_context,
        "cvs53": data.get("object"),
        "cvs54": data.get("id"),
        "cvs55": data.get("trace_id"),
        "cvs56": data.get("parent_id"),
        "cvs57": data.get("started_at"),
        "cvi1": _to_timestamp(data.get("started_at")),
        "cvs58": data.get("ended_at"),
        "cvi2": _to_timestamp(data.get("ended_at")),
        "cvs59": data.get("error"),
    }

    type_ = span_data.get("type")
    extended = {
        "agent": lambda: {
            "cvs61": span_data.get("name"),
            "cvs62": ", ".join(span_data.get("handoffs") or []),
            "cvs63": ", ".join(span_data.get("tools") or []),
            "cvs64": span_data.get("output_type"),
        },
        "function": lambda: {
            "cvs61": span_data.get("name"),
            "cvs65": span_data.get("input"),
            "cvs66": span_data.get("output"),
            "cvs67": span_data.get("mcp_data"),
        },
        "guardrail": lambda: {
            "cvs61": span_data.get("name"),
            "cvs68": span_data.get("triggered"),
        },
        "generation": lambda: {
            "cvs65": span_data.get("input"),
            "cvs66": span_data.get("output"),
            "cvs69": span_data.get("model"),
            "cvs70": span_data.get("model_config"),
            "cvs71": span_data.get("usage"),
        },
        "custom": lambda: {
            "cvs61": span_data.get("name"),
            "cvs72": span_data.get("data"),
        },
        "transcription": lambda: {
            "cvs72": span_data.get("input", {}).get("data"),
            "cvs73": span_data.get("input", {}).get("format"),
            "cvs66": span_data.get("output"),
            "cvs69": span_data.get("model"),
            "cvs70": span_data.get("model_config"),
        },
        "speech": lambda: {
            "cvs65": span_data.get("input"),
            "cvs72": span_data.get("output", {}).get("data"),
            "cvs73": span_data.get("output", {}).get("format"),
            "cvs69": span_data.get("model"),
            "cvs70": span_data.get("model_config"),
            "cvs74": span_data.get("first_content_at"),
        },
        "speechgroup": lambda: {
            "cvs65": span_data.get("input"),
        },
        "MCPListTools": lambda: {
            "cvs75": span_data.get("server"),
            "cvs76": span_data.get("result"),
        },
        "response": lambda: {
            "cvs77": span_data.get("response_id"),
        },
        "handoff": lambda: {
            "cvs78": span_data.get("from_agent"),
            "cvs79": span_data.get("to_agent"),
        },
    }

    result = {**base, "cvs60": type_}
