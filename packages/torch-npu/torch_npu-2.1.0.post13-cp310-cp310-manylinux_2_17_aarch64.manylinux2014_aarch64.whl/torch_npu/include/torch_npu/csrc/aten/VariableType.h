...
// @generated from /opt/agent_1744679930750/workspace/j_3R72rEvo/pytorch/codegen/autograd/templates/VariableType.h
...
namespace VariableType {
  ...
  ::std::tuple<at::Tensor,at::Tensor,at::Tensor> npu_nsa_select_attention(c10::DispatchKeySet ks, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & topk_indices, double scale_value, int64_t head_num, int64_t select_block_size, int64_t select_block_count, const c10::optional<at::Tensor> & atten_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen);
};
