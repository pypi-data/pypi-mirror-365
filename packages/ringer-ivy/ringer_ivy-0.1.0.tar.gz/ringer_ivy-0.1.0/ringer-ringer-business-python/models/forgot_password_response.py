...
class ForgotPasswordResponse(BaseModel):
    ...
    """ # noqa: E501
    reset_password_token: Optional[StrictStr] = Field(default=None, description="The password reset token. This is often NOT returned directly for security reasons; instead, it is emailed to the user.")
    links: Optional[List[Link]] = None
    __properties: ClassVar[List[str]] = ["reset_password_token", "links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.reset_password_token is None and "reset_password_token" in self.model_fields_set:
            _dict['reset_password_token'] = None
