...
class SiteResponse(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the site.")
    thin_client: Optional[StrictStr] = Field(default=None, description="Name of the assigned thin client.")
    music_on_hold: Optional[StrictStr] = Field(default=None, description="URL to the music on hold audio file for the site.")
    dns_name: Optional[StrictStr] = Field(default=None, description="The fully qualified DNS name for the site (e.g., hq.ivy.teliax.com).")
    enterprise_trunking: Optional[StrictBool] = Field(default=None, description="Indicates if enterprise trunking is enabled for this site.")
    international_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if international calling is enabled for this site.")
    voice_recording_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if voice recording is enabled for this site.")
    allow_custom_caller_ids: Optional[StrictBool] = Field(default=None, description="Indicates if custom caller IDs are allowed for this site.")
    links: Optional[List[SchemasLink]] = Field(default=None, description="HATEOAS links related to this site.")
    __properties: ClassVar[List[str]] = ["dns_extension", "active", "caller_id_name", "caller_id_number", "thin_client_id", "acl", "channel_limit", "permitted_country_codes", "id", "thin_client", "music_on_hold", "dns_name", "enterprise_trunking", "international_enabled", "voice_recording_enabled", "allow_custom_caller_ids", "links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.links:
            ...
            _dict['links'] = _items
        # set to None if thin_client (nullable) is None
        # and model_fields_set contains the field
        if self.thin_client is None and "thin_client" in self.model_fields_set:
            _dict['thin_client'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "thin_client": obj.get("thin_client"),
            "music_on_hold": obj.get("music_on_hold"),
            "dns_name": obj.get("dns_name"),
            "enterprise_trunking": obj.get("enterprise_trunking"),
            "international_enabled": obj.get("international_enabled"),
            "voice_recording_enabled": obj.get("voice_recording_enabled"),
            "allow_custom_caller_ids": obj.get("allow_custom_caller_ids"),
