...
class VoicemailBoxRequest(BaseModel):
    """
    ...
    announcement: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = Field(default=None, description="Greeting message for the Voicemail Box. This is a file upload field.")
    status: StrictStr = Field(description="Status of the Voicemail Box.")
    site_id: Optional[StrictInt] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["name", "pin", "notification_emails", "announcement_url", "announcement", "status", "site_id", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VoicemailBoxRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VoicemailBoxRequest from a dict"""
        if obj is None:
            return None
