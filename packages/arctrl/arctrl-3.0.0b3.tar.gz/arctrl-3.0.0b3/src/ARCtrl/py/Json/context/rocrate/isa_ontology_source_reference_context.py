...
IContext_reflection = _expr1763

def _arrow1772(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1764()), ("OntologySourceReference", ObjectExpr1765()), ("description", ObjectExpr1766()), ("name", ObjectExpr1767()), ("file", ObjectExpr1768()), ("version", ObjectExpr1769()), ("comments", ObjectExpr1770())])
...
context_jsonvalue: IEncodable = _arrow1772()
