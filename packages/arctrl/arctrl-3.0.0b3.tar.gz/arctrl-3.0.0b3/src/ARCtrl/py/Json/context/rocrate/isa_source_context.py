...
def _arrow1875(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1869()), ("bio", ObjectExpr1870()), ("Source", ObjectExpr1871()), ("name", ObjectExpr1872()), ("characteristics", ObjectExpr1873())])
