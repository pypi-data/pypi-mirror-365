...
IContext_reflection = _expr1773

def _arrow1778(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1774()), ("Organization", ObjectExpr1775()), ("name", ObjectExpr1776())])
...
context_jsonvalue: IEncodable = _arrow1778()
