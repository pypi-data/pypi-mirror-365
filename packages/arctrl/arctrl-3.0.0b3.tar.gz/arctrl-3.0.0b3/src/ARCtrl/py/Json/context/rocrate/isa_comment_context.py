...
def _arrow1663(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1658()), ("Comment", ObjectExpr1659()), ("name", ObjectExpr1660()), ("value", ObjectExpr1661())])
