...
def directory_exists_async(path: str) -> Async[bool]:
    def _arrow3604(__unit: None=None, path: Any=path) -> Async[bool]:
...
def create_directory_async(path: str) -> Async[None]:
    def _arrow3605(__unit: None=None, path: Any=path) -> Async[None]:
        Path(path).mkdir(parents=True, exist_ok=True)
        return singleton.Zero()

    return singleton.Delay(_arrow3605)
...
def ensure_directory_async(path: str) -> Async[None]:
    def _arrow3607(__unit: None=None, path: Any=path) -> Async[None]:
        ...
        return singleton.Bind(directory_exists_async(path), _arrow3606)

    return singleton.Delay(_arrow3607)


def ensure_directory_of_file_async(file_path: str) -> Async[None]:
    def _arrow3608(__unit: None=None, file_path: Any=file_path) -> Async[None]:
        return singleton.ReturnFrom(ensure_directory_async(Path(file_path).parent))

    return singleton.Delay(_arrow3608)


def file_exists_async(path: str) -> Async[bool]:
    def _arrow3609(__unit: None=None, path: Any=path) -> Async[bool]:
...
def read_file_text_async(path: str) -> Async[str]:
    def _arrow3611(__unit: None=None, path: Any=path) -> Async[str]:
        def _arrow3610(__unit: None=None) -> str:
            with open(path, 'r', encoding='utf-8') as f: return f.read()

        return singleton.Return(_arrow3610())

    return singleton.Delay(_arrow3611)


def read_file_binary_async(path: str) -> Async[bytearray]:
    def _arrow3613(__unit: None=None, path: Any=path) -> Async[bytearray]:
        def _arrow3612(__unit: None=None) -> bytearray:
            with open(path, 'rb') as f: return f.read()

        return singleton.Return(_arrow3612())

    return singleton.Delay(_arrow3613)


def read_file_xlsx_async(path: str) -> Async[FsWorkbook]:
    def _arrow3614(__unit: None=None, path: Any=path) -> Async[FsWorkbook]:
...
def move_file_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3615(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
...
def delete_file_async(path: str) -> Async[None]:
    def _arrow3616(__unit: None=None, path: Any=path) -> Async[None]:
        try:
            os.remove(path)
...
def write_file_text_async(path: str, text: str) -> Async[None]:
    def _arrow3618(__unit: None=None, path: Any=path, text: Any=text) -> Async[None]:
...
def write_file_binary_async(path: str, bytes: bytearray) -> Async[None]:
    def _arrow3619(__unit: None=None, path: Any=path, bytes: Any=bytes) -> Async[None]:
...
def write_file_xlsx_async(path: str, wb: FsWorkbook) -> Async[None]:
    def _arrow3620(__unit: None=None, path: Any=path, wb: Any=wb) -> Async[None]:
...
def get_sub_directories_async(path: str) -> Async[Array[str]]:
    def _arrow3621(__unit: None=None, path: Any=path) -> Async[Array[str]]:
...
def get_sub_files_async(path: str) -> Async[Array[str]]:
    def _arrow3622(__unit: None=None, path: Any=path) -> Async[Array[str]]:
...
def get_all_file_paths_async(directory_path: str) -> Async[Array[str]]:
    ...
    def _arrow3628(__unit: None=None, directory_path: Any=directory_path) -> Async[Array[str]]:
        def all_files(dirs: IEnumerable_1[str]) -> Async[IEnumerable_1[str]]:
            def _arrow3626(__unit: None=None, dirs: Any=dirs) -> Async[IEnumerable_1[str]]:
                def _arrow3625(_arg: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                    sub_files_1: IEnumerable_1[str] = concat(_arg)
                    def _arrow3624(_arg_1: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                        def _arrow3623(_arg_2: Array[IEnumerable_1[str]]) -> Async[IEnumerable_1[str]]:
                            sub_dir_contents_1: IEnumerable_1[str] = concat(_arg_2)
                            return singleton.Return(append(sub_dir_contents_1, sub_files_1))

                        return singleton.Bind(all(map_1(all_files, _arg_1)), _arrow3623)

                    return singleton.Bind(all(map_1(get_sub_directories_async, dirs)), _arrow3624)

                return singleton.Return(empty()) if is_empty(dirs) else singleton.Bind(all(map_1(get_sub_files_async, dirs)), _arrow3625)

            return singleton.Delay(_arrow3626)

        def _arrow3627(_arg_3: IEnumerable_1[str]) -> Async[Array[str]]:
        ...
        return singleton.Bind(all_files(to_enumerable([directory_path_1])), _arrow3627)

    return singleton.Delay(_arrow3628)


def rename_file_or_directory_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3631(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
        def _arrow3630(_arg: bool) -> Async[None]:
            def _arrow3629(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(old_path), _arrow3629)

        return singleton.Bind(file_exists_async(old_path), _arrow3630)

    return singleton.Delay(_arrow3631)


def delete_file_or_directory_async(path: str) -> Async[None]:
    def _arrow3634(__unit: None=None, path: Any=path) -> Async[None]:
        def _arrow3633(_arg: bool) -> Async[None]:
            def _arrow3632(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(path), _arrow3632)

        return singleton.Bind(file_exists_async(path), _arrow3633)
