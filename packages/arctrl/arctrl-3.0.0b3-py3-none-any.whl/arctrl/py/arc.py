...
class ARC(ArcInvestigation):
    ...
    def try_load_async(arc_path: str) -> Async[FSharpResult_2[ARC, Array[str]]]:
        def _arrow3806(__unit: None=None) -> Async[FSharpResult_2[ARC, Array[str]]]:
            def _arrow3805(_arg: Array[str]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                arc: ARC = ARC.from_file_paths(to_array(_arg))
                contracts: Array[Contract] = arc.GetReadContracts()
                def _arrow3804(_arg_1: FSharpResult_2[Array[Contract], Array[str]]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                ...
                return singleton.Bind(full_fill_contract_batch_async(arc_path, contracts), _arrow3804)

            return singleton.Bind(get_all_file_paths_async(arc_path), _arrow3805)

        return singleton.Delay(_arrow3806)
    ...
    def GetAssayRemoveContracts(self, assay_identifier: str) -> Array[Contract]:
        ...
        class ObjectExpr3808:
            ...
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3807(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.AssayIdentifiers, ObjectExpr3808()):
        ...
        def _arrow3811(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3810(__unit: None=None) -> IEnumerable_1[Contract]:
                ...
                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)), delay(_arrow3809))

            return append(singleton_1(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3810))

        return to_array(delay(_arrow3811))
    ...
    def GetAssayRenameContracts(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3813:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3812(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_assay_identifier, this.AssayIdentifiers, ObjectExpr3813()):
            raise Exception("ARC does not contain assay with given name")
        ...
        def _arrow3815(__unit: None=None) -> IEnumerable_1[Contract]:
            ...
            return append(singleton_1(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3814))

        return to_array(delay(_arrow3815))
    ...
    def GetStudyRenameContracts(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3817:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3816(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_study_identifier, this.StudyIdentifiers, ObjectExpr3817()):
        ...
        def _arrow3819(__unit: None=None) -> IEnumerable_1[Contract]:
            ...
            return append(singleton_1(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3818))

        return to_array(delay(_arrow3819))
    ...
    def WriteAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3821(__unit: None=None) -> Async[None]:
            def _arrow3820(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
            ...
            return singleton.Bind(this.TryWriteAsync(arc_path), _arrow3820)

        return singleton.Delay(_arrow3821)

    def UpdateAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3823(__unit: None=None) -> Async[None]:
            def _arrow3822(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryUpdateAsync(arc_path), _arrow3822)

        return singleton.Delay(_arrow3823)

    def RemoveAssayAsync(self, arc_path: str, assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3825(__unit: None=None) -> Async[None]:
            def _arrow3824(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveAssayAsync(arc_path, assay_identifier), _arrow3824)
    ...
    def RenameAssayAsync(self, arc_path: str, old_assay_identifier: str, new_assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3827(__unit: None=None) -> Async[None]:
            def _arrow3826(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameAssayAsync(arc_path, old_assay_identifier, new_assay_identifier), _arrow3826)

        return singleton.Delay(_arrow3827)

    def RemoveStudyAsync(self, arc_path: str, study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3829(__unit: None=None) -> Async[None]:
            def _arrow3828(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveStudyAsync(arc_path, study_identifier), _arrow3828)
    ...
    def RenameStudyAsync(self, arc_path: str, old_study_identifier: str, new_study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3831(__unit: None=None) -> Async[None]:
            def _arrow3830(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameStudyAsync(arc_path, old_study_identifier, new_study_identifier), _arrow3830)

        return singleton.Delay(_arrow3831)

    @staticmethod
    def load_async(arc_path: str) -> Async[ARC]:
        def _arrow3833(__unit: None=None) -> Async[ARC]:
            def _arrow3832(_arg: FSharpResult_2[ARC, Array[str]]) -> Async[ARC]:
            ...
            return singleton.Bind(ARC.try_load_async(arc_path), _arrow3832)
    ...
    def MakeDataFilesAbsolute(self, __unit: None=None) -> None:
        this: ARC = self
        class ObjectExpr3834:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        files_paths: Any = of_seq(this.FileSystem.Tree.ToFilePaths(), ObjectExpr3834())
        ...
        def update_column_option(data_name_function: Callable[[Data], str], col: CompositeColumn | None=None) -> None:
            ...
            if col is not None:
                def _arrow3835(__unit: None=None, data_name_function: Any=data_name_function, col: Any=col) -> bool:
    ...
    def GetUpdateContracts(self, skip_update_fs: bool | None=None) -> Array[Contract]:
        ...
        if this.StaticHash == 0:
            ...
            def _arrow3860(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = this.GetLightHashCode() or 0
                def _arrow3859(__unit: None=None) -> IEnumerable_1[Contract]:
                    this.StaticHash = hash_1 or 0
                    def _arrow3840(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow3839(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value is not None:
                                if DataMap__get_StaticHash(match_value) == 0:
                                    ...
                                    def _arrow3838(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                ...
                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3836))
                                ...
                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3837))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3839))

                    def _arrow3858(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3845(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow3844(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_1 is not None:
                                    if DataMap__get_StaticHash(match_value_1) == 0:
                                        ...
                                        def _arrow3843(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow3841(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3841))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow3842(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3842))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton_1(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3844))

                        def _arrow3857(__unit: None=None) -> IEnumerable_1[Contract]:
                            def _arrow3850(w: ArcWorkflow) -> IEnumerable_1[Contract]:
                                ...
                                def _arrow3849(__unit: None=None) -> IEnumerable_1[Contract]:
                                    ...
                                    if match_value_2 is not None:
                                        if DataMap__get_StaticHash(match_value_2) == 0:
                                            ...
                                            def _arrow3848(__unit: None=None) -> bool:
                                    ...
                                    if pattern_matching_result_2 == 0:
                                        def _arrow3846(__unit: None=None) -> IEnumerable_1[Contract]:
                                            DataMap__set_StaticHash_Z524259A4(dm_10, safe_hash(dm_10))
                                            return empty()

                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForWorkflow_Z721C83C5(dm_10, ArcWorkflow__get_Identifier(w))), delay(_arrow3846))

                                    elif pattern_matching_result_2 == 1:
                                        def _arrow3847(__unit: None=None) -> IEnumerable_1[Contract]:
                                            DataMap__set_StaticHash_Z524259A4(dm_11, safe_hash(dm_11))
                                            return empty()

                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForWorkflow_Z721C83C5(dm_11, ArcWorkflow__get_Identifier(w))), delay(_arrow3847))

                                    elif pattern_matching_result_2 == 2:
                                        return empty()


                                return append(ARCtrl_ArcWorkflow__ArcWorkflow_ToCreateContract_6FCE9E49(w, True) if (ArcWorkflow__get_StaticHash(w) == 0) else (singleton_1(ARCtrl_ArcWorkflow__ArcWorkflow_ToUpdateContract(w)) if (ArcWorkflow__get_StaticHash(w) != hash_4) else empty()), delay(_arrow3849))

                            def _arrow3856(__unit: None=None) -> IEnumerable_1[Contract]:
                                def _arrow3855(r: ArcRun) -> IEnumerable_1[Contract]:
                                    ...
                                    def _arrow3854(__unit: None=None) -> IEnumerable_1[Contract]:
                                        ...
                                        if match_value_3 is not None:
                                            if DataMap__get_StaticHash(match_value_3) == 0:
                                                ...
                                                def _arrow3853(__unit: None=None) -> bool:
                                        ...
                                        if pattern_matching_result_3 == 0:
                                            ...
                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForRun_Z721C83C5(dm_14, r.Identifier)), delay(_arrow3851))

                                        elif pattern_matching_result_3 == 1:
                                            def _arrow3852(__unit: None=None) -> IEnumerable_1[Contract]:
                                                DataMap__set_StaticHash_Z524259A4(dm_15, safe_hash(dm_15))
                                                return empty()

                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForRun_Z721C83C5(dm_15, r.Identifier)), delay(_arrow3852))

                                        elif pattern_matching_result_3 == 2:
                                            return empty()


                                    return append(ARCtrl_ArcRun__ArcRun_ToCreateContract_6FCE9E49(r, True) if (r.StaticHash == 0) else (singleton_1(ARCtrl_ArcRun__ArcRun_ToUpdateContract(r)) if (r.StaticHash != hash_5) else empty()), delay(_arrow3854))

                                return collect(_arrow3855, this.Runs)

                            return append(collect(_arrow3850, this.Workflows), delay(_arrow3856))

                        return append(collect(_arrow3845, this.Assays), delay(_arrow3857))

                    return append(collect(_arrow3840, this.Studies), delay(_arrow3858))

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)) if (this.StaticHash != hash_1) else empty(), delay(_arrow3859))

            return to_array(delay(_arrow3860))
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None, default_gitattributes: bool | None=None) -> Array[Contract]:
        ...
        def _arrow3864(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3863(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3862(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton_1(gitattributes_contract) if default_gitattributes_1 else empty(), delay(_arrow3861))

                return append(singleton_1(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3862))

            return append(singleton_1(Init_createInitContract_6DFDD678(branch)), delay(_arrow3863))

        return to_array(delay(_arrow3864))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_1(s_1: ArcStudy) -> Any:
            ...
            def _arrow3872(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3871(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3870(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3869(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3868(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3867(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3866(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton_1(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3866))

                                return append(singleton_1(text_value), delay(_arrow3867))

                            return collect(_arrow3868, table.Values)

                        return collect(_arrow3869, s_1.Tables)

                    return append(singleton_1(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3870))

                return append(singleton_1(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3871))

            class ObjectExpr3873:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3872)), ObjectExpr3873())

        class ObjectExpr3874:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_2(a: ArcAssay) -> Any:
            ...
            def _arrow3881(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3880(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3879(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3878(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3877(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow3876(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3875(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton_1(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3875))

                                return append(singleton_1(text_value_1), delay(_arrow3876))

                            return collect(_arrow3877, table_1.Values)

                        return collect(_arrow3878, a.Tables)

                    return append(singleton_1(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3879))

                return append(singleton_1(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3880))
            ...
            return of_seq(to_list(delay(_arrow3881)), ObjectExpr3882())

        class ObjectExpr3883:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr3884:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3865()), union_many(map_1(mapping_1, registered_studies, None), ObjectExpr3874()), union_many(map_1(mapping_2, registered_assays, None), ObjectExpr3883())]), ObjectExpr3884())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3885(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3885)(tree_1)

            else: 
                return tree_1


        def _arrow3887(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3886(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3886)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3887()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr3888:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3888())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3889(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3889)(tree_1)

            else: 
                return tree_1


        def _arrow3891(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3890(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3890)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3891()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr3892:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3892())
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        class ObjectExpr3895:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3894(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3895()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3897:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3896(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3897()):
            def predicate(p: str) -> bool:
...
def ARCAux_getArcInvestigationFromContracts(contracts: Array[Contract]) -> ArcInvestigation:
    ...
    def _arrow3900(x: ArcInvestigation, y: ArcInvestigation, contracts: Any=contracts) -> bool:
        return equals(x, y)

    if (len(match_value) == 1) if (not equals_with(_arrow3900, match_value, None)) else False:
