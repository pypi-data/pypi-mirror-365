...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow213(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                ...
                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr208())
                def _arrow210(__unit: None=None) -> int:
                    c_2: FsCell = head(cells_1)
                    return c_2.RowNumber

                def _arrow212(__unit: None=None) -> int:
                    c_3: FsCell = last(cells_1)
                    return c_3.RowNumber

                tupled_arg_1 = (FsAddress__ctor_Z37302880(_arrow210(), column_index), FsAddress__ctor_Z37302880(_arrow212(), column_index))
                return FsRangeAddress__ctor_7E77A4A0(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow213(), self_1.CellCollection)
        ...
        class ObjectExpr215:
            ...
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow214(x: int, y: int) -> bool:
                    return x == y
        ...
        return map(mapping, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr215()))
    ...
    def Copy(self, __unit: None=None) -> FsWorksheet:
        ...
        def _arrow216(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow217(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow216(), _arrow217(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr218()))
