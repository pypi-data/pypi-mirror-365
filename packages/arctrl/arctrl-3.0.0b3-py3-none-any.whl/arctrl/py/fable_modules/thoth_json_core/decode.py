...
string: Decoder_1[str] = ObjectExpr67()

class ObjectExpr68(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr68()

class ObjectExpr71(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow69(__unit: None=None) -> str:
                return out_arg

            def _arrow70(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow69, _arrow70)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr71()

class ObjectExpr72(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr72()

class ObjectExpr75(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow73(__unit: None=None) -> int8:
                return out_arg

            def _arrow74(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow73, _arrow74)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr75()
