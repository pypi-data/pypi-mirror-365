...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow2532(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2535(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2536(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2538(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2540(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2542(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2543(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2532()), ("@type", list_1_1(singleton(ObjectExpr2533()))), try_include("name", _arrow2535, oa.Name), try_include("protocolType", _arrow2536, oa.ProtocolType), try_include("description", _arrow2538, oa.Description), try_include("uri", _arrow2540, oa.Uri), try_include("version", _arrow2542, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2543, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2556(get: IGetters) -> Protocol:
    def _arrow2548(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow2545(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow2545(), empty())
        def _arrow2546(__unit: None=None) -> FSharpList[Component] | None:
            arg_3: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("reagents", arg_3)

        list_4 = append(default_arg(_arrow2546(), empty()), list_2)
        def _arrow2547(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow2547(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2548())
    def _arrow2549(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("@id", Decode_uri)

    def _arrow2550(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("name", string)

    def _arrow2551(__unit: None=None) -> OntologyAnnotation | None:
    ...
    def _arrow2555(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2549(), _arrow2550(), _arrow2551(), _arrow2552(), _arrow2553(), _arrow2554(), None, components, _arrow2555())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2556)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2560(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2562(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2563(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2565(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2567(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2569(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2570(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return encoder(id_map, value_10)

        def _arrow2571(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, c)

        def _arrow2572(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2560, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2562, oa_1.Name), try_include("protocolType", _arrow2563, oa_1.ProtocolType), try_include("description", _arrow2565, oa_1.Description), try_include("uri", _arrow2567, oa_1.Uri), try_include("version", _arrow2569, oa_1.Version), try_include_list_opt("parameters", _arrow2570, oa_1.Parameters), try_include_list_opt("components", _arrow2571, oa_1.Components), try_include_list_opt("comments", _arrow2572, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2574(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2574, f, oa, id_map)
...
def _arrow2584(get: IGetters) -> Protocol:
    def _arrow2575(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2576(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
    ...
    def _arrow2578(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("description", string)

    def _arrow2579(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("uri", Decode_uri)

    def _arrow2580(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("version", string)

    def _arrow2581(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(decoder)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2582(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_1)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2583(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_2)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2575(), _arrow2576(), _arrow2577(), _arrow2578(), _arrow2579(), _arrow2580(), _arrow2581(), _arrow2582(), _arrow2583())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2584)
