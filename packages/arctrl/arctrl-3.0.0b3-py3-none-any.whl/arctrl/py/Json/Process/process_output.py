...
def _arrow2700(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2701(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2702(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2700, ROCrate_decoder_1), map(_arrow2701, ROCrate_decoder_2), map(_arrow2702, ROCrate_decoder_3)]))
