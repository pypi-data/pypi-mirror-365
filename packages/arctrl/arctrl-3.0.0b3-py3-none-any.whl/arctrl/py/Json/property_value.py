...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr2117(), None)
            ...
            pattern_input_1 = (ObjectExpr2118(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow2120(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow2122(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow2120, oa_1.Name), map(_arrow2122, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr2123(), None)
    ...
    def _arrow2130(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2133(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2136(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2138(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2140(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2142(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2144(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2145(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow2146(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow2148(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2150(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2130()), ("@type", ObjectExpr2131()), ("additionalType", _arrow2133()), try_include("alternateName", _arrow2136, pv.AlternateName()), try_include("measurementMethod", _arrow2138, pv.MeasurementMethod()), try_include("description", _arrow2140, pv.Description()), try_include("category", _arrow2142, pattern_input[0]), try_include("categoryCode", _arrow2144, pattern_input[1]), try_include("value", _arrow2145, pattern_input_1[0]), try_include("valueCode", _arrow2146, pattern_input_1[1]), try_include("unit", _arrow2148, pattern_input_2[0]), try_include("unitCode", _arrow2150, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2153(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2152(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2152(), unit)

    return object(_arrow2153)
