...
IContext_reflection = _expr1745

def _arrow1753(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1746()), ("bio", ObjectExpr1747()), ("Material", ObjectExpr1748()), ("type", ObjectExpr1749()), ("name", ObjectExpr1750()), ("characteristics", ObjectExpr1751())])
...
context_jsonvalue: IEncodable = _arrow1753()
