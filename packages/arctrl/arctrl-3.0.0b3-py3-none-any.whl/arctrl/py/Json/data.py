...
def encoder(d: Data) -> IEncodable:
    ...
    def _arrow2208(value: str, d: Any=d) -> IEncodable:
    ...
    def _arrow2210(value_2: str, d: Any=d) -> IEncodable:
    ...
    def _arrow2212(value_4: str, d: Any=d) -> IEncodable:
    ...
    def _arrow2214(value_6: str, d: Any=d) -> IEncodable:
    ...
    def _arrow2215(comment: Comment, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2208, d.ID), try_include("name", _arrow2210, d.Name), try_include("dataType", ISAJson_encoder_1, d.DataType), try_include("format", _arrow2212, d.Format), try_include("selectorFormat", _arrow2214, d.SelectorFormat), try_include_seq("comments", _arrow2215, d.Comments)]))
...
def _arrow2223(get: IGetters) -> Data:
    ...
    def _arrow2219(__unit: None=None) -> DataFile | None:
    ...
    return Data(_arrow2217(), _arrow2218(), _arrow2219(), _arrow2220(), _arrow2221(), _arrow2222())


decoder: Decoder_1[Data] = object(_arrow2223)
...
def compressed_encoder(string_table: Any, d: Data) -> IEncodable:
    ...
    def _arrow2225(s: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow2226(s_1: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow2227(s_2: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow2228(s_3: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_3)

    def _arrow2229(comment: Comment, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("i", _arrow2225, d.ID), try_include("n", _arrow2226, d.Name), try_include("d", ISAJson_encoder_1, d.DataType), try_include("f", _arrow2227, d.Format), try_include("s", _arrow2228, d.SelectorFormat), try_include_seq("c", _arrow2229, d.Comments)]))
...
def compressed_decoder(string_table: Array[str]) -> Decoder_1[Data]:
    def _arrow2237(get: IGetters, string_table: Any=string_table) -> Data:
...
def ROCrate_encoder(oa: Data) -> IEncodable:
    ...
    def _arrow2241(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2244(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2245(value_4: DataFile, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_4)

    def _arrow2247(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2249(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2250(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2241()), ("@type", list_1_1(singleton(ObjectExpr2242()))), try_include("name", _arrow2244, oa.Name), try_include("type", _arrow2245, oa.DataType), try_include("encodingFormat", _arrow2247, oa.Format), try_include("usageInfo", _arrow2249, oa.SelectorFormat), try_include_seq("comments", _arrow2250, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2258(get: IGetters) -> Data:
    def _arrow2252(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)
    ...
    def _arrow2254(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2257(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow2252(), _arrow2253(), _arrow2254(), _arrow2255(), _arrow2256(), _arrow2257())


ROCrate_decoder: Decoder_1[Data] = object(_arrow2258)
...
def ISAJson_encoder(id_map: Any | None, oa: Data) -> IEncodable:
    def f(oa_1: Data, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2262(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2264(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2262, ROCrate_genID(oa_1)), try_include("name", _arrow2264, oa_1.Name), try_include("type", ISAJson_encoder_1, oa_1.DataType), try_include_seq("comments", _arrow2265, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2267(d_1: Data, id_map: Any=id_map, oa: Any=oa) -> str:
...
def _arrow2272(get: IGetters) -> Data:
    ...
    def _arrow2270(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    return Data(_arrow2268(), _arrow2269(), _arrow2270(), None, None, _arrow2271())


ISAJson_decoder: Decoder_1[Data] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2272)
