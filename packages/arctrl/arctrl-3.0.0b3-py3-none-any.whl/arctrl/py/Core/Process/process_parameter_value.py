...
class ProcessParameterValue(Record):
    ...
    def SetCategory(self, c: OntologyAnnotation) -> ProcessParameterValue:
        this: ProcessParameterValue = self
        def _arrow588(__unit: None=None) -> ProtocolParameter | None:
        ...
        return ProcessParameterValue(_arrow588(), this.Value, this.Unit)
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow590(__unit: None=None) -> str:
        ...
        return ("" if (value is None) else _arrow589()) if (category is None) else (_arrow590() if (value is None) else _arrow591())
...
ProcessParameterValue_reflection = _expr592
