...
class Random:
    ...
    def chance(
        ...
        'probability' provided, that must be a number
        between 0 and 1, where 0.5 means a 50% of
        probability of getting True as the boolean
        value.

        You can provide 1/4 (0.25) as parameter for a
        one in four chance.
        """
        ParameterValidator.validate_mandatory_number_between('probability', probability, 0.0, 1.0)

        return Random.float_between(0.0, 1.0) <= probability
