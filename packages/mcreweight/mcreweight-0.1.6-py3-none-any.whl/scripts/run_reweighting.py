...
def main():
    ...
    parser.add_argument("--monitoring_vars", nargs='+', default=["B_ETA", "nFTClusters", "nVPClusters", "nEcalClusters"],
    ...
    parser.add_argument("--trials", type=int, default=10, help="Number of trials for the gradient boosting reweighting")
    parser.add_argument("--test_size", type=float, default=0.3, help="Proportion of the dataset to include in the test split")
    parser.add_argument("--n_folds", type=int, default=4, help="Number of folds for k-folding reweighting")
