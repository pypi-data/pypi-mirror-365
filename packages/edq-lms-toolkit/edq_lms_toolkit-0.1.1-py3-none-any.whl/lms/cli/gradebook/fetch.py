...
def run_cli(include_empty_assignments = DEFAULT_INCLUDE_EMPTY_ASSIGNMENTS, include_empty_users = DEFAULT_INCLUDE_EMPTY_USERS,
        ...
        skip_headers = lms.cli.common.DEFAULT_SKIP_HEADERS, students = [], **kwargs):
    assignments, user_grades = lms.api.gradebook.fetch.request(user_queries = students, include_computed_scores = include_computed_scores, **kwargs)
...
def _modify_parser(parser):
    ...
    parser.add_argument('--include-computed-scores', dest = 'include_computed_scores',
        ...
        help = 'Include computed scores (default: %(default)s).')
