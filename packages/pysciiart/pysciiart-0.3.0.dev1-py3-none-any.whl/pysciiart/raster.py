...
class RasterCell:
    def __init__(self, character: str = ' ', origin: object = None, color: str = None, attrs: List[str] = None) -> None:
...
class Raster:
    ...
    def write(self, x: int, y: int, text, origin: object = None, color: str = None, attrs: List[str] = None) -> None:
    ...
    def draw_line(self, src_x: int, src_y: int, dst_x: int, dst_y: int, color: str = None,
