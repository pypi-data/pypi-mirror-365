...
class RasterCell:
    def __init__(self, character: str = ' ', origin: object = None,
                 color: str = None, attrs: List[str] = None) -> None:
...
class Raster:
    def __init__(self) -> None:
        self._cells: List[List[RasterCell]] = []
    ...
    def origin_bounds(self, origin: object) -> Optional[Boundary]:
