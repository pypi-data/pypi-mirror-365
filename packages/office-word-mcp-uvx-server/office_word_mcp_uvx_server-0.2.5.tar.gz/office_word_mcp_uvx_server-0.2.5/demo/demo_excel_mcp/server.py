...
# Import from office-word-mcp-uvx-server package with consistent _impl suffixes
...
async def run_sse():
    """Run office-word-mcp-uvx-server in SSE mode."""
    ...
    try:
        logger.info(f"Starting office-word-mcp-uvx-server with SSE transport (files directory: {EXCEL_FILES_PATH})")
...
async def run_streamable_http():
    """Run office-word-mcp-uvx-server in streamable HTTP mode."""
    ...
    try:
        logger.info(f"Starting office-word-mcp-uvx-server with streamable HTTP transport (files directory: {EXCEL_FILES_PATH})")
...
def run_stdio():
    """Run office-word-mcp-uvx-server in stdio mode."""
    # No need to assign EXCEL_FILES_PATH in stdio mode
    
    try:
        logger.info("Starting office-word-mcp-uvx-server with stdio transport")
