...
def test_get_x_sn_date():
    """Test that the get_x_sn_date function returns the correct date string."""
...
def test_generate_signing_key_hex():
    """Test that the generate_signing_key_hex function returns a 64-character hex string."""
    dt = datetime(2024, 2, 4, 12, 30, 45, tzinfo=timezone.utc)
    secret = "test_secret"
...
def test_order_query_parameters():
    """Test that the order_query_parameters function returns the correct ordered query parameters."""
    # Test empty string
...
def test_generate_canonical_request_message():
    """Test that the generate_canonical_request_message function returns the correct canonical request message."""
    method = "GET"
    path = "/api/v1/data"
...
def test_generate_signing_message():
    """Test that the generate_signing_message function returns the correct signing message."""
    dt = datetime(2024, 2, 4, 12, 30, 45, tzinfo=timezone.utc)
...
def test_generate_auth_header():
    """Test that the generate_auth_header function returns the correct auth header."""
    dt = datetime(2024, 2, 4, 12, 30, 45, tzinfo=timezone.utc)
    token = "test_token"
    secret = "test_secret"
    method = "GET"
