...
class PortLinkClient:
    def __init__(self, server_uri=None, debug=False, ping_timeout=31):
        # 默认使用公共服务器地址
...
async def main():
    ...
    parser.add_argument('-t', '--ping-timeout', type=int, default=31, help='WebSocket ping timeout in seconds (default: 60)')
