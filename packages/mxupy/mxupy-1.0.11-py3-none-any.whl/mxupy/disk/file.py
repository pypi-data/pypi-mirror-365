...
def read_file(filename, type='user', user_id=-1, sub_dir='', responseType='content'):
    """ 读取用户文件
    ...
    Args:
        ...
        responseType (str): text：文本内容、content：文件内容、file：下载
    ...
    """
    if responseType not in ['text', 'content', 'file']:
