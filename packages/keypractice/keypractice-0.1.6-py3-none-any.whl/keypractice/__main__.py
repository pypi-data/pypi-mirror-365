...
def main():
    # Look for YAML files in the package directory
    package_dir = get_package_dir()
    yaml_files = glob.glob(os.path.join(package_dir, '*.yaml'))
    
    if not yaml_files:
        print('No exercise YAML files found in the package. Please add some to the keypractice/ directory.')
        return
