...
PROMPT = ("You will get unix command which failed and your job is to fix it. "
...
class CommandCorrection(BaseModel):
    ...
    corrected_command: str = Field(..., description="The corrected and likely intended Unix command. "
