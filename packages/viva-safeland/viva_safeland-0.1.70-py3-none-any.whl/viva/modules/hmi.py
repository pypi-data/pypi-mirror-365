...
class HMI:
    ...
    def __call__(self) -> Tuple[List[float], bool, bool]:
        ...
        Returns:
            A tuple containing:
                - actions (List[float]): Control values [theta, phi, fk].
    ...
    def quit(self) -> None:
        ...
        Properly closes all controllers and shuts down pygame systems.
        """
