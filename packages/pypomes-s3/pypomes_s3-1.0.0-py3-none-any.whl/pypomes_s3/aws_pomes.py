...
def prefix_count(errors: list[str] | None,
                 prefix: str | Path | None,
                 bucket: str = None,
                 client: BaseClient = None,
...
def prefix_list(errors: list[str] | None,
                prefix: str | Path,
                max_count: int = None,
...
def prefix_remove(errors: list[str] | None,
                  prefix: str | Path,
                  bucket: str = None,
                  client: BaseClient = None,
                  logger: Logger = None) -> int:
    ...
    if client:
        ...
        bucket = bucket or _get_param(engine=S3Engine.AWS,
                                      param=S3Param.BUCKET_NAME)
        items: list[dict[str, Any]] = prefix_list(errors=errors,
                                                  bucket=bucket,
                                                  prefix=prefix,
                                                  client=client,
                                                  logger=logger)
