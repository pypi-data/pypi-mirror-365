...
class InsufficientCreditError(BaseModel):
    """
    Error response for not having sufficient credits.
    """ # noqa: E501
    status: Optional[StrictStr] = 'Error'
    message: Optional[StrictStr] = 'Operation failed due to a client error'
    detail: Optional[StrictStr] = 'You have insufficient credits to create a new Inference Services.'
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InsufficientCreditError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InsufficientCreditError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "detail": obj.get("detail") if obj.get("detail") is not None else 'You have insufficient credits to create a new Inference Services.',
