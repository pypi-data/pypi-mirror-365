...
class GetSizeClassesSuccess(BaseModel):
    """
    Success response for size classes list.
    """ # noqa: E501
    ...
    size_classes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "size_classes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSizeClassesSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSizeClassesSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size_classes": obj.get("size_classes")
        })
        return _obj
