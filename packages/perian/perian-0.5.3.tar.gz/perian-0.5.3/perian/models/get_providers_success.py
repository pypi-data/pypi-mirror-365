...
class GetProvidersSuccess(BaseModel):
    """
    Success response for providers list.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "providers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetProvidersSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetProvidersSuccess from a dict"""
        if obj is None:
            return None
