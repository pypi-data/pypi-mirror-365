...
class SourceManager:
    ...
    def _fetch_all_data(self):
        ...
        self.properties = self.client.get_properties()  # Properties are now global
    ...
    def _ensure_properties_exist(self):
        ...
        for prop_def in self.property_definitions:
            ...
            if tech_name not in self.properties_by_tech_name:
                ...
                created_property = self.client.create_property(property_data, source_id=self.source_id)
