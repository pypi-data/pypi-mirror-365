...
class qlscript(ql_api):
    ...
    async def add(self, filename: str, path: str, content: str, originFilename: str) -> dict:
        ...
        res = await self.s.post(url, json=data) # httpx 自动处理 json 参数
        return res.json()
    ...
    async def update(self, filename: str, path: str, content: str) -> dict:
        ...
        res = await self.s.put(url, json=data) # httpx 自动处理 json 参数
        return res.json()
    ...
    async def delete(self, path:str,filename: str) -> dict:
        ...
        res = await self.s.delete(url,json=data) # httpx 自动处理 json 参数
        return res.json()
