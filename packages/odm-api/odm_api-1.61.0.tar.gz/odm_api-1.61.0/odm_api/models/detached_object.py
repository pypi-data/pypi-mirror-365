...
class DetachedObject(BaseModel):
    ...
    def detached_object_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['STUDY', 'SAMPLE_GROUP', 'LIBRARY_GROUP', 'PREPARATION_GROUP', 'TABULAR_DATA', 'GENE_VARIANT', 'FLOW_CYTOMETRY']):
            raise ValueError("must be one of enum values ('STUDY', 'SAMPLE_GROUP', 'LIBRARY_GROUP', 'PREPARATION_GROUP', 'TABULAR_DATA', 'GENE_VARIANT', 'FLOW_CYTOMETRY')")
        return value
