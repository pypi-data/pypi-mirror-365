...
class VariantMetadataWithId(BaseModel):
    ...
    reference_genome: Optional[Dict[str, Any]] = Field(default=None, alias="referenceGenome")
    __properties: ClassVar[List[str]] = ["itemId", "metadata", "annotation", "referenceGenome"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "referenceGenome": obj.get("referenceGenome")
        })
        return _obj
