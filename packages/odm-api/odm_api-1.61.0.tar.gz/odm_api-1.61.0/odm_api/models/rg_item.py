...
class RGItem(BaseModel):
    ...
    RGItem
    """ # noqa: E501
    genestackaccession: Optional[StrictStr] = Field(default=None, alias="genestack:accession")
    annotation_url: Optional[StrictStr] = Field(default=None, alias="annotationUrl")
    organism: Optional[StrictStr] = None
    assembly: Optional[StrictStr] = None
    release: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    initialization_status: Optional[StrictStr] = Field(default=None, alias="initializationStatus")
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    owner_email: Optional[StrictStr] = Field(default=None, alias="ownerEmail")
    __properties: ClassVar[List[str]] = ["genestack:accession", "annotationUrl", "organism", "assembly", "release", "name", "initializationStatus", "createdAt", "ownerEmail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotationUrl": obj.get("annotationUrl"),
