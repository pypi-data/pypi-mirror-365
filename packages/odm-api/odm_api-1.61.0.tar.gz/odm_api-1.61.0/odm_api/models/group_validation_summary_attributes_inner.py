    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.attribute_invalid_values:
            for _item_attribute_invalid_values in self.attribute_invalid_values:
                if _item_attribute_invalid_values:
                    _items.append(_item_attribute_invalid_values.to_dict())
