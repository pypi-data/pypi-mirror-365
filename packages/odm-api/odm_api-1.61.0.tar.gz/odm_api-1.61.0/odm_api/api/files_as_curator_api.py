...
class FilesAsCuratorApi:
    ...
    def get_file_as_curator(
        ...
        _param = self._get_file_as_curator_serialize(
            id=id,
            range=range,
    ...
    @validate_call
    def get_file_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        range: Annotated[Optional[StrictStr], Field(description="Request a specific range of bytes to support partial downloads. Example: `bytes=0-1024` to download the first 1024 bytes. Supplying several ranges is not supported. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_file_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        range: Annotated[Optional[StrictStr], Field(description="Request a specific range of bytes to support partial downloads. Example: `bytes=0-1024` to download the first 1024 bytes. Supplying several ranges is not supported. ")] = None,
        _request_timeout: Union[
    ...
    def _get_file_as_curator_serialize(
        self,
        id,
        range,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/files/{id}/download',
    ...
    @validate_call
    def get_file_metadata_by_id_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        ...
        _param = self._get_file_metadata_by_id_as_curator_serialize(
            id=id,
    ...
    @validate_call
    def get_file_metadata_by_id_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        include_contents: Annotated[Optional[StrictBool], Field(description="Select `true` in order to include file structure (contents) for .h5, .h5ad, .zip, .gz to the response.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_file_metadata_by_id_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        include_contents: Annotated[Optional[StrictBool], Field(description="Select `true` in order to include file structure (contents) for .h5, .h5ad, .zip, .gz to the response.")] = None,
        _request_timeout: Union[
    ...
    def _get_file_metadata_by_id_as_curator_serialize(
        self,
        id,
        include_contents,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/files/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_files_metadata_as_curator(
        self,
        ...
        _param = self._get_files_metadata_as_curator_serialize(
            filter=filter,
            query=query,
            include_contents=include_contents,
    ...
    @validate_call
    def get_files_metadata_as_curator_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by files metadata (key-value metadata pair(s)).")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for files via a full-text query over all file metadata.")] = None,
        include_contents: Annotated[Optional[StrictBool], Field(description="Select `true` in order to include file structure (contents) for .h5, .h5ad, .zip, .gz to the response.")] = None,
    ...
    @validate_call
    def get_files_metadata_as_curator_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by files metadata (key-value metadata pair(s)).")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for files via a full-text query over all file metadata.")] = None,
        include_contents: Annotated[Optional[StrictBool], Field(description="Select `true` in order to include file structure (contents) for .h5, .h5ad, .zip, .gz to the response.")] = None,
    ...
    def _get_files_metadata_as_curator_serialize(
        self,
        filter,
        query,
        include_contents,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def head_file_as_curator(
        ...
        _param = self._head_file_as_curator_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def head_file_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def head_file_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _head_file_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
