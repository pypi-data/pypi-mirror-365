...
class TestAccessionResponse(unittest.TestCase):
    """AccessionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessionResponse:
        """Test AccessionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessionResponse`
        """
        model = AccessionResponse()
        if include_optional:
            return AccessionResponse(
                genestackaccession = ''
            )
        else:
            return AccessionResponse(
    ...
    def testAccessionResponse(self):
        """Test AccessionResponse"""
