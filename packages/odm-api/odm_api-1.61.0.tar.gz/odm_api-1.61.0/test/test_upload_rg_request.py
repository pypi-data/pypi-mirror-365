...
class TestUploadRGRequest(unittest.TestCase):
    """UploadRGRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadRGRequest:
        """Test UploadRGRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadRGRequest`
        """
        model = UploadRGRequest()
        if include_optional:
            return UploadRGRequest(
                annotation_url = '',
                organism = '',
                assembly = '',
                release = '',
