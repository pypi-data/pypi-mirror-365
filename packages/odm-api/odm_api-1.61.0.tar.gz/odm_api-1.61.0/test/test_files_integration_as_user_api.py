...
class TestFilesIntegrationAsUserApi(unittest.TestCase):
    """FilesIntegrationAsUserApi unit test stubs"""

    def setUp(self) -> None:
        self.api = FilesIntegrationAsUserApi()

    def tearDown(self) -> None:
        pass

    def test_get_files_by_study_as_user(self) -> None:
        """Test case for get_files_by_study_as_user
