...
# --- ПРИКЛАД ЗАПУСКУ ДЛЯ ТЕСТУВАННЯ ---
if __name__ == '__main__':
    # 1. Ваші дані для тесту
    SENDER_KEY = "53691ca52406d5f3271ba44c7133d96ea7704e1ffd650e3e9ea6f4f76a1c3193af550c70c9bf9761c47c88a27a9c6ae4875d32ea958845d2f667f61902300184"
    RECIPIENT_ADDR = "Te9E5FBj7pkaC9GU3RqSUsCdrqqVV4Y6g5GvUr8Ydpy"
    AMOUNT = 0.01  # Кількість SOL для відправки

    print("--- Початок тестової транзакції ---")

    # 2. Створюємо екземпляр класу
    solana_handler = SolanaTransaction()

    # 3. Викликаємо метод
    result = solana_handler.send_transaction(
        sender_private_key_hex=SENDER_KEY,
    ...
    if isinstance(result, dict) and 'error' in result:
        ...
        print(f"Посилання на транзакцію: {result}")
    print("-----------------")
