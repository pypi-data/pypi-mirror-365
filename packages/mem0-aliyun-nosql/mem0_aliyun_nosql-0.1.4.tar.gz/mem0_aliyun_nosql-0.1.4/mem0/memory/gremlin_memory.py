...
class MemoryGraph:
    def __init__(self, config):
        ...
        # Initialize vector store and embedding model for external vector indexing
    ...
    def _delete_entities(self, to_be_deleted, filters):
        ...
        for item in to_be_deleted:
            ...
            if result:
                ...
                # Delete corresponding embeddings from vector store
    ...
    def _add_entities(self, to_be_added, filters, entity_type_map):
        ...
        for item in to_be_added:
            ...
            if not destination_node_search_result and source_node_search_result:
                ...
                dest_id = f"{destination}_{user_id}_{hashlib.md5((destination + user_id).encode()).hexdigest()}"
                ...
                source_id = f"{source}_{user_id}_{hashlib.md5((source + user_id).encode()).hexdigest()}"
            ...
            try:
                ...
                if result:
                    ...
                    # Store embeddings in vector store after successful graph operations
    ...
    def _refresh_vector_store(self):
        if hasattr(self.vector_store, 'refresh') and callable(self.vector_store.refresh):
