...
class Tf(BasePanel[TFMessage]):
    SUPPORTED_SCHEMAS: ClassVar[set[str]] = {"tf2_msgs/msg/TFMessage"}
    ...
    def watch_data(self, data: ChannelMessage[TFMessage] | None) -> None:
        if data is None:
            return
        if data.schema != "tf2_msgs/msg/TFMessage":
            return
