...
class mapServersImplementationsCreateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[ServersImplementationsCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapServersImplementationsCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ServersImplementationsCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
