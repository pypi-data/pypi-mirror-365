...
class mapServersImplementationsUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ServersImplementationsUpdateOutput:
        ...
        server_variant=data.get('server_variant') and {
    ...
    @staticmethod
    def to_dict(value: Union[ServersImplementationsUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapServersImplementationsUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ServersImplementationsUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
