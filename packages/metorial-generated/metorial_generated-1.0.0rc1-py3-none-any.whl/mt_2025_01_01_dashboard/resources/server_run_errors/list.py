...
class mapServerRunErrorsListOutput:
    ...
    @staticmethod
    def to_dict(value: Union[ServerRunErrorsListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapServerRunErrorsListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[ServerRunErrorsListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
