...
def test_environment():
	...
	for tool in ['curl', 'sed']:
		try:
			subprocess.run(f'command -v {tool}', shell=True, check=True, capture_output=True)
...
def test_correctly_setup():
	...
	local_test_command_entry = atuin.test_atuin_recording_locally()
...
def _main():
	...
	atuin.test_atuin_recording_locally()
