...
def import_existing_history():
	...
	try:
		out = run_command([Paths.EXECUTABLE, 'import', Shell().name], check=True)
		return True
...
def configure_atuin(sync_address: str, freq='0'):
...
def is_the_users_existing_atuin_env_supported() -> bool:
...
def test_atuin_recording_locally() -> dict | None:
	"""
	...
	full_command = run_test_login_command(
		...
		env=os.environ.copy() | neccessary_atuin_env_vars(),
	)
