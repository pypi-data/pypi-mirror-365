...
def create_gps(executor: GraphQLExecutor, config_id: str, variables: list):
    gps_items = [GPSSchema(**item) for item in variables]
    payload = make_gps_input(config_id, gps_items)
