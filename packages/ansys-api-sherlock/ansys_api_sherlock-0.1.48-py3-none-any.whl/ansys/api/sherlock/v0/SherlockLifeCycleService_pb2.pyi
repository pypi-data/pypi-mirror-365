...
class ImportThermalSignalRequest(google.protobuf.message.Message):
    ...
    NUMBEROFBINS_FIELD_NUMBER: builtins.int
    FILTERINGLIMIT_FIELD_NUMBER: builtins.int
    ...
    numberOfBins: builtins.int = ...
    """Number of bins for binning cycles, 0 for no binning."""

    filteringLimit: builtins.float = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fileProperties",b"fileProperties","filteringLimit",b"filteringLimit","generatedCyclesLabel",b"generatedCyclesLabel","loadRangePercentage",b"loadRangePercentage","numberOfBins",b"numberOfBins","phaseName",b"phaseName","project",b"project","thermalSignalFile",b"thermalSignalFile","timeRemoval",b"timeRemoval"]) -> None: ...
