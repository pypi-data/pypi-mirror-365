...
def add_cli_intersect_arg_parser(
    ...
    parser = sub_parsers.add_parser(
        'intersect',
        help='Identify an intersecting set of variants among variant lists.'
    )
    ...
    parser_required.add_argument(
        ...
        nargs='+',
        required=True,
        help="Variants list TSV files. Expected columns: 'id', 'chromosome_1', position_1', 'operation_1', 'chromosome_2', 'position_2', 'operation_2'."
    )
    parser_required.add_argument(
        "--output-tsv-file", '-o',
...
def run_cli_intersect_from_parsed_args(args: argparse.Namespace):
    ...
    df_intersecting.to_csv(args.output_tsv_file, sep='\t', index=False)
