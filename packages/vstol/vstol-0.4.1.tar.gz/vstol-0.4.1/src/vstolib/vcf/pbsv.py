...
def parse_pbsv_vcf(
    ...
    """
    Parse a PBSV VCF DataFrame and return a Pandas DataFrame.
    ...
    for row in df_vcf.to_dict('records'):
        ...
        for sample_id in sample_ids:
            ...
            def append_variant(
                ...
                data['method'].append(VariantCallingMethod.PBSV)
            ...
            if sv_type == 'DEL':
                ...
                insertion_sequence = alternate_allele[1:]
                append_variant(
                    chromosome_1=chromosome,
                    position_1=position,
                    strand_1=Strand.FORWARD,
    ...
    logger.info('Converted %i PBSV variants.' % len(df_variants['id'].unique()))
    return df_variants
