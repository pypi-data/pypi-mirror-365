...
from studyfetch_sdk.types.v1 import Material
...
class TestUpload:
    ...
    def test_method_complete_upload(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(Material, upload, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_create_presigned_url(self, client: StudyfetchSDK) -> None:
        upload = client.v1.materials.upload.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        )
        assert_matches_type(UploadCreatePresignedURLResponse, upload, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_method_create_presigned_url_with_all_params(self, client: StudyfetchSDK) -> None:
        upload = client.v1.materials.upload.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_create_presigned_url(self, client: StudyfetchSDK) -> None:
        response = client.v1.materials.upload.with_raw_response.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create_presigned_url(self, client: StudyfetchSDK) -> None:
        with client.v1.materials.upload.with_streaming_response.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        ) as response:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_upload_url_and_process(self, client: StudyfetchSDK) -> None:
        upload = client.v1.materials.upload.upload_url_and_process(
            name="My Document",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_upload_url_and_process_with_all_params(self, client: StudyfetchSDK) -> None:
        upload = client.v1.materials.upload.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
            folder_id="folderId",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_upload_url_and_process(self, client: StudyfetchSDK) -> None:
        response = client.v1.materials.upload.with_raw_response.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_upload_url_and_process(self, client: StudyfetchSDK) -> None:
        with client.v1.materials.upload.with_streaming_response.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
        ) as response:
            assert not response.is_closed
...
class TestAsyncUpload:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_presigned_url(self, async_client: AsyncStudyfetchSDK) -> None:
        upload = await async_client.v1.materials.upload.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_presigned_url_with_all_params(self, async_client: AsyncStudyfetchSDK) -> None:
        upload = await async_client.v1.materials.upload.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_create_presigned_url(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.materials.upload.with_raw_response.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create_presigned_url(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.materials.upload.with_streaming_response.create_presigned_url(
            content_type="application/pdf",
            filename="document.pdf",
            name="Chapter 1 Notes",
        ) as response:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_upload_url_and_process(self, async_client: AsyncStudyfetchSDK) -> None:
        upload = await async_client.v1.materials.upload.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
        )
        assert_matches_type(Material, upload, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_upload_url_and_process_with_all_params(self, async_client: AsyncStudyfetchSDK) -> None:
        upload = await async_client.v1.materials.upload.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
            folder_id="folderId",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_upload_url_and_process(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.materials.upload.with_raw_response.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_upload_url_and_process(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.materials.upload.with_streaming_response.upload_url_and_process(
            name="My Document",
            url="https://example.com/document.pdf",
        ) as response:
            assert not response.is_closed
