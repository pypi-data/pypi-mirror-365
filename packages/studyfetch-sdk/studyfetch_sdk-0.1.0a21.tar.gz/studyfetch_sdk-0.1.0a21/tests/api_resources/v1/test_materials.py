...
class TestMaterials:
    ...
    def test_method_create(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(Material, material, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_batch_create(self, client: StudyfetchSDK) -> None:
        material = client.v1.materials.batch_create(
            materials=[
                {
        ...
        assert_matches_type(MaterialBatchCreateResponse, material, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_batch_create(self, client: StudyfetchSDK) -> None:
        response = client.v1.materials.with_raw_response.batch_create(
            materials=[
                {
                    "content_type": "application/pdf",
                    "filename": "document.pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_batch_create(self, client: StudyfetchSDK) -> None:
        with client.v1.materials.with_streaming_response.batch_create(
            materials=[
                {
                    "content_type": "application/pdf",
                    "filename": "document.pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_debug(self, client: StudyfetchSDK) -> None:
        material = client.v1.materials.debug(
            "id",
        )
        assert_matches_type(MaterialDebugResponse, material, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_debug(self, client: StudyfetchSDK) -> None:
        response = client.v1.materials.with_raw_response.debug(
            "id",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_debug(self, client: StudyfetchSDK) -> None:
        with client.v1.materials.with_streaming_response.debug(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_debug(self, client: StudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.materials.with_raw_response.debug(
                "",
            )
    ...
    def test_method_generate(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(GeneratedMaterial, material, path=["response"])
...
class TestAsyncMaterials:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_batch_create(self, async_client: AsyncStudyfetchSDK) -> None:
        material = await async_client.v1.materials.batch_create(
            materials=[
                {
                    "content_type": "application/pdf",
                    "filename": "document.pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_batch_create(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.materials.with_raw_response.batch_create(
            materials=[
                {
                    "content_type": "application/pdf",
                    "filename": "document.pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_batch_create(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.materials.with_streaming_response.batch_create(
            materials=[
                {
                    "content_type": "application/pdf",
                    "filename": "document.pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_debug(self, async_client: AsyncStudyfetchSDK) -> None:
        material = await async_client.v1.materials.debug(
            "id",
        )
        assert_matches_type(MaterialDebugResponse, material, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_debug(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.materials.with_raw_response.debug(
            "id",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_debug(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.materials.with_streaming_response.debug(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_debug(self, async_client: AsyncStudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.materials.with_raw_response.debug(
                "",
            )
