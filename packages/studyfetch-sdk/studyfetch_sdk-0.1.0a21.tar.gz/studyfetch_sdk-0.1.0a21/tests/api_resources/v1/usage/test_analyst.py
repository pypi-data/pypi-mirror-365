...
from studyfetch_sdk.types.v1.usage import (
...
class TestAnalyst:
    ...
    def test_method_get_test_questions(self, client: StudyfetchSDK) -> None:
        analyst = client.v1.usage.analyst.get_test_questions()
    ...
    def test_raw_response_get_test_questions(self, client: StudyfetchSDK) -> None:
        response = client.v1.usage.analyst.with_raw_response.get_test_questions()
    ...
    def test_streaming_response_get_test_questions(self, client: StudyfetchSDK) -> None:
        with client.v1.usage.analyst.with_streaming_response.get_test_questions() as response:
    ...
    def test_method_list_chat_messages(self, client: StudyfetchSDK) -> None:
        analyst = client.v1.usage.analyst.list_chat_messages()
        assert_matches_type(AnalystListChatMessagesResponse, analyst, path=["response"])
    ...
    def test_raw_response_list_chat_messages(self, client: StudyfetchSDK) -> None:
        response = client.v1.usage.analyst.with_raw_response.list_chat_messages()
    ...
    def test_streaming_response_list_chat_messages(self, client: StudyfetchSDK) -> None:
        with client.v1.usage.analyst.with_streaming_response.list_chat_messages() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list_events(self, client: StudyfetchSDK) -> None:
        analyst = client.v1.usage.analyst.list_events(
            end_date="endDate",
    ...
    def test_raw_response_list_events(self, client: StudyfetchSDK) -> None:
        response = client.v1.usage.analyst.with_raw_response.list_events(
            end_date="endDate",
            event_type="material_created",
            start_date="startDate",
        )
    ...
    def test_streaming_response_list_events(self, client: StudyfetchSDK) -> None:
        with client.v1.usage.analyst.with_streaming_response.list_events(
            end_date="endDate",
            event_type="material_created",
            start_date="startDate",
        ) as response:
...
class TestAsyncAnalyst:
    ...
    async def test_method_get_test_questions(self, async_client: AsyncStudyfetchSDK) -> None:
        analyst = await async_client.v1.usage.analyst.get_test_questions()
        assert analyst is None
    ...
    async def test_raw_response_get_test_questions(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.usage.analyst.with_raw_response.get_test_questions()
    ...
    async def test_streaming_response_get_test_questions(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.usage.analyst.with_streaming_response.get_test_questions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list_chat_messages(self, async_client: AsyncStudyfetchSDK) -> None:
        analyst = await async_client.v1.usage.analyst.list_chat_messages()
        assert_matches_type(AnalystListChatMessagesResponse, analyst, path=["response"])
    ...
    async def test_raw_response_list_chat_messages(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.usage.analyst.with_raw_response.list_chat_messages()
    ...
    async def test_streaming_response_list_chat_messages(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.usage.analyst.with_streaming_response.list_chat_messages() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list_events(self, async_client: AsyncStudyfetchSDK) -> None:
        analyst = await async_client.v1.usage.analyst.list_events(
            end_date="endDate",
            event_type="material_created",
            start_date="startDate",
        )
    ...
    async def test_raw_response_list_events(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.usage.analyst.with_raw_response.list_events(
            end_date="endDate",
            event_type="material_created",
            start_date="startDate",
        )
    ...
    async def test_streaming_response_list_events(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.usage.analyst.with_streaming_response.list_events(
            end_date="endDate",
            event_type="material_created",
            start_date="startDate",
        ) as response:
