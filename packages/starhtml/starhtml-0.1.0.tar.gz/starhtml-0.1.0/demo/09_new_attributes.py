...
def home():
    return Div(
        ...
        Div(
            ...
            Div(
                P(
                    "Loading...",
                    ds_text="$onceMessage",
                    ds_on_load__once="$onceMessage = 'Loaded once at ' + new Date().toLocaleTimeString()",
                ),
        ...
        Div(
            ...
            Form(
                Input(type="text", placeholder="Type here...", cls="border p-2 rounded", ds_preserve_attr="value"),
                Textarea(
                    placeholder="Write something...", cls="border p-2 rounded mt-2 w-full", ds_preserve_attr="value"
                ),
                Select(
        ...
        Div(
            ...
            Pre(ds_json_signals=True, cls="bg-gray-900 text-green-400 p-4 rounded font-mono text-sm overflow-auto"),
