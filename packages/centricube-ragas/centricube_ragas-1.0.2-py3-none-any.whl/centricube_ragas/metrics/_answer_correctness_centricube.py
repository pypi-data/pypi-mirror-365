...
from centricube_ragas.metrics._answer_similarity import AnswerSimilarity
...
@dataclass
class AnswerCorrectnessCentricube(MetricWithLLM):
    """
...
answer_correctness_centricube = AnswerCorrectnessCentricube()
