...
class WorkflowListType(BaseEntryListType):
    ...
    def load_dds(self, data):
        ...
        if s1_date_created is not None:
            ...
            w1.load_data(
                '1-created', 'vytvořeno', None, s1_date_created, s1_creator,
                None, '2-authorized')
        ...
        if form == 'regcertrequest':
            ...
            if s11_date_accepted is not None:
                ...
                w11.node_name = f'žádost akceptována'
