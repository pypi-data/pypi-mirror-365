...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <evathon.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <evathon.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <evathon.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None):
        ...
        <evathon.events.newmessage.NewMessage>`. You cannot distinguish
