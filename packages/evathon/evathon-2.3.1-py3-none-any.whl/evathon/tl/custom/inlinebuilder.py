...
class InlineBuilder:
    ...
    <evathon.events.inlinequery.InlineQuery>` ``results``.
    ...
    explained here to avoid repetition:
        ...
        buttons (`list`, `custom.Button <evathon.tl.custom.button.Button>`, :tl:`KeyboardButton`, optional):
    ...
    async def photo(
        ...
        Args:
            ...
            file (`obj`, optional):
                ...
                <evathon.client.uploads.UploadMethods.send_file>`.
