...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <evathon.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <evathon.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <evathon.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `TelegramClient <evathon.client.telegramclient.TelegramClient>`
    ...
    def forward(self):
        """
        The `Forward <evathon.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <evathon.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <evathon.tl.custom.file.File>` wrapping the
        ...
        `file.id <evathon.tl.custom.file.File.id>`,
        `file.name <evathon.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from evathon.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `evathon.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `evathon.client.messages.MessageMethods.forward_messages`
        ...
        `evathon.client.telegramclient.TelegramClient` instance directly.
        """
        if self._client:
    ...
    async def edit(self, *args, **kwargs):
        ...
        `evathon.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `evathon.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `evathon.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <evathon.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <evathon.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <evathon.tl.types.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        <evathon.client.messages.MessageMethods.send_read_acknowledge>`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `evathon.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `evathon.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
