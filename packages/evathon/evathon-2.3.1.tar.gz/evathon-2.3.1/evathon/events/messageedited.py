...
class MessageEdited(NewMessage):
    ...
    <evathon.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <evathon.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <evathon.tl.custom.message.Message>`
