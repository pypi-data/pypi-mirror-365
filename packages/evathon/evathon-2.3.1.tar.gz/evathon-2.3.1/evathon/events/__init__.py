...
def register(event=None):
    ...
    `add_event_handler()
    <evathon.client.updates.UpdateMethods.add_event_handler>` variant.
    ...
    >>> # (somewhere else)
    ...
    >>> from evathon import TelegramClient
    >>> client = TelegramClient(...)
...
def unregister(callback, event=None):
    ...
    <evathon.client.updates.UpdateMethods.remove_event_handler>`
