...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <evathon.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <evathon.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `evathon.client.messages.MessageMethods.send_message`
