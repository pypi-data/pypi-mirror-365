...
class MessageButton:
    ...
    .. note::
        ...
        <evathon.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `evathon.client.telegramclient.TelegramClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None):
        ...
        sent, and the sent `Message <evathon.tl.custom.message.Message>` returned.
