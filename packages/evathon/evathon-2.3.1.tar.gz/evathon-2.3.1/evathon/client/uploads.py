...
def _resize_photo_if_needed(
    ...
    try:
        ...
        # See https://github.com/LonamiWebs/evathon/issues/1121 for more.
...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            file (`str` | `bytes` | `file` | `media`):
                ...
                * A Bot API-like ``file_id``. You can convert previously
                  ...
                  `evathon.utils.pack_bot_file_id`.
            ...
            reply_to (`int` | `Message <evathon.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <evathon.tl.custom.message.Message>` (or messages)
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <evathon.tl.custom.inputsizedfile.InputSizedFile>`
