...
class AccountMethods:
    def takeout(
        ...
        """
        Returns a :ref:`evathon-client` which calls methods behind a takeout session.
        ...
        <evathon.client.messages.MessageMethods.iter_messages>`.
        ...
        <evathon.sessions.abstract.Session.takeout_id>`.
