        ...
        for d in r.dialogs:
            ...
            if peer_id not in self.seen:
                ...
                if peer_id not in entities:
                    ...
                    # Real world example: https://t.me/evathonChat/271471
                    continue
...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <evathon.tl.custom.dialog.Dialog>`.
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <evathon.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <evathon.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <evathon.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <evathon.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <evathon.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <evathon.tl.custom.conversation.Conversation>`.
