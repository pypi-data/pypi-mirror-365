...
class ChatMethods:
    ...
    def iter_participants(
        ...
        Example
            .. code-block:: python
                ...
                # Filter by admins
                from evathon.tl.types import ChannelParticipantsAdmins
    ...
    def iter_admin_log(
        ...
        *all* event types will be returned. If at least one of them is
        ...
        Yields
            Instances of `AdminLogEvent <evathon.tl.custom.adminlogevent.AdminLogEvent>`.
    ...
    async def kick_participant(
        ...
        Returns
            Returns the service `Message <evathon.tl.custom.message.Message>`
    ...
    async def get_permissions(
        ...
        Returns
            A `ParticipantPermissions <evathon.tl.custom.participantpermissions.ParticipantPermissions>`
    ...
    async def get_stats(
        ...
        Raises
            ...
            ``evathon.errors.ChatAdminRequiredError`` will appear.
