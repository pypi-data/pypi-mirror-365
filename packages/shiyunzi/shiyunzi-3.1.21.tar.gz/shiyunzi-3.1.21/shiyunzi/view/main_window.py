...
class MainWindow(QMainWindow):
    ...
    def switch_page(self, index):
        ...
        self.runway_btn.setChecked(index == 4)
        self.ai_btn.setChecked(index == 5)
        self.sd_btn.setChecked(index == 6)
        self.video_btn.setChecked(index == 7)
