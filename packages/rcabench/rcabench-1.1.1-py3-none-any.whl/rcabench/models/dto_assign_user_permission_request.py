...
class DtoAssignUserPermissionRequest(BaseModel):
    """
    ...
    user_id: StrictInt
    __properties: ClassVar[List[str]] = ["expires_at", "grant_type", "permission_id", "project_id", "user_id"]

    @field_validator('grant_type')
    def grant_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('grant', 'deny'):
            raise ValueError("must be one of enum values ('grant', 'deny')")
        return value
