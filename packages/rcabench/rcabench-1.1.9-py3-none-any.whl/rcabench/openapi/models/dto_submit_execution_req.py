...
class DtoSubmitExecutionReq(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "payloads": [DtoExecutionPayload.from_dict(_item) for _item in obj.get("payloads")] if obj.get("payloads") is not None else None,
