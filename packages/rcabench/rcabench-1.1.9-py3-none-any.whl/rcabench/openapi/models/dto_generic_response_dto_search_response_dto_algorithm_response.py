...
class DtoGenericResponseDtoSearchResponseDtoAlgorithmResponse(BaseModel):
    ...
    data: Optional[DtoSearchResponseDtoAlgorithmResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoSearchResponseDtoAlgorithmResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
