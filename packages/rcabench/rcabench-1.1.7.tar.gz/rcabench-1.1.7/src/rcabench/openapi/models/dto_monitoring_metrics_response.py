...
class DtoMonitoringMetricsResponse(BaseModel):
    """
    DtoMonitoringMetricsResponse
    """ # noqa: E501
    labels: Optional[Dict[str, StrictStr]] = None
    metrics: Optional[Dict[str, DtoMetricValue]] = None
    timestamp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["labels", "metrics", "timestamp"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": dict(
                (_k, DtoMetricValue.from_dict(_v))
