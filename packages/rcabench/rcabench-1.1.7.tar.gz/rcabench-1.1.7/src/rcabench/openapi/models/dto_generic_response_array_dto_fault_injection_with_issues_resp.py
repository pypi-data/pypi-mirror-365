...
class DtoGenericResponseArrayDtoFaultInjectionWithIssuesResp(BaseModel):
    """
    DtoGenericResponseArrayDtoFaultInjectionWithIssuesResp
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[List[DtoFaultInjectionWithIssuesResp]] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [DtoFaultInjectionWithIssuesResp.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
