...
class DtoAuditLogListResponse(BaseModel):
    """
    DtoAuditLogListResponse
    """ # noqa: E501
    items: Optional[List[DtoAuditLogResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [DtoAuditLogResponse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
