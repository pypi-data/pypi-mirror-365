...
class DtoGenericResponseArrayDtoUserResponse(BaseModel):
    """
    DtoGenericResponseArrayDtoUserResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[List[DtoUserResponse]] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [DtoUserResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
