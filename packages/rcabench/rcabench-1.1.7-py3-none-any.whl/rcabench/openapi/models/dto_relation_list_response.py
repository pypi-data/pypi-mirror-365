...
class DtoRelationListResponse(BaseModel):
    """
    DtoRelationListResponse
    """ # noqa: E501
    items: Optional[List[DtoRelationResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [DtoRelationResponse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
