...
class DtoSearchResponseDtoPermissionResponse(BaseModel):
    """
    ...
    items: Optional[List[DtoPermissionResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DtoPermissionResponse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
