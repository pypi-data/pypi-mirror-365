...
class DtoGenericResponseDtoSearchResponseDtoDatasetV2Response(BaseModel):
    ...
    data: Optional[DtoSearchResponseDtoDatasetV2Response] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoSearchResponseDtoDatasetV2Response.from_dict(obj.get("data")) if obj.get("data") is not None else None,
