...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.DatasetsApi(api_client)
...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.DatasetsApi(api_client)
    id = 56 # int | Dataset ID
    manage = rcabench.DtoDatasetV2InjectionManageReq() # DtoDatasetV2InjectionManageReq | Injection management request
...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.DatasetsApi(api_client)
    id = 56 # int | Dataset ID
    manage = rcabench.DtoDatasetV2LabelManageReq() # DtoDatasetV2LabelManageReq | Label management request
...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.DatasetsApi(api_client)
    id = 56 # int | Dataset ID
    dataset = rcabench.DtoDatasetV2UpdateReq() # DtoDatasetV2UpdateReq | Dataset update request
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.DatasetsApi(api_client)
    dataset = rcabench.DtoDatasetV2CreateReq() # DtoDatasetV2CreateReq | Dataset creation request
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.DatasetsApi(api_client)
    search = rcabench.DtoDatasetV2SearchReq() # DtoDatasetV2SearchReq | Search criteria
