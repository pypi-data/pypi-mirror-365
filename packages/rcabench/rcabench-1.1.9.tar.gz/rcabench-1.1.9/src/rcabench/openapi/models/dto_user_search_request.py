...
class DtoUserSearchRequest(BaseModel):
    """
    ...
    last_login_range: Optional[DtoDateRange] = None
    ...
    username_pattern: Optional[StrictStr] = Field(default=None, description="User-specific filter shortcuts")
    __properties: ClassVar[List[str]] = ["created_at", "departments", "email_pattern", "exclude_fields", "filters", "fullname_pattern", "include", "include_fields", "is_active", "keyword", "last_login_range", "page", "project_id", "project_ids", "role_ids", "size", "sort", "status", "updated_at", "user_id", "username_pattern"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_login_range
        if self.last_login_range:
            _dict['last_login_range'] = self.last_login_range.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "email_pattern": obj.get("email_pattern"),
            ...
            "fullname_pattern": obj.get("fullname_pattern"),
            "include": obj.get("include"),
            "include_fields": obj.get("include_fields"),
            "is_active": obj.get("is_active"),
            "keyword": obj.get("keyword"),
            "last_login_range": DtoDateRange.from_dict(obj.get("last_login_range")) if obj.get("last_login_range") is not None else None,
            "page": obj.get("page"),
            ...
            "username_pattern": obj.get("username_pattern")
        })
        return _obj
