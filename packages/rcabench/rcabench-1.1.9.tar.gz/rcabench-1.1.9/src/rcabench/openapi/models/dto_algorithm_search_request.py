...
class DtoAlgorithmSearchRequest(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Algorithm-specific filters")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "exclude_fields", "filters", "image", "include", "include_fields", "is_active", "keyword", "name", "page", "project_id", "size", "sort", "status", "tag", "type", "updated_at", "user_id"]
