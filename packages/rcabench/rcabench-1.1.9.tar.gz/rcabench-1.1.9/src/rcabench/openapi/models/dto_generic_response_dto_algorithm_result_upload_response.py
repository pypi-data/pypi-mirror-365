...
class DtoGenericResponseDtoAlgorithmResultUploadResponse(BaseModel):
    """
    DtoGenericResponseDtoAlgorithmResultUploadResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[DtoAlgorithmResultUploadResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoAlgorithmResultUploadResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
