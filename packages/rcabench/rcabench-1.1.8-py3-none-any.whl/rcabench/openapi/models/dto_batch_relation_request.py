...
class DtoBatchRelationRequest(BaseModel):
    """
    DtoBatchRelationRequest
    """ # noqa: E501
    operations: Annotated[List[DtoRelationOperation], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "operations": [DtoRelationOperation.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
