...
class DtoAdvancedSearchRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created_at", "exclude_fields", "filters", "include", "include_fields", "is_active", "keyword", "page", "project_id", "size", "sort", "status", "updated_at", "user_id"]
