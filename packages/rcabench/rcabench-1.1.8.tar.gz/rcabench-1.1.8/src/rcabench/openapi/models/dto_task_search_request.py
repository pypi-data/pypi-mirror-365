...
class DtoTaskSearchRequest(BaseModel):
    """
    ...
    task_id: Optional[StrictStr] = Field(default=None, description="Task-specific filters")
    task_type: Optional[StrictStr] = None
    trace_id: Optional[StrictStr] = None
    updated_at: Optional[DtoDateRange] = None
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_at", "exclude_fields", "filters", "group_id", "immediate", "include", "include_fields", "is_active", "keyword", "page", "project_id", "size", "sort", "status", "task_id", "task_type", "trace_id", "updated_at", "user_id"]
