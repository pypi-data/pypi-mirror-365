...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.AuthenticationApi(api_client)
    request = rcabench.DtoChangePasswordRequest() # DtoChangePasswordRequest | Password change request
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.AuthenticationApi(api_client)
    request = rcabench.DtoLoginRequest() # DtoLoginRequest | Login credentials
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.AuthenticationApi(api_client)
    request = rcabench.DtoLogoutRequest() # DtoLogoutRequest | Logout request
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.AuthenticationApi(api_client)
    request = rcabench.DtoTokenRefreshRequest() # DtoTokenRefreshRequest | Token refresh request
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.AuthenticationApi(api_client)
    request = rcabench.DtoRegisterRequest() # DtoRegisterRequest | Registration details
