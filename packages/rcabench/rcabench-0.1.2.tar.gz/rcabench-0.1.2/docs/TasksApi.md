...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.TasksApi(api_client)
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.TasksApi(api_client)
    request = rcabench.DtoAdvancedSearchRequest() # DtoAdvancedSearchRequest | Search request with pagination
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.TasksApi(api_client)
    request = rcabench.DtoTaskSearchRequest() # DtoTaskSearchRequest | Task search request
