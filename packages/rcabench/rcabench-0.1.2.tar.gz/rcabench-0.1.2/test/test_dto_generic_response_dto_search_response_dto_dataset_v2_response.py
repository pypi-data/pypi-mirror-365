...
class TestDtoGenericResponseDtoSearchResponseDtoDatasetV2Response(unittest.TestCase):
    """DtoGenericResponseDtoSearchResponseDtoDatasetV2Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DtoGenericResponseDtoSearchResponseDtoDatasetV2Response:
        """Test DtoGenericResponseDtoSearchResponseDtoDatasetV2Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DtoGenericResponseDtoSearchResponseDtoDatasetV2Response`
        """
        model = DtoGenericResponseDtoSearchResponseDtoDatasetV2Response()
        if include_optional:
            return DtoGenericResponseDtoSearchResponseDtoDatasetV2Response(
                code = 56,
                data = rcabench.models.dto/search_response_dto_dataset_v2_response.dto.SearchResponse-dto_DatasetV2Response(
                    applied_filters = [
    ...
    def testDtoGenericResponseDtoSearchResponseDtoDatasetV2Response(self):
        """Test DtoGenericResponseDtoSearchResponseDtoDatasetV2Response"""
