...
class TestDtoDatasetSearchResponse(unittest.TestCase):
    """DtoDatasetSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DtoDatasetSearchResponse:
        """Test DtoDatasetSearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DtoDatasetSearchResponse`
        """
        model = DtoDatasetSearchResponse()
        if include_optional:
            return DtoDatasetSearchResponse(
                items = [
    ...
    def testDtoDatasetSearchResponse(self):
        """Test DtoDatasetSearchResponse"""
