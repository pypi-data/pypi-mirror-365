...
with rcabench.ApiClient(configuration) as api_client:
    ...
    api_instance = rcabench.EvaluationApi(api_client)
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.EvaluationApi(api_client)
    body = rcabench.DtoGroundTruthReq() # DtoGroundTruthReq | Ground truth query request, contains dataset list
...
with rcabench.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = rcabench.EvaluationApi(api_client)
    body = rcabench.DtoRawDataReq() # DtoRawDataReq | Raw data query request, supports three modes: pairs array, (algorithms+datasets) Cartesian product, or execution_ids list
