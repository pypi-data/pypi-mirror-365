...
class DtoGenericResponseArrayDtoFaultInjectionWithIssuesResp(BaseModel):
    ...
    data: Optional[List[DtoFaultInjectionWithIssuesResp]] = Field(default=None, description="泛型类型的数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [DtoFaultInjectionWithIssuesResp.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
