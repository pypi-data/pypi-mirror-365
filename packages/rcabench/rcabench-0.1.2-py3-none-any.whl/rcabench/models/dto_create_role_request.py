...
class DtoCreateRoleRequest(BaseModel):
    """
    ...
    name: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["description", "display_name", "name", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('system', 'custom'):
            raise ValueError("must be one of enum values ('system', 'custom')")
        return value
