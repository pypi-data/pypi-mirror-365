...
class BalanceInquiryRequestAdditionalInfo(BaseModel, BaseSdkModel):
    ...
    """ # noqa: E501
    access_token: Annotated[str, Field(strict=True, max_length=512)] = Field(description="Contains customer token, which has been obtained from binding process, refer to Account Binding & Unbinding documentation ")
