...
def get_secrets(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit secrets to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit secrets to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_secrets_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('materialize:index/getSecrets:GetSecrets', __args__, opts=opts, typ=GetSecretsResult)
