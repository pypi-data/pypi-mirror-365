...
def get_connections(connection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_id: Limit connections to a specific connection ID
    :param builtins.str database_name: Limit connections to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit connections to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_connections_output(connection_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
