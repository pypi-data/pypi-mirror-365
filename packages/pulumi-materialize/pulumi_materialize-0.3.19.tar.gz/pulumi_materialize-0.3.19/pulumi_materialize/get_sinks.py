...
def get_sinks(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit sinks to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit sinks to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_sinks_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('materialize:index/getSinks:GetSinks', __args__, opts=opts, typ=GetSinksResult)
