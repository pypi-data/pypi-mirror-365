...
class ProviderArgs:
    def __init__(__self__, *,
                 base_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_endpoint: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] base_endpoint: The base endpoint for Materialize.
        :param pulumi.Input[builtins.str] cloud_endpoint: The endpoint for the Materialize Cloud API.
        :param pulumi.Input[builtins.str] database: The Materialize database. Can also come from the `MZ_DATABASE` environment variable. Defaults to `materialize`.
        :param pulumi.Input[builtins.str] default_region: The default region if not specified in the resource
        :param pulumi.Input[builtins.str] endpoint: The endpoint for the Materialize API.
        :param pulumi.Input[builtins.str] host: The Materialize host. Can also come from the `MZ_HOST` environment variable.
        :param pulumi.Input[builtins.str] password: Materialize host. Can also come from the `MZ_PASSWORD` environment variable.
        :param pulumi.Input[builtins.int] port: The Materialize SQL port. Can also come from the `MZ_PORT` environment variable.
        :param pulumi.Input[builtins.str] sslmode: For testing purposes, the SSL mode to use.
        :param pulumi.Input[builtins.str] username: The Materialize username. Can also come from the `MZ_USERNAME` environment variable.
        """
    ...
    def base_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def base_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base_endpoint", value)

    @property
    @pulumi.getter(name="cloudEndpoint")
    def cloud_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cloud_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="baseEndpoint")
    def base_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The base endpoint for Materialize.
        """
        return pulumi.get(self, "base_endpoint")
    ...
    @property
    @pulumi.getter(name="cloudEndpoint")
    def cloud_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The endpoint for the Materialize Cloud API.
        """
        return pulumi.get(self, "cloud_endpoint")
    ...
    @property
    @pulumi.getter
    def sslmode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        For testing purposes, the SSL mode to use.
        """
        return pulumi.get(self, "sslmode")
