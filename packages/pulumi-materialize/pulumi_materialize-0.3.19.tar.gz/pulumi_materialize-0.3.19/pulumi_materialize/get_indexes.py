...
def get_indexes(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit indexes to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit indexes to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_indexes_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
