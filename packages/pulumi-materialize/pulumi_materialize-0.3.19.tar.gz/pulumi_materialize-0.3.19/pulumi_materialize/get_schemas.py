...
def get_schemas(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit schemas to a specific database
...
def get_schemas_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('materialize:index/getSchemas:GetSchemas', __args__, opts=opts, typ=GetSchemasResult)
