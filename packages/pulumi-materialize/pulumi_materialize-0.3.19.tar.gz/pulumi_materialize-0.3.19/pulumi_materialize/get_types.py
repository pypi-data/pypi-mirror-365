...
def get_types(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit types to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit types to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_types_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('materialize:index/getTypes:GetTypes', __args__, opts=opts, typ=GetTypesResult)
