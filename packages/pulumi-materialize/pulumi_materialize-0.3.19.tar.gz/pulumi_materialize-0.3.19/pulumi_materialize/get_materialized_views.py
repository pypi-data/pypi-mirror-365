...
def get_materialized_views(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: Limit materialized views to a specific database
    :param builtins.str region: The region in which the resource is located.
    :param builtins.str schema_name: Limit materialized views to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_materialized_views_output(database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
