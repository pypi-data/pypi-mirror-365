...
def get_system_parameters(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the specific system parameter to fetch.
...
def get_system_parameters_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
