...
class Corporation(models.Model):
    ...
    def get_member_from_alliance_date_range(self):
        ...
        for i, record in enumerate(sorted_records):
            ...
            if alliance_id == MILALLIANCETAXES_ALLIANCE_ID:
        ...
        print(f"The Corporation {self.corporation_id} was a member of the alliance from {membership_range['start']} to {membership_range['end']}")
