...
class FlowscaleAPI:
    ...
    def execute_workflow_async(
        ...
        # Get the run_id and workflow_id from the response
        ...
        if "workflow_id" not in response_data:
            raise Exception("No workflow_id in execution response")

        run_id = response_data["run_id"]
        workflow_id_from_response = response_data["workflow_id"]
