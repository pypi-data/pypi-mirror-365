...
T = TypeVar("T", bound="JobSamplingRescanResult")


@_attrs_define
class JobSamplingRescanResult:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_sampling_rescan_result = cls(
            job_type=job_type,
        )

        job_sampling_rescan_result.additional_properties = d
        return job_sampling_rescan_result
