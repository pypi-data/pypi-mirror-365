...
class Footer():
    ...
    def read(self, reader: Reader):
        ...
        print(f"Footer: magic={magic}, version={version}, index_offset={self.index_offset}, index_size={self.index_size}")
        self.hash = reader.sha1()
        self.is_frozen = reader.uint() == 1 if self.version >= PakVersion.V9 else False
