...
`unpage tools` subcommands, which will invoke tools directly from the command
line.
...
```bash
$ uv run unpage tools call shell_list_files_in_directory /Users/michael/Downloads
total 0
