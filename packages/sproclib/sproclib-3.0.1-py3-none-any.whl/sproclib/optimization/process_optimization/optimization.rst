...
.. currentmodule:: sproclib.optimization.process_optimization

.. autoclass:: ProcessOptimization
   :members:
   :undoc-members:
   :show-inheritance:
...
.. math::
   ...
   \\text{minimize: } f(x) = \\text{Capital\\_Cost}(x) + \\text{PV}(\\text{Operating\\_Cost}(x))
...
* :math:`x`: Design variables (temperatures, pressures, sizes, compositions)
* :math:`\\text{Capital\\_Cost}(x)`: Equipment and installation costs
* :math:`\\text{Operating\\_Cost}(x)`: Utilities, maintenance, and raw materials
* :math:`\\text{PV}()`: Present value calculation over project lifetime
...
.. math::
   ...
   \\text{Cost} = \\text{Base\\_Cost} \\times \\left(\\frac{\\text{Size}}{\\text{Base\\_Size}}\\right)^{\\text{scaling\\_factor}}
...
.. automethod:: ProcessOptimization.__init__
.. automethod:: ProcessOptimization.optimize
.. automethod:: ProcessOptimization.describe
.. automethod:: ProcessOptimization.multi_objective_optimize
.. automethod:: ProcessOptimization.robust_optimize
.. automethod:: ProcessOptimization.set_algorithm
.. automethod:: ProcessOptimization.set_tolerances
...
* :doc:`../economic_optimization/economic_optimization`
