...
def load_data(
    ...
    adata = sc_adata.concatenate(st_adata, batch_key="batch")
    sc.pp.filter_genes(adata, min_counts=3)  # 过滤低表达基因
    ...
    batch1_mask = (batch_info == '0')
    batch2_mask = (batch_info == '1')
    corrected_batch1 = corrected[batch1_mask, :]  
    corrected_batch2 = corrected[batch2_mask, :]

    cell_ids = sc_adata.obs_names  # (n_cells,) 
    ...
    sc_adata2 = ad.AnnData(corrected_sc)
    sc_adata2.obs = sc_meta

    st_adata2 = ad.AnnData(corrected_st)
