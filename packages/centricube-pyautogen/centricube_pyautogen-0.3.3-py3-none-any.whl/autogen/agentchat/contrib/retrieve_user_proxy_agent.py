...
class RetrieveUserProxyAgent(UserProxyAgent):
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            retrieve_config (dict or None): config for the retrieve agent.
                ...
                - collection_name (Optional, str): the name of the collection.
                    If key not provided, a default name `centricube-pyautogen-docs` will be used.
                ...
                - custom_text_split_function(Optional, Callable): a custom function to split a string into a list of strings.
                    Default is None, will use the default function in `centricube-pyautogen.retrieve_utils.split_text_to_chunks`.
        ...
        self._collection_name = self._retrieve_config.get("collection_name", "centricube-pyautogen-docs")
