...
import { JSONLDValidator } from '../jsonld-validator.js';
...
export class ModuleFactory {
  ...
  static createModules(viewer) {
    ...
    modules.jsonldValidator = new JSONLDValidator();
    ...
    modules.exportManager = new ExportManager(modules.jsonRenderer, modules.stateManager, modules.referenceManager);
    ...
    // Set up progress callback for enhanced link substitution
    modules.enhancedLinkSubstitution.setProgressCallback((progressInfo) => {
      modules.uiManager.showLoading(true, progressInfo);
    });
