...
from calita.model_client import ModelClientFactory, ModelClient
from calita.mcp_config_loader import load_mcp_servers_config
...
class ResearchAgent:
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.mcp_servers_config: Dict[str, Any] = load_mcp_servers_config("mcp_search_servers.json")
