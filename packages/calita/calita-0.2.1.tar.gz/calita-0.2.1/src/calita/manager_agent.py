...
from calita.code_runner_e2b import CodeRunnerSandbox
...
class ManagerAgent:
    ...
    def orchestrate(self, task: str) -> str:
        ...
        while iteration < self.max_iterations:
            ...
            generate_code: Dict[str, str] = self.script_generator.generate_script(spec, resources)
            ...
            if status:
                ...
                self.mcp_registry.register_mcp_tool(function_name, script, requirements)
                final_output = output
