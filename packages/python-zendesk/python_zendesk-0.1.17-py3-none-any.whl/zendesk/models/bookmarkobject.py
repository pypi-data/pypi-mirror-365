...
BookmarkObjectPriority = Literal["urgent", "high", "normal", "low"]
r"""The urgency with which the ticket should be addressed"""

BookmarkObjectStatus = Literal["new", "open", "pending", "hold", "solved", "closed"]
...
BookmarkObjectType = Literal["problem", "incident", "question", "task"]
