...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_init(api, mock_vector_data, mock_feature_data, geom_type):
    """Test initialization of Feature object for different geometry types"""
    layer = VectorLayer(api, uuid=mock_vector_data['uuid'], layer_type=LayerType(geom_type), data=mock_vector_data)
    feature_data = mock_feature_data[geom_type]
    feature = Feature(layer, srid=3857, data=mock_feature_data[geom_type])
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_repr(api, mock_vector_data, mock_feature_data, geom_type):
    """Test the repr method of Feature object for different geometry types"""
    layer = VectorLayer(api, uuid=mock_vector_data['uuid'], layer_type=LayerType(geom_type), data=mock_vector_data)
    feature_data = mock_feature_data[geom_type]
    feature = Feature(layer, srid=3857, data=mock_feature_data[geom_type])
    assert repr(feature) == f"Feature(id={mock_feature_data[geom_type]['id']}, type={FeatureType(geom_type)})"


@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_dir(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_getattr(api, mock_vector_data, mock_feature_data, geom_type):
    ...
    assert feature.srid == 3857
    assert feature.feature_type == FeatureType(geom_type)
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_save(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_save_srid(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_delete(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_update(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_create_feature(api, mock_vector_data, mock_feature_data, geom_type):
    ...
    expected_request = {
        ...
        'properties': {'name': f'test_{geom_type.lower()}'}
    }
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_get_feature(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_geometry(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_set_geometry_with_error_cases(api, mock_vector_data, mock_feature_data, geom_type):
    ...
    if geom_type != "Point":  # Only test if current type is not Point
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_set_geometry_success(api, mock_vector_data, mock_feature_data, geom_type):
    ...
    assert new_geometry.geom_type == layer.layer_type.value
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_srid(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_properties(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_feature_type(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_coordinates(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_length(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_area(api, mock_vector_data, mock_feature_data, geom_type):
...
@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_transform_all_types(api, mock_vector_data, mock_feature_data, geom_type):
    ...
    if geom_type == "Point":
        ...
        assert transformed_geom.equals_exact(shape({'type': geom_type, 'coordinates': manual_transformed_coords}), 1e-7)


@pytest.mark.parametrize("geom_type", ["Point", "LineString", "Polygon", "MultiPoint", "MultiLineString", "MultiPolygon"])
def test_transform_missing_data(api, mock_vector_data, mock_feature_data, geom_type):
