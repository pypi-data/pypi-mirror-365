...
class MultiProfileBiddingStrategy(SatelliteModel):
        ...
        **kwargs,
        ...
        -----
            ...
            ceiling_price: Maximum price to bid at, at which demand will always
                be satisfied.
            electricity_price_forecast: Dataframe containing the electricity
                price forecast based on which multiple forecast scenarios will
                be generated by adjusting with the `forecast_scaling_factor`.
            carrier_prices: Dataframe containing price timeseries for any energy
        ...
        self.base_forecast = electricity_price_forecast
        ...
        validate_prosumer(self.cronian_config, demands)
    ...
    def determine_bids(self) -> pd.DataFrame:
        ...
        Returns:
        --------
            bids: A collection of bids covering the current bidding window.
        """
    ...
    def make_forecast_scenarios(base_forecast: pd.DataFrame, forecast_scaling_factor: float) -> dict[str, pd.DataFrame]:
        ...
        Returns:
        --------
            forecast_scenarios: Electricity price forecast scenarios.
    ...
    def _determine_profiles(self, forecast_scenarios: dict[str, pd.DataFrame]) -> dict[str, list[float]]:
        ...
        Returns:
        --------
            power_profiles: Optimized electric power profile for each scenario.
    ...
    def _determine_profile(self, forecast: pd.DataFrame) -> list[float]:
        ...
        Returns:
        --------
            power_profile: Optimized electricity power profile for the given forecast price.
        """
    ...
    def _make_bids(self, profiles: dict[str, list[float]]) -> pd.DataFrame:
        ...
        Returns:
        --------
            bids: pd.DataFrame table of the constructed bids.
        """
        bidding_window = self._get_horizon(length=24)
        bid_tuples = []
    ...
    def _add_cost_objective(self, model):
        ...
        Returns:
        --------
            model: The given model object, now with `cost_objective` added.
        """
