...
class SshKey(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the SSH key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/ssh_key#name SshKey#name}
        :param key: The text of the SSH private key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/ssh_key#key SshKey#key}
        :param key_wo: The text of the SSH private key, guaranteed not to be written to state. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/ssh_key#key_wo SshKey#key_wo}
        :param organization: The name of the organization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/ssh_key#organization SshKey#organization}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/ssh_key#import import section} in the documentation of this resource for the id to use
