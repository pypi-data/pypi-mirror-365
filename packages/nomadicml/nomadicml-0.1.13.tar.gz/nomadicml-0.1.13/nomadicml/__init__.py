...
__version__ = "0.1.13"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "4233932"      # This will hold the commit hash or full build string, populated by CI
