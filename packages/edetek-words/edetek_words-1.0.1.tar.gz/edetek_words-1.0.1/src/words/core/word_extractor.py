...
from src.words.common.docx_utils import get_bold_semantic_texts
from src.words.common.json_utils import save_json
from src.words.common.path import output_doc_path
from src.words.common.word_cleaner import clean_data
from src.words.dto.segment_dto import SegmentDTO
from src.words.dto.styled_text_segment import StyledTextSegment, FontStyle
