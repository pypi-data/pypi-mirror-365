...
from src.edetek_words.common.constant import EN_US
from src.edetek_words.common.json_utils import save_json
from src.edetek_words.common.path import docs_path, output_doc_path
from src.edetek_words.common.read_file import connect_to
from src.edetek_words.common.translate_util import translate_multi_text, extraction_semantic
from src.edetek_words.dto.segment_dto import SegmentDTO
from src.edetek_words.dto.styled_text_segment import StyledTextSegment
from src.edetek_words.dto.translation_package import TranslationPackage, ContentItem
    ...
    if len(original_texts) == len(translated_list):
        ...
        for idx in range(len(original_texts)):
            ...
            if package and package.contents:
                ...
                if content and not content.needAI:
