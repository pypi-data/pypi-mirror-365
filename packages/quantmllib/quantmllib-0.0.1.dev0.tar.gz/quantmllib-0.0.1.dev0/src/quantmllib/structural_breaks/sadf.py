...
from quantmllib.util.multiprocess import mp_pandas_obj
...
def _get_y_x(series: pd.Series, model: str, lags: int | list,
...
def _lag_df(df: pd.DataFrame, lags: int | list) -> pd.DataFrame:
    """
...
def get_sadf(series: pd.Series, model: str, lags: int | list, min_length: int, add_const: bool = False,
