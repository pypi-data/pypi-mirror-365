...
from quantmllib.data_structures.base_bars import BaseBars
...
class StandardBars(BaseBars):
    ...
    def _extract_bars(self, data: list | tuple | np.ndarray) -> list:
        """
...
def get_dollar_bars(file_path_or_df: str | Iterable[str] | pd.DataFrame, threshold: float | pd.Series = 70000000,
                    batch_size: int = 20000000, verbose: bool = True, to_csv: bool = False, output_path: str | None = None):
    """
...
def get_volume_bars(file_path_or_df: str | Iterable[str] | pd.DataFrame, threshold: float | pd.Series = 70000000,
                    batch_size: int = 20000000, verbose: bool = True, to_csv: bool = False, output_path: str | None = None):
    """
...
def get_tick_bars(file_path_or_df: str | Iterable[str] | pd.DataFrame, threshold: float | pd.Series = 70000000,
                  batch_size: int = 20000000, verbose: bool = True, to_csv: bool = False, output_path: str | None = None):
    """
