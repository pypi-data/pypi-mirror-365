...
from quantmllib.clustering.hierarchical_clustering import optimal_hierarchical_cluster
from quantmllib.codependence import get_dependence_matrix
...
def plot_time_series_dependencies(time_series, dependence_method="gnpr_distance", **kwargs):
    ...
    axis.set_title(f"Dependence Matrix using {dependence_method} Metric")
