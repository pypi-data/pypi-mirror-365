...
from quantmllib.cointegration_approach.base import CointegratedPortfolio
...
class EngleGrangerPortfolio(CointegratedPortfolio):
    ...
    def get_ols_hedge_ratio(price_data: pd.DataFrame, dependent_variable: str, add_constant: bool = False) -> \
        ...
        hedge_ratios_dict = dict(zip([dependent_variable] + exogenous_variables, np.insert(hedge_ratios, 0, 1.0), strict=False))
