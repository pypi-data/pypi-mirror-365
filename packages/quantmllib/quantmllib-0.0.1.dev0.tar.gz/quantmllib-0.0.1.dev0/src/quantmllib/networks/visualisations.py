...
from quantmllib.codependence import get_distance_matrix
...
def generate_mst_server(log_returns_df, mst_algorithm="kruskal", distance_matrix_type="angular", colours=None,
                        sizes=None):
    """
...
def create_input_matrix(log_returns_df, distance_matrix_type):
    ...
    correlation_matrix = log_returns_df.corr(method="pearson", numeric_only=True)
...
def generate_almst_server(log_returns_df, distance_matrix_type="angular", colours=None, sizes=None):
    """
    This method returns a Dash server ready to be run.
...
def generate_mst_almst_comparison(log_returns_df, distance_matrix_type="angular"):
    """
    This method returns a Dash server ready to be run.
...
def generate_pmfg_server(log_returns_df, input_type="distance", colours=None, sizes=None):
    """
