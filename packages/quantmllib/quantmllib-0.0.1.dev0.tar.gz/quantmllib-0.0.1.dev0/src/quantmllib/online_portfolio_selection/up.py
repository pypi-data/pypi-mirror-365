...
from quantmllib.online_portfolio_selection.base import OLPS
from quantmllib.online_portfolio_selection.crp import CRP
...
class UP(OLPS):
    ...
    def _print_progress(self, iteration, prefix="", suffix="", decimals=1, bar_length=50):
        ...
        # Print new line.
        sys.stdout.write("\r{} |{}| {}{} {}".format(prefix, block, percents, "%", suffix)),
