...
class TimeBars(BaseBars):
    ...
    def __init__(self, resolution: str, num_units: int, batch_size: int = 20000000):
        ...
        assert resolution in self.time_bar_thresh_mapping, f"{resolution} resolution is not implemented"
...
def get_time_bars(file_path_or_df: str | Iterable[str] | pd.DataFrame, resolution: str = "D", num_units: int = 1, batch_size: int = 20000000,
