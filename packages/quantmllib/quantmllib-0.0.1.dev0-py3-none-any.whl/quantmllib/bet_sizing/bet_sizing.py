...
from quantmllib.bet_sizing.ch10_snippets import (
    avg_active_signals,
    bet_size,
    discrete_signal,
    get_signal,
...
from quantmllib.bet_sizing.ef3m import M2N, most_likely_parameters, raw_moment
...
def bet_size_reserve(events_t1, sides, fit_runs=100, epsilon=1e-5, factor=5, variant=2, max_iter=10_000,
    ...
    Note that this function creates a <quantmllib.bet_sizing.ef3m.M2N> object and makes use of the parallel fitting
    functionality. As such, this function accepts and passes fitting parameters to the
    quantmllib.bet_sizing.ef3m.M2N.mp_fit() method.
