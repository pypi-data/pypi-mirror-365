...
async def drift(
    ...
    github_repo_name: Annotated[
        str | None, typer.Option(help="GitHub repo name (owner/repo)")
    ] = None,
    ...
    backend_dir: Annotated[
        str | None,
        typer.Option(
            help="The directory where the backend is located. This should be a relative path from the source directory."
        ),
    ] = None,
