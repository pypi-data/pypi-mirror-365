...
from snakestack.pubsub import constants


class PubSubPublisherFactory:

    def create(
        self: "PubSubPublisherFactory",
    ...
    def low_latency(self: "PubSubPublisherFactory") -> PublisherClient:
        """
    ...
    def high_throughput(self: "PubSubPublisherFactory") -> PublisherClient:
        """
    ...
    def balanced(self: "PubSubPublisherFactory") -> PublisherClient:
        """
    ...
    def aggressive(self: "PubSubPublisherFactory") -> PublisherClient:
        """
