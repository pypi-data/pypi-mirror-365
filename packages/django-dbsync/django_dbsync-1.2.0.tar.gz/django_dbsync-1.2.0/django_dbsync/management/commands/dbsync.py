        ...
        try:
            ...
            if options['list_views']:
                ...
                try:
                    ...
                    self.stdout.write(f"{Fore.RED}❌ Error listing views: {e}{Style.RESET_ALL}")
            ...
            if options['report_views']:
                ...
                try:
                    ...
                    self.stdout.write(f"{Fore.RED}❌ Error generating views report: {e}{Style.RESET_ALL}")
            ...
            # Handle orphaned table dropping if requested
            if options['drop_orphaned']:
                ...
                # If only dropping orphaned tables, don't run full sync
                if not any([
                    options['exclude_apps'], options['include_apps'], 
                    options['exclude_table_patterns'], options['exclude_app_patterns'],
                    ...
                    # Run full synchronization after dropping orphaned tables
