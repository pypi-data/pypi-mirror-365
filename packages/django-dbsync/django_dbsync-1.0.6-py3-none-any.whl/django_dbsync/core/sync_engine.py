        ...
        try:
            ...
            if any(phrase in error_message for phrase in [
                ...
                friendly_error = f"""
                    ...
                    {Fore.GREEN}{col_name} = models.CharField(max_length=100, default=''){Style.RESET_ALL}
                    {Fore.GREEN}# or{Style.RESET_ALL}
                    ...
                    {Fore.CYAN}Option 3:{Style.RESET_ALL} Use Django migrations instead:
                    {Fore.GREEN}python manage.py makemigrations{Style.RESET_ALL}
                    {Fore.GREEN}python manage.py migrate{Style.RESET_ALL}
