...
def get_path_size(path: str, *, string: bool = True, visited = None) -> Union[str, int]:
    if not os.path.exists(path):
        return 'Not Found' if string else 0
            ...
            with os.scandir(path) as it:
                for entry in it:
                    ...
                    if entry.is_file(follow_symlinks=False):
                        ...
                        total += get_path_size(entry.path, string=False, visited=visited)
