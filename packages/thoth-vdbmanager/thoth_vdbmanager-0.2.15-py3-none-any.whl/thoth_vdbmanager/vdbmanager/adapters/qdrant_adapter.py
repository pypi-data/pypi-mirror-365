...
class QdrantAdapter(HaystackVectorStoreAdapter):
    ...
    def ensure_collection_exists(self) -> None:
        ...
        try:
            # Get the Qdrant client from the document store
            ...
            try:
                ...
                logger.info(f"Successfully created collection '{self.collection_name}' with {self.embedding_dim}-dimensional vectors and Cosine distance")
