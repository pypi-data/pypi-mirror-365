...
* [list](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/awscredentials/README.md#list) - List all AWS Credentials
* [create](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/awscredentials/README.md#create) - Create an AWS Credential
* [get](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/awscredentials/README.md#get) - Retrieve an AWS Credential
...
### [machine_tokens](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/machinetokens/README.md)

* [create](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/machinetokens/README.md#create) - Create a machine token
...
### [management](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/management/README.md)

* [upsert_user](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/management/README.md#upsert_user) - Upsert a user
* [create_organization](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/management/README.md#create_organization) - Create an organization
* [create_application](https://github.com/clerk/clerk-sdk-python/blob/master/docs/sdks/management/README.md#create_application) - Create an application (instance)
