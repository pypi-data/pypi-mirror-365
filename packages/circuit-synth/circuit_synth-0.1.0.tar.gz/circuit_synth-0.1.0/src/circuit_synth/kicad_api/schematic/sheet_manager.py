...
from ..core.types import (
    Schematic, Sheet, SheetPin, Point, BoundingBox,
    SchematicSymbol
)
...
class SheetManager:
    ...
    def add_sheet(self, name: str, filename: str, 
                  position: Tuple[float, float],
                  size: Tuple[float, float]) -> Sheet:
        """
    ...
    def add_sheet_pin(self, sheet_uuid: str, name: str, 
                      pin_type: str, side: str) -> Optional[SheetPin]:
        """
    ...
    def create_sheet_from_components(self, components: List[SchematicSymbol],
                                   name: str, filename: Optional[str] = None) -> Sheet:
        """
        ...
        self._parser.write_file(
            self._parser.from_schematic(sheet_schematic),
            sheet_path
        )
    ...
    def _calculate_sheet_size(self, components: List[SchematicSymbol]) -> Tuple[float, float]:
    ...
    def _find_circular_references(self, hierarchy: Dict[str, List[str]]) -> List[List[str]]:
