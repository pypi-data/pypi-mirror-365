...
from ..core.types import Wire, Junction, Point, Schematic
from .connection_utils import points_equal, get_wire_segments, segment_intersection
...
class JunctionManager:
    ...
    def update_junctions(self):
        ...
        logger.info(f"Updated junctions: {len(junction_points)} total, "
