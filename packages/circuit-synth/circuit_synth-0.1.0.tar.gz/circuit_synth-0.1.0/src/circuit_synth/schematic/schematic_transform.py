...
from ..core.types import SchematicSymbol as Component, Wire, Point, Junction, Text, Label
from dataclasses import dataclass
...
class SchematicTransform:
    ...
    def transform_component(self, component: Component, transform: Optional[TransformMatrix] = None):
    ...
    def transform_junction(self, junction: Junction, transform: Optional[TransformMatrix] = None):
    ...
    def transform_label(self, label: Label, transform: Optional[TransformMatrix] = None):
    ...
    def rotate_elements(self, elements: List[Any], angle_degrees: float, 
        ...
        cx, cy = center
        transform = (TransformMatrix.translation(-cx, -cy)
    ...
    def mirror_elements(self, elements: List[Any], axis: str = 'x',
                       center: Optional[Tuple[float, float]] = None):
    ...
    def scale_elements(self, elements: List[Any], scale_x: float, scale_y: float,
                      center: Optional[Tuple[float, float]] = None):
    ...
    def align_elements(self, elements: List[Any], alignment: str = 'left',
    ...
    def distribute_elements(self, elements: List[Any], direction: str = 'horizontal',
                          spacing: Optional[float] = None):
    ...
    def auto_arrange(self, components: List[Component], 
