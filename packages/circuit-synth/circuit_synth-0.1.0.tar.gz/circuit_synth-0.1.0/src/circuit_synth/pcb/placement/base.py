...
class ComponentWrapper:
    ...
    def original_bbox(self) -> BoundingBox:
        ...
        if not hasattr(self, '_original_bbox_cache') or self._original_bbox_cache is None:
            self._calculate_bbox()
    ...
    def _calculate_bbox(self):
        ...
        try:
            courtyard_polygon = self._courtyard_detector.get_courtyard_polygon(self.footprint)
            ...
            logger.warning(f"Falling back to calculated bounding box for {self.footprint.reference}: {e}")
