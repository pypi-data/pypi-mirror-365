...
class FreeroutingRunner:
    ...
    def route(self, dsn_file: str, output_file: Optional[str] = None) -> Tuple[bool, str]:
        """
        ...
        cmd = [
            ...
            "-de", dsn_file,  # Input DSN
            "-do", output_file,  # Output SES
            "-mp", str(self.config.optimization_passes),  # Max passes
        ]
            ...
            while self._process.poll() is None:
                if self.config.timeout_seconds:
                    ...
                    if elapsed > self.config.timeout_seconds:
                        ...
                        self.stop()
                        return False, f"Timeout after {self.config.timeout_seconds} seconds"
