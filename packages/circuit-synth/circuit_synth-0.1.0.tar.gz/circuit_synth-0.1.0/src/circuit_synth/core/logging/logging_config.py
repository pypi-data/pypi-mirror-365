...
class LoggingConfig:
    ...
    def __init__(self):
        ...
        self.max_log_size = int(os.getenv("CIRCUIT_SYNTH_MAX_LOG_SIZE", str(self.DEFAULT_MAX_LOG_SIZE)))
        self.backup_count = int(os.getenv("CIRCUIT_SYNTH_BACKUP_COUNT", str(self.DEFAULT_BACKUP_COUNT)))
        self.log_format = os.getenv("CIRCUIT_SYNTH_LOG_FORMAT", self.DEFAULT_LOG_FORMAT)
        self.date_format = os.getenv("CIRCUIT_SYNTH_DATE_FORMAT", self.DEFAULT_DATE_FORMAT)
    ...
    def _get_log_level(self) -> str:
        ...
        if level not in valid_levels:
            print(f"Warning: Invalid LOG_LEVEL '{level}'. Using default '{self.DEFAULT_LOG_LEVEL}'")
    ...
    def get_file_handler(self, log_path: Path, level: Optional[int] = None) -> logging.FileHandler:
        """
