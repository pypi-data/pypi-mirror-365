...
class DatabaseLogger(CircuitSynthLogger):
    ...
    def log_llm_request(self, model: str, prompt_tokens: int, max_tokens: int, 
        ...
        super().log_llm_request(model, prompt_tokens, max_tokens, 
                              temperature, request_id, prompt_preview)
    ...
    def log_llm_response(self, model: str, request_id: str, completion_tokens: int,
        ...
        super().log_llm_response(model, request_id, completion_tokens,
...
class DatabaseLoggerFactory:
    ...
    @classmethod
    def get_logger(cls, username: str, session_id: Optional[str] = None,
                   db_path: Optional[Path] = None) -> DatabaseLogger:
        """
