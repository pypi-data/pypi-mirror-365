...
class DashboardLogger(CircuitSynthLogger):
    ...
    def log_callback_start(self, callback_id: str, inputs: Dict[str, Any], 
                          state: Dict[str, Any], triggered_by: str):
    ...
    def log_callback_end(self, callback_id: str, outputs: Dict[str, Any], 
    ...
    def log_user_interaction(self, component_id: str, action: str, 
    ...
    def log_page_navigation(self, from_page: str, to_page: str, 
...
class LLMLogger(CircuitSynthLogger):
    ...
    def log_request(self, request_id: str, model: str, provider: str,
    ...
    def log_conversation_turn(self, turn_number: int, role: str, 
...
class FileOperationLogger(CircuitSynthLogger):
    ...
    def log_file_read(self, file_path: str, file_size: int, 
                     purpose: str, success: bool = True, error: Optional[str] = None):
    ...
    def log_file_write(self, file_path: str, file_size: int, 
                      file_type: str, purpose: str, 
    ...
    def log_file_delete(self, file_path: str, reason: str, 
                       success: bool = True, error: Optional[str] = None):
        """Log a file deletion."""
        self.log_event(
            'file_delete',
    ...
    def log_circuit_generation_start(self, generation_id: str, 
                                   circuit_type: str, parameters: Dict[str, Any]):
    ...
    def log_circuit_generation_complete(self, generation_id: str, 
                                      output_files: List[str], 
                                      success: bool = True, error: Optional[str] = None):
        """Log the completion of circuit generation."""
        duration_ms = 0
        if generation_id in self.operation_timers:
            duration_ms = (time.time() - self.operation_timers.pop(generation_id)) * 1000
    ...
    def log_kicad_operation(self, operation: str, file_path: str, 
    ...
    def log_file_upload(self, file_name: str, file_size: int, 
                       file_type: str, source: str):
    ...
    def log_file_download(self, file_path: str, file_size: int, 
                         destination: str):
...
class PerformanceLogger(CircuitSynthLogger):
    ...
    def log_memory_usage(self, process: str, memory_mb: float, 
    ...
    def log_cpu_usage(self, process: str, cpu_percent: float, 
    ...
    def log_api_latency(self, endpoint: str, method: str, 
    ...
    def end_operation_timer(self, operation_id: str, operation_name: str,
                          metadata: Optional[Dict[str, Any]] = None):
