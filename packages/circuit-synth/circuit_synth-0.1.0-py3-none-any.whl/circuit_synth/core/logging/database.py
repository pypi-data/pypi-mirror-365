...
class LogDatabase:
    ...
    def update_user_session(self, session_id: str, end_time: Optional[datetime] = None,
    ...
    def create_chat_session(self, chat_id: str, session_id: str, 
    ...
    def update_chat_session(self, chat_id: str, end_time: Optional[datetime] = None,
    ...
    def add_event_to_index(self, timestamp: str, session_id: str, event_type: str,
                         log_file: str, line_number: int, chat_id: Optional[str] = None,
    ...
    def add_performance_metric(self, session_id: str, metric_type: str, 
    ...
    def add_llm_usage(self, request_id: str, session_id: str, model: str,
                     provider: str, chat_id: Optional[str] = None,
    ...
    def update_llm_usage(self, request_id: str,
                        completion_tokens: Optional[int] = None,
                        total_tokens: Optional[int] = None,
                        cost_usd: Optional[float] = None,
                        duration_ms: Optional[float] = None,
