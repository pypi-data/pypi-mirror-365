...
class KiCadCLI:
    ...
    def run_command(self, args: List[str], cwd: Optional[Union[str, Path]] = None,
        ...
        try:
            ...
            raise KiCadCLINotFoundError(f"kicad-cli not found at: {self.kicad_cli_path}")
    ...
    def run_drc(self, pcb_file: Union[str, Path], output_file: Optional[Union[str, Path]] = None,
                units: str = "mm", severity: str = "error", format: str = "json",
                custom_rules_file: Optional[Union[str, Path]] = None) -> DRCResult:
        """
    ...
    def export_gerbers(self, pcb_file: Union[str, Path], output_dir: Union[str, Path],
                      layers: Optional[List[str]] = None, protel_extensions: bool = False) -> List[Path]:
        """
    ...
    def export_drill(self, pcb_file: Union[str, Path], output_dir: Union[str, Path],
                    format: str = "excellon", units: str = "mm",
                    mirror_y: bool = False, minimal_header: bool = False) -> Tuple[Optional[Path], Optional[Path]]:
        """
    ...
    def export_pos(self, pcb_file: Union[str, Path], output_file: Union[str, Path],
                  side: str = "both", format: str = "csv", units: str = "mm",
                  use_drill_origin: bool = False, smd_only: bool = False) -> Path:
        """
    ...
    def export_svg(self, pcb_file: Union[str, Path], output_file: Union[str, Path],
                  layers: Optional[List[str]] = None, theme: Optional[str] = None,
                  black_and_white: bool = False, page_size: Optional[str] = None) -> Path:
        """
