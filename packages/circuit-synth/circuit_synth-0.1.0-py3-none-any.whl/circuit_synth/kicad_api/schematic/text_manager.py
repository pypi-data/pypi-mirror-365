...
from ..core.types import Text, Point, Schematic
...
class TextManager:
    ...
    def find_text_at_point(self, point: Tuple[float, float], tolerance: float = 0.1) -> List[Text]:
        """
    ...
    def find_text_by_content(self, pattern: str, exact_match: bool = False) -> List[Text]:
        """
