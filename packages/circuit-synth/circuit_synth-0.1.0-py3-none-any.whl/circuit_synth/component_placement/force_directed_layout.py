...
class ForceDirectedLayout:
    ...
    def _calculate_attractive_force(self, node1: PlacementNode, node2: PlacementNode) -> ForceVector:
    ...
    def _calculate_repulsive_force(self, node1: PlacementNode, node2: PlacementNode) -> ForceVector:
    ...
    def _apply_forces(self) -> float:
        ...
        for i, node1 in enumerate(nodes):
            for node2 in nodes[i+1:]:
                ...
                if node1.component.library == "power" or node2.component.library == "power":
                    continue
    ...
    def layout(self, circuit: 'Circuit', initial_positions: Optional[Dict[str, Tuple[float, float, float]]] = None) -> Dict[str, Tuple[float, float, float]]:
