...
class NetNameGenerator:
    ...
    def generate_net_name(self, net_id: str) -> str:
        ...
        if (net_info.driver_source and 
            net_info.driver_priority >= DriverPriority.HIER_LABEL):
    ...
    def resolve_bus_names(self, net_ids: List[str], bus_name: str) -> Dict[str, str]:
        ...
        for net_id in net_ids:
            net_info = self._net_tracker.get_net_info(net_id)
            if net_info and net_info.driver_source and \
               net_info.driver_priority >= DriverPriority.HIER_LABEL and \
               net_info.driver_priority < DriverPriority.LOCAL_LABEL:
    ...
    def apply_power_net_rules(self, net_id: str) -> str:
        ...
        if net_info.is_power_net:
            ...
            if net_info.driver_priority == DriverPriority.GLOBAL_POWER_PIN and net_info.driver_source:
