...
from .schematic_reader import SchematicSymbol, SchematicNet, SchematicSheet
...
class ChangeSet:
    ...
    modified_components: List[tuple[Component, Dict[str, Any]]] = field(default_factory=list)
...
class SchematicComparer:
    ...
    def __init__(self, original_symbols: Dict[str, SchematicSymbol],
    ...
    def _compare_component_properties(self, 
                                    original: SchematicSymbol,
                                    modified: Component) -> Dict[str, Any]:
        ...
        for net_name, net in circuit._nets.items():
            ...
            if net_name in self.original_nets:
                ...
                if added_nodes or removed_nodes:
                    changes.modified_nets.append((net, {
