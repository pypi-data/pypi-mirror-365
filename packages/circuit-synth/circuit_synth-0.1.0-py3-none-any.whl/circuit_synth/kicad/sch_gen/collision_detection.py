...
class BBox:
    ...
    def intersects(self, other: "BBox") -> bool:
        ...
        """
        overlap = not (self.x_max < other.x_min or
    ...
    def __repr__(self):
        return (f"BBox(x_min={self.x_min}, y_min={self.y_min}, "
...
class CollisionDetector:
    ...
    """
    def __init__(self, min_spacing: float = 2.54, sheet_size: tuple = (210.0, 297.0), sheet_margin: float = 25.4):
        """
        ...
        """
        logger.debug("Initializing CollisionDetector with min_spacing=%.2f, sheet_margin=%.2f",
                    min_spacing, sheet_margin)
    ...
    def _add_sheet_boundaries(self):
        ...
        logger.debug("Added virtual bounding boxes for sheet boundaries with margin=%.2f", margin)
