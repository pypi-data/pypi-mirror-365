...
class BulkOperations:
    ...
    def align_components(
        ...
        if alignment == "horizontal":
            self._align_horizontal(positioned_components, spacing, reference_component, results)
        elif alignment == "vertical":
            self._align_vertical(positioned_components, spacing, reference_component, results)
        elif alignment == "grid":
    ...
    def distribute_evenly(
        ...
        """
        if len(components) < 2:
            return {"success": True, "message": "Need at least 2 components to distribute"}
        ...
        if bounds is None:
            ...
            bounds = (group_bounds.min_x, group_bounds.min_y,
                     group_bounds.max_x, group_bounds.max_y)
