# DOES THAT FILE CONSOLIDATED IN alligator_cli.py ?? or TideAlligatorAnalysis.py ?? - that file is either DEPRECATED or it is an interesting analysis of the potential application of the Tide Alligator for entering on larger timeframe (the tide alligator) pull back)
