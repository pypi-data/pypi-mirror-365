...
class LLMTracer(BaseTracer):
    ...
    async def trace(self, func: Callable, *args, **kwargs) -> Any:
        ...
        try:
            ...
            # Handle SDK mode for different providers
    ...
    async def _handle_anthropic_sdk_mode(
        ...
        try:
            if result is None:
                print("[LANGFUSE] Warning: SDK result is None, skipping tracing")
                return result
    ...
    async def _handle_openai_sdk_mode(
        ...
        try:
            if result is None:
                print("[LANGFUSE] Warning: OpenAI SDK result is None, skipping tracing")
                return result
            ...
            tokens_data = {
                ...
                "total_tokens": sdk_response.usage.total_tokens if sdk_response.usage else 0,
            }
            ...
            if isinstance(user_prompt, list):
                ...
                input_messages.append({"role": "user", "content": user_prompt or ""})
...
class LLMStreamingTracer(BaseTracer):
    ...
    async def _trace_sdk_streaming_mode(self, func: Callable, *args, **kwargs):
        ...
        try:
            ...
            print(f"[LANGFUSE] Error in LLMStreamingTracer SDK streaming mode: {e}")
    ...
    async def _trace_streaming_mode(self, func: Callable, *args, **kwargs):
        ...
        try:
            ...
            print(f"[LANGFUSE] Error in LLMStreamingTracer streaming mode: {e}")
