                ...
                try:
                    ...
                    if extension == '.py':
                        with open(file_path, 'r', encoding='utf-8') as f:
                            ...
                            print(f"First line of downloaded file: {first_line}")
                            if not (first_line.startswith('#') or first_line.startswith('import') or first_line.startswith('from') or first_line.startswith('class') or first_line.startswith('def')):
