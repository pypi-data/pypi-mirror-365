...
setup(
    ...
    description="A framework for building powerful AI agents with intelligent memory management and minimal boilerplate code",
    ...
    keywords="ai, agent, llm, openai, groq, anthropic, huggingface, tools, memory, conversation, context-management, token-aware, intelligent-summarization",
    python_requires=">=3.8",
    install_requires=[
        "openai>=1.0.0",
        "groq>=0.4.0",
