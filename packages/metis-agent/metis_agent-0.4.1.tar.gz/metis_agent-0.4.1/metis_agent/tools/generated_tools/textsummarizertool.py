"""
Called TextSummarizerTool that summarizes text content

This tool was automatically generated by ToolGeneratorTool.
Generated on: 2025-07-29T21:02:58.501286
"""
...
class Textsummarizertool(BaseTool):
    ...
    def __init__(self):
        """Initialize the tool."""
        self.name = "textsummarizertool"
        self.description = "Called TextSummarizerTool that summarizes text content"
    ...
    def can_handle(self, task: str) -> bool:
        ...
        keywords = ["create", "file", "content", "read", "text", "delete", "write", "directory", "summarizes"]
    ...
    def get_examples(self) -> List[str]:
        ...
        return [
            "Example usage: summarizes text content",
        ]
