"""
Analyzes text for sentiment and extracts key information

This tool was automatically generated by ToolGeneratorTool.
Generated on: 2025-07-29T21:00:34.201035
"""
...
class ThatTool(BaseTool):
    """
    Analyzes text for sentiment and extracts key information
    
    Purpose: analyzes text for sentiment and extracts key information
    ...
    def __init__(self):
        """Initialize the tool."""
        self.name = "that_tool"
        self.description = "Analyzes text for sentiment and extracts key information"
    ...
    def can_handle(self, task: str) -> bool:
        ...
        keywords = ["convert", "analyzes", "process", "parse", "extracts", "transform", "information", "sentiment", "format", "text"]
    ...
    def get_examples(self) -> List[str]:
        ...
        return [
            "Example usage: analyzes text for sentiment and extracts key information",
        ]
