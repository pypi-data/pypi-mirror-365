...
class MLPipeline:
    ...
    def evaluate(self, y_true, y_pred, task='regression', verbose=True):
        """
        ...
        Args:
            ...
            task (str, optional): Type of task - 'regression' or 'classification'.
                                Defaults to 'regression'.
            verbose (bool, optional): If True, prints evaluation metrics. Defaults to True.
        ...
        Notes:
            - For regression, the RMSE, MAE, and R² are standard performance indicators.
            - For classification, metrics use weighted averages to handle class imbalance.
            - Ensure that y_true and y_pred correspond to the same samples.
        """
        if task == 'regression':
