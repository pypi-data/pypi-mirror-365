...
Each component repository is cloned into its own subdirectory, maintaining its original structure while being part of the larger HKG project.
...
3. **Component Management** (`components/`):
