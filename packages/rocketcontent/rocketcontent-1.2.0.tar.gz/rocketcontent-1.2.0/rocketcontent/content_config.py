...
class ContentConfig:
    ...
    def __init__(self, yaml_file):
        ...
        self.class_navigator_cache_page_limit = int(content_config.get('class_navigator_cache_page_limit', 200))        
    ...
    def save_config_ori(self, config):
        """
        Saves the updated configuration to a YAML file and generates an MD5 checksum file.
    ...
    def save_config(self, config):
        ...
        key_order = [
            ...
            "class_navigator_cache_page_limit"
        ]
    ...
    def get_current_config(self):
        ...
        content_config["repository"]["class_navigator_cache_page_limit"] = int(self.class_navigator_cache_page_limit)
