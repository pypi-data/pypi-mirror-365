...
#ifndef GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2ftma_5fmetadata_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2ftma_5fmetadata_2eproto_2epb_2eh
...
PROTOBUF_EXPORT extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_xla_2fstream_5fexecutor_2fgpu_2ftma_5fmetadata_2eproto;
...
PROTOBUF_EXPORT bool TmaDescriptorProto_TmaInterleave_IsValid(int value);
PROTOBUF_EXPORT extern const uint32_t TmaDescriptorProto_TmaInterleave_internal_data_[];
constexpr TmaDescriptorProto_TmaInterleave TmaDescriptorProto_TmaInterleave_TmaInterleave_MIN = static_cast<TmaDescriptorProto_TmaInterleave>(0);
constexpr TmaDescriptorProto_TmaInterleave TmaDescriptorProto_TmaInterleave_TmaInterleave_MAX = static_cast<TmaDescriptorProto_TmaInterleave>(2);
constexpr int TmaDescriptorProto_TmaInterleave_TmaInterleave_ARRAYSIZE = 2 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
TmaDescriptorProto_TmaInterleave_descriptor();
template <typename T>
...
inline const std::string& TmaDescriptorProto_TmaInterleave_Name(TmaDescriptorProto_TmaInterleave value) {
  return ::google::protobuf::internal::NameOfDenseEnum<TmaDescriptorProto_TmaInterleave_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool TmaDescriptorProto_TmaInterleave_Parse(absl::string_view name, TmaDescriptorProto_TmaInterleave* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TmaDescriptorProto_TmaInterleave>(
      TmaDescriptorProto_TmaInterleave_descriptor(), name, value);
}
...
PROTOBUF_EXPORT bool TmaDescriptorProto_TmaSwizzle_IsValid(int value);
PROTOBUF_EXPORT extern const uint32_t TmaDescriptorProto_TmaSwizzle_internal_data_[];
constexpr TmaDescriptorProto_TmaSwizzle TmaDescriptorProto_TmaSwizzle_TmaSwizzle_MIN = static_cast<TmaDescriptorProto_TmaSwizzle>(0);
constexpr TmaDescriptorProto_TmaSwizzle TmaDescriptorProto_TmaSwizzle_TmaSwizzle_MAX = static_cast<TmaDescriptorProto_TmaSwizzle>(3);
constexpr int TmaDescriptorProto_TmaSwizzle_TmaSwizzle_ARRAYSIZE = 3 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
TmaDescriptorProto_TmaSwizzle_descriptor();
template <typename T>
...
inline const std::string& TmaDescriptorProto_TmaSwizzle_Name(TmaDescriptorProto_TmaSwizzle value) {
  return ::google::protobuf::internal::NameOfDenseEnum<TmaDescriptorProto_TmaSwizzle_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool TmaDescriptorProto_TmaSwizzle_Parse(absl::string_view name, TmaDescriptorProto_TmaSwizzle* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TmaDescriptorProto_TmaSwizzle>(
      TmaDescriptorProto_TmaSwizzle_descriptor(), name, value);
}
...
PROTOBUF_EXPORT bool TmaDescriptorProto_TmaL2Promotion_IsValid(int value);
PROTOBUF_EXPORT extern const uint32_t TmaDescriptorProto_TmaL2Promotion_internal_data_[];
constexpr TmaDescriptorProto_TmaL2Promotion TmaDescriptorProto_TmaL2Promotion_TmaL2Promotion_MIN = static_cast<TmaDescriptorProto_TmaL2Promotion>(0);
constexpr TmaDescriptorProto_TmaL2Promotion TmaDescriptorProto_TmaL2Promotion_TmaL2Promotion_MAX = static_cast<TmaDescriptorProto_TmaL2Promotion>(3);
constexpr int TmaDescriptorProto_TmaL2Promotion_TmaL2Promotion_ARRAYSIZE = 3 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
TmaDescriptorProto_TmaL2Promotion_descriptor();
template <typename T>
...
inline const std::string& TmaDescriptorProto_TmaL2Promotion_Name(TmaDescriptorProto_TmaL2Promotion value) {
  return ::google::protobuf::internal::NameOfDenseEnum<TmaDescriptorProto_TmaL2Promotion_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool TmaDescriptorProto_TmaL2Promotion_Parse(absl::string_view name, TmaDescriptorProto_TmaL2Promotion* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TmaDescriptorProto_TmaL2Promotion>(
      TmaDescriptorProto_TmaL2Promotion_descriptor(), name, value);
}
...
PROTOBUF_EXPORT bool TmaDescriptorProto_TmaFloatOobFill_IsValid(int value);
PROTOBUF_EXPORT extern const uint32_t TmaDescriptorProto_TmaFloatOobFill_internal_data_[];
constexpr TmaDescriptorProto_TmaFloatOobFill TmaDescriptorProto_TmaFloatOobFill_TmaFloatOobFill_MIN = static_cast<TmaDescriptorProto_TmaFloatOobFill>(0);
constexpr TmaDescriptorProto_TmaFloatOobFill TmaDescriptorProto_TmaFloatOobFill_TmaFloatOobFill_MAX = static_cast<TmaDescriptorProto_TmaFloatOobFill>(1);
constexpr int TmaDescriptorProto_TmaFloatOobFill_TmaFloatOobFill_ARRAYSIZE = 1 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
TmaDescriptorProto_TmaFloatOobFill_descriptor();
template <typename T>
...
inline const std::string& TmaDescriptorProto_TmaFloatOobFill_Name(TmaDescriptorProto_TmaFloatOobFill value) {
  return ::google::protobuf::internal::NameOfDenseEnum<TmaDescriptorProto_TmaFloatOobFill_descriptor,
                                                 0, 1>(
      static_cast<int>(value));
}
inline bool TmaDescriptorProto_TmaFloatOobFill_Parse(absl::string_view name, TmaDescriptorProto_TmaFloatOobFill* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TmaDescriptorProto_TmaFloatOobFill>(
      TmaDescriptorProto_TmaFloatOobFill_descriptor(), name, value);
}
...
/* @@protoc_insertion_point(class_definition:stream_executor.gpu.TmaDescriptorProto) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TmaDescriptorProto(
  ...
  static inline const TmaDescriptorProto* internal_default_instance() {
  ...
  inline void Swap(TmaDescriptorProto* other) {
  ...
  void UnsafeArenaSwap(TmaDescriptorProto* other) {
    if (other == this) return;
  ...
  TmaDescriptorProto* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
  ...
  void SharedDtor();
  void InternalSwap(TmaDescriptorProto* other);
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "stream_executor.gpu.TmaDescriptorProto"; }

 protected:
  explicit TmaDescriptorProto(::google::protobuf::Arena* arena);
  TmaDescriptorProto(::google::protobuf::Arena* arena, const TmaDescriptorProto& from);
  TmaDescriptorProto(::google::protobuf::Arena* arena, TmaDescriptorProto&& from) noexcept
 ...
 public:
  ...
  static inline const ::google::protobuf::EnumDescriptor* TmaInterleave_descriptor() {
  ...
  static inline bool TmaInterleave_Parse(absl::string_view name, TmaInterleave* value) {
  ...
  static inline const ::google::protobuf::EnumDescriptor* TmaSwizzle_descriptor() {
  ...
  static inline bool TmaSwizzle_Parse(absl::string_view name, TmaSwizzle* value) {
  ...
  static inline const ::google::protobuf::EnumDescriptor* TmaL2Promotion_descriptor() {
  ...
  static inline bool TmaL2Promotion_Parse(absl::string_view name, TmaL2Promotion* value) {
  ...
  static inline const ::google::protobuf::EnumDescriptor* TmaFloatOobFill_descriptor() {
  ...
  static inline bool TmaFloatOobFill_Parse(absl::string_view name, TmaFloatOobFill* value) {
  ...
  ::google::protobuf::RepeatedField<::int64_t>* mutable_global_dims();

  private:
  const ::google::protobuf::RepeatedField<::int64_t>& _internal_global_dims() const;
  ::google::protobuf::RepeatedField<::int64_t>* _internal_mutable_global_dims();
  ...
  ::google::protobuf::RepeatedField<::int64_t>* mutable_global_strides();

  private:
  const ::google::protobuf::RepeatedField<::int64_t>& _internal_global_strides() const;
  ::google::protobuf::RepeatedField<::int64_t>* _internal_mutable_global_strides();
  ...
  ::google::protobuf::RepeatedField<::int32_t>* mutable_box_dims();

  private:
  const ::google::protobuf::RepeatedField<::int32_t>& _internal_box_dims() const;
  ::google::protobuf::RepeatedField<::int32_t>* _internal_mutable_box_dims();
  ...
  ::google::protobuf::RepeatedField<::int32_t>* mutable_element_strides();

  private:
  const ::google::protobuf::RepeatedField<::int32_t>& _internal_element_strides() const;
  ::google::protobuf::RepeatedField<::int32_t>* _internal_mutable_element_strides();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::google::protobuf::internal::CachedSize _global_dims_cached_byte_size_;
    ::google::protobuf::RepeatedField<::int64_t> global_strides_;
    mutable ::google::protobuf::internal::CachedSize _global_strides_cached_byte_size_;
    ::google::protobuf::RepeatedField<::int32_t> box_dims_;
    mutable ::google::protobuf::internal::CachedSize _box_dims_cached_byte_size_;
    ::google::protobuf::RepeatedField<::int32_t> element_strides_;
    mutable ::google::protobuf::internal::CachedSize _element_strides_cached_byte_size_;
...
class TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse final
    : public ::google::protobuf::internal::MapEntry<
          TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse, ::int64_t, ::stream_executor::gpu::TmaDescriptorProto,
 ...
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse(
      ::google::protobuf::internal::ConstantInitialized);
  explicit TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse(::google::protobuf::Arena* arena);
  static const TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse* internal_default_instance() {
    return reinterpret_cast<const TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse*>(
        &_TmaMetadataProto_ArgIndexToTmaInfoEntry_DoNotUse_default_instance_);
  }
...
/* @@protoc_insertion_point(class_definition:stream_executor.gpu.TmaMetadataProto) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR TmaMetadataProto(
      ::google::protobuf::internal::ConstantInitialized);
  ...
  static inline const TmaMetadataProto* internal_default_instance() {
  ...
  inline void Swap(TmaMetadataProto* other) {
    if (other == this) return;
#ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr && GetArena() == other->GetArena()) {
#else   // PROTOBUF_FORCE_COPY_IN_SWAP
  ...
  void UnsafeArenaSwap(TmaMetadataProto* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  TmaMetadataProto* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  void SharedDtor();
  void InternalSwap(TmaMetadataProto* other);
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "stream_executor.gpu.TmaMetadataProto"; }

 protected:
  explicit TmaMetadataProto(::google::protobuf::Arena* arena);
  TmaMetadataProto(::google::protobuf::Arena* arena, const TmaMetadataProto& from);
  TmaMetadataProto(::google::protobuf::Arena* arena, TmaMetadataProto&& from) noexcept
 ...
 public:
  ...
  ::google::protobuf::Map<::int64_t, ::stream_executor::gpu::TmaDescriptorProto>* mutable_arg_index_to_tma_info();

  private:
  const ::google::protobuf::Map<::int64_t, ::stream_executor::gpu::TmaDescriptorProto>& _internal_arg_index_to_tma_info() const;
  ::google::protobuf::Map<::int64_t, ::stream_executor::gpu::TmaDescriptorProto>* _internal_mutable_arg_index_to_tma_info();
...
inline ::google::protobuf::RepeatedField<::int64_t>* TmaDescriptorProto::mutable_global_dims()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedField<::int64_t>* TmaDescriptorProto::_internal_mutable_global_dims() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.global_dims_;
}
...
inline ::google::protobuf::RepeatedField<::int64_t>* TmaDescriptorProto::mutable_global_strides()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedField<::int64_t>* TmaDescriptorProto::_internal_mutable_global_strides() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.global_strides_;
}
...
inline ::google::protobuf::RepeatedField<::int32_t>* TmaDescriptorProto::mutable_box_dims()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedField<::int32_t>* TmaDescriptorProto::_internal_mutable_box_dims() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.box_dims_;
}
...
inline ::google::protobuf::RepeatedField<::int32_t>* TmaDescriptorProto::mutable_element_strides()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedField<::int32_t>* TmaDescriptorProto::_internal_mutable_element_strides() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.element_strides_;
}
...
inline ::google::protobuf::Map<::int64_t, ::stream_executor::gpu::TmaDescriptorProto>* TmaMetadataProto::_internal_mutable_arg_index_to_tma_info() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.arg_index_to_tma_info_.MutableMap();
}
inline ::google::protobuf::Map<::int64_t, ::stream_executor::gpu::TmaDescriptorProto>* TmaMetadataProto::mutable_arg_index_to_tma_info() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor<::stream_executor::gpu::TmaDescriptorProto_TmaInterleave>() {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor<::stream_executor::gpu::TmaDescriptorProto_TmaSwizzle>() {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor<::stream_executor::gpu::TmaDescriptorProto_TmaL2Promotion>() {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor<::stream_executor::gpu::TmaDescriptorProto_TmaFloatOobFill>() {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2ftma_5fmetadata_2eproto_2epb_2eh
