...
TEST_DATA = [
    ...
    (
        "--min-date 1999-12-31 --max-date 1999-12-31",
        {"delta": timedelta()},
        [
    ...
    (
        "HEAD~3 --min-date 1999-12-31 --max-date 1999-12-31",
        {"delta": timedelta()},
        [
            ("2000-01-01", "1999-12-31"),
            ("2000-01-01", "1999-12-31"),
    ...
    (
        "root --min-date 1999-12-31 --max-date 1999-12-31",
        {"delta": timedelta()},
        [
            ("2000-01-01", "1999-12-31"),
            ("2000-01-01", "1999-12-31"),
...
def test_base_ref(cmd: str, repo_args: dict[str, Any], expected: list[str]):
