    ...
    def _prepare_index(
        ...
        with debugging.span("prepare_index"):
            ...
            payload = {
                ...
                "caller_engine_size": self.config.get_default_engine_size(),
