...
class OB08(SAP):
    ...
    def _click_entradas_nuevas_elemento(self) -> bool:
        ...
        try:
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//div[@title="Entradas nuevas (F5)"]'):
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//span[contains(text(), "ntradas nuevas")]'):
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//span[contains(text(), "Entradas nuevas")]'):
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//div[contains(@lsdata, "Entradas nuevas")]'):
                self.mostrar("✅ Click exitoso por lsdata")
                return True
            
            # Método 5: Buscar por accesskey="E"
            self.mostrar("🎯 Método 5: Buscando por accesskey")
            if self.click_elemento_en_iframe(By.XPATH, '//div[@accesskey="E"]'):
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//div[@role="button" and contains(., "Entradas nuevas")]'):
            ...
            if self.click_elemento_en_iframe(By.XPATH, '//*[contains(text(), "Entradas nuevas") or contains(@title, "Entradas nuevas")]'):
    ...
    def ingresar_tipo_de_cambio(self, df_divisas: pd.DataFrame) -> bool:
        ...
        Raises:
            SAPNavigationError: Si no se puede acceder al menú 'Entradas nuevas'
        """
        try:
            # Intentar acceder a entradas nuevas - si falla, lanza SAPNavigationError
