...
def get_language_config(language: str) -> Dict[str, Any]:
    ...
    configs = {
        "python": {
            ...
            "min_lines": 3,  # Python functions are often compact
        ...
        "javascript": {
            ...
            "complexity_threshold": 3,
            "min_lines": 2,  # JavaScript utility functions are often small
            "min_function_lines": 2,
        ...
        "java": {
            ...
            "complexity_threshold": 3,
            "min_lines": 5,  # Java methods tend to be more verbose
