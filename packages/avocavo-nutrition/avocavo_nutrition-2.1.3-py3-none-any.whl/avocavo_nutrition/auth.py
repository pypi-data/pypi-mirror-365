...
class AuthManager:
    ...
    def login(self, email: str = None, password: str = None, provider: str = "google", use_supabase: bool = True) -> Dict:
        ...
        # Skip Supabase OAuth due to NULL field scanning issues
        # Use legacy OAuth browser login (more reliable)
        if use_supabase:
            print("🔐 Using legacy OAuth authentication (Supabase has NULL field issues)...")
        
        # Use legacy OAuth browser login
