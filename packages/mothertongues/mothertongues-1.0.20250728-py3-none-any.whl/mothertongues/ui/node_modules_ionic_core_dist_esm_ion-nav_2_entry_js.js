...
/* harmony import */ var _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-f0d7371a.js */ 346);
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = _ionic_global_e6c98cd0_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean('swipeBackEnabled', mode === 'ios');
    }
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.d);
      view._destroy();
    }
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.b);
        (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.c);
        (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.d);
      }
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,_Users_pinea_mothertongues_mothertongues_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_e6c98cd0_js__WEBPACK_IMPORTED_MODULE_5__.b)(_this11);
      ...
      const animationOpts = Object.assign(Object.assign({
        ...
        baseEl: _this11.el,
        progressCallback,
        animated: _this11.animated && _ionic_global_e6c98cd0_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean('animated', true),
        enteringEl,
        leavingEl
      }, opts), {
        animationBuilder: opts.animationBuilder || _this11.animation || _ionic_global_e6c98cd0_js__WEBPACK_IMPORTED_MODULE_5__.c.get('navAnimation')
      });
      const {
        hasCompleted
      } = yield (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.t)(animationOpts);
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.l)(element, _index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_f0d7371a_js__WEBPACK_IMPORTED_MODULE_4__.s)(element, true);
        }
      }
    }
  }
