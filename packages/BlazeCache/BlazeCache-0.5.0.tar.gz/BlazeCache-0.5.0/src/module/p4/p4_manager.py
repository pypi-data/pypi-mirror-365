...
class P4Manager:
    ...
    def run_cache_generator_task(self, p4_ignore_url: str, diff_ninja_log_file: str):
        '''
        封装测速任务 P4 执行逻辑
        ...
        with self._p4_client as client:
            ...
            if not client.check_depot():
                ...
                diff_file_lists = self.get_diffs(diff_ninja_log_file=diff_ninja_log_file, filter_func=lark_filter_func)
    ...
    def run_ci_check_task(self, diff_ninja_log_file: str, delete_client: bool = True):
        '''
