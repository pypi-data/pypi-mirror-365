...
__all__ = ["AssetRetrieveResponse", "Data", "DataAsset", "DataAssetLatestLocation", "DataAssetLatestLocationLocation"]


class DataAssetLatestLocationLocation(BaseModel):
...
class DataAssetLatestLocation(BaseModel):
    ...
    location: Optional[DataAssetLatestLocationLocation] = None
...
class DataAsset(BaseModel):
    ...
    latest_location: Optional[DataAssetLatestLocation] = None
