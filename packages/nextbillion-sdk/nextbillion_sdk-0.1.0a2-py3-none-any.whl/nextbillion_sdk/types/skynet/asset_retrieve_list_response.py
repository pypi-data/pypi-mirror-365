...
__all__ = ["AssetRetrieveListResponse", "Data", "DataList", "DataListLatestLocation", "DataListLatestLocationLocation"]


class DataListLatestLocationLocation(BaseModel):
...
class DataListLatestLocation(BaseModel):
    ...
    location: Optional[DataListLatestLocationLocation] = None
...
class DataList(BaseModel):
    ...
    latest_location: Optional[DataListLatestLocation] = None
