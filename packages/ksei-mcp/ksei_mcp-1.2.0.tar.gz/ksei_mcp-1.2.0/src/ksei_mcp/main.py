#!/usr/bin/env python3
"""
KSEI MCP Server - Model Context Protocol server for KSEI portfolio access
"""
...
if not username or not password:
    raise ValueError("KSEI_USERNAME and KSEI_PASSWORD environment variables must be set")
