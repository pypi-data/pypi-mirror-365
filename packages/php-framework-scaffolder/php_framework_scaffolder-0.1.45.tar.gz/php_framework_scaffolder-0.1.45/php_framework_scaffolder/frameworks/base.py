...
class BaseFrameworkSetup(ABC):
    ...
    def setup(self, repository_path: Path, target_folder: Path, apk_packages: List[str] = [], php_extensions: List[str] = [], pecl_extensions: List[str] = [], php_version: Optional[str] = None) -> None:
