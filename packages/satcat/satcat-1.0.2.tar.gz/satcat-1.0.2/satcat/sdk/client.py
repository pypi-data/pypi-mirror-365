...
from satcat.sdk.events import models as event_models
...
class Client:
    ...
    def request_authenticated(
        ...
        elif self.authenticated_at and (datetime.utcnow() - self.authenticated_at).total_seconds() > AUTH_TIMEOUT_MINUTES * 60:
            with cli_utils.FetchingSpinner("Authenticating..."):
                self.authenticate_session()
        res = self.request(
