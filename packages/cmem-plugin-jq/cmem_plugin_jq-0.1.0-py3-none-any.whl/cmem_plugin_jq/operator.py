...
@Plugin(
    ...
    documentation="""
> [jq](https://jqlang.org/) is like sed for JSON data - you can use it to slice and filter and
> map and transform structured data with the same ease that sed, awk, grep and friends let you
> play with text.
""",
    parameters=[
        PluginParameter(
