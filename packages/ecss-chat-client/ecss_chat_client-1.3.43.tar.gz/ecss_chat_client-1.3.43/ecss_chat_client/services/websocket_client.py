...
class WebsocketClient:
    ...
    async def subscribe_room_changed(self, user_id: str) -> str:
    ...
    async def subscribe_readmark_changed(self, user_id: str) -> str:
    ...
    async def subscribe_preferences_changed(self, user_id: str) -> str:
    ...
    async def subscribe_subscriptions_changed(self, user_id: str) -> str:
        ...
        data = {
            ...
            'name': 'stream-notify-user',
            'params': [
                f'{user_id}/subscriptions-changed',
                {
                    'useCollection': False,
                    'args': [],
                },
    ...
    async def subscribe_notification(self, user_id: str) -> str:
    ...
    async def subscribe_messages_changed(self, user_id: str) -> str:
    ...
    async def subscribe_folders_changed(self, user_id: str) -> str:
