...
class FieldsLocal(GenericCrudMysql):
    ...
    def get_field_name_by_field_id_and_data_source_type_id(self, field_id: int, data_source_type_id: int) -> str | None:
        ...
        data_source_field_tuples = self.select_multi_tuple_by_where(
            schema_name="data_source_field",
            view_table_name="data_source_field_view",
        ...
        if data_source_field_tuples:
            field_name = data_source_field_tuples[0][0]
