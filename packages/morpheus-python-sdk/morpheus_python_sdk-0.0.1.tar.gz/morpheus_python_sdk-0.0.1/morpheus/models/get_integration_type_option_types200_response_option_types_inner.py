...
class GetIntegrationTypeOptionTypes200ResponseOptionTypesInner(BaseModel):
    """
    ...
    depends_on_code: Optional[StrictBool] = Field(default=None, alias="dependsOnCode")
    visible_on_code: Optional[StrictBool] = Field(default=None, alias="visibleOnCode")
    require_on_code: Optional[StrictBool] = Field(default=None, alias="requireOnCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetIntegrationTypeOptionTypes200ResponseOptionTypesInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if export_meta (nullable) is None
        # and model_fields_set contains the field
        if self.export_meta is None and "export_meta" in self.model_fields_set:
            _dict['exportMeta'] = None
        ...
        # set to None if no_blank (nullable) is None
        # and model_fields_set contains the field
        if self.no_blank is None and "no_blank" in self.model_fields_set:
            _dict['noBlank'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetIntegrationTypeOptionTypes200ResponseOptionTypesInner from a dict"""
        if obj is None:
            return None
