...
class ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfRoleMappingsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfRoleMappingsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if source_role_name (nullable) is None
        # and model_fields_set contains the field
        if self.source_role_name is None and "source_role_name" in self.model_fields_set:
            _dict['sourceRoleName'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfRoleMappingsInner from a dict"""
        if obj is None:
            return None
