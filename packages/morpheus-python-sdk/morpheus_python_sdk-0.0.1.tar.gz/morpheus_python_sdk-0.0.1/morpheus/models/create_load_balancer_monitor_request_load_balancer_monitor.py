...
class CreateLoadBalancerMonitorRequestLoadBalancerMonitor(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "monitorType", "monitorTimeout", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateLoadBalancerMonitorRequestLoadBalancerMonitor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateLoadBalancerMonitorRequestLoadBalancerMonitor from a dict"""
        if obj is None:
            return None
