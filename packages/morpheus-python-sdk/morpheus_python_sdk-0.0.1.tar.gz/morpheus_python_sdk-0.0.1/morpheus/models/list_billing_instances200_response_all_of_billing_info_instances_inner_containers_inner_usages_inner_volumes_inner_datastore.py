...
class ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInnerUsagesInnerVolumesInnerDatastore(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "externalId", "internalId", "externalPath"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInnerUsagesInnerVolumesInnerDatastore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInnerUsagesInnerVolumesInnerDatastore from a dict"""
        if obj is None:
            return None
