...
class GetBillingServersIdentifier200ResponseAllOfBillingInfoUsagesInnerApplicablePricesInnerPricesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "pricePerUnit", "costPerUnit", "cost", "price", "quantity", "datastoreId", "volumeType", "datastore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBillingServersIdentifier200ResponseAllOfBillingInfoUsagesInnerApplicablePricesInnerPricesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBillingServersIdentifier200ResponseAllOfBillingInfoUsagesInnerApplicablePricesInnerPricesInner from a dict"""
        if obj is None:
            return None
