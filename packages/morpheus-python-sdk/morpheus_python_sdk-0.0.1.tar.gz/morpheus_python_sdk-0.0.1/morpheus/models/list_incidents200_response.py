...
class ListIncidents200Response(BaseModel):
    ...
    """ # noqa: E501
    incidents: Optional[List[GetCheckApps200ResponseOpenIncidentsInner]] = None
    issues: Optional[List[ListIncidents200ResponseAllOfIssuesInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["incidents", "issues", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "incidents": [GetCheckApps200ResponseOpenIncidentsInner.from_dict(_item) for _item in obj["incidents"]] if obj.get("incidents") is not None else None,
            "issues": [ListIncidents200ResponseAllOfIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
