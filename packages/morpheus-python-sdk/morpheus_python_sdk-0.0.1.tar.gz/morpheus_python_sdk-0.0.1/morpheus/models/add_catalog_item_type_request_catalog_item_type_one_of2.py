...
class AddCatalogItemTypeRequestCatalogItemTypeOneOf2(BaseModel):
    """
    ...
    workflow: GetAlerts200ResponseAllOfChecksInnerAccount
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCatalogItemTypeRequestCatalogItemTypeOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCatalogItemTypeRequestCatalogItemTypeOneOf2 from a dict"""
        if obj is None:
            return None
