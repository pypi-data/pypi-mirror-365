...
class UpdateIntegrationInventoryRequestInventory(BaseModel):
    """
    UpdateIntegrationInventoryRequestInventory
    """ # noqa: E501
    tenants: Optional[List[GetAlerts200ResponseAllOfChecksInnerAccount]] = Field(default=None, description="Array of tenant accounts that will use this inventory as Default. Used by jobs set to 'Use Tenant Default'")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateIntegrationInventoryRequestInventory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateIntegrationInventoryRequestInventory from a dict"""
        if obj is None:
            return None
