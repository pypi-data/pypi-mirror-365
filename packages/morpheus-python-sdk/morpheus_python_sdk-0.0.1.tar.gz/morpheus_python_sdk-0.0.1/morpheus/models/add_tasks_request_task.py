...
class AddTasksRequestTask(BaseModel):
    """
    AddTasksRequestTask
    """ # noqa: E501
    name: StrictStr = Field(description="A unique name for the task")
    ...
    task_type: AddTasksRequestTaskTaskType = Field(alias="taskType")
    ...
    execute_target: StrictStr = Field(description="The execution target. eg. local,remote,resource. The default value varies by task type. ", alias="executeTarget")
    ...
    credential: Optional[AddTasksRequestTaskCredential] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddTasksRequestTask from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddTasksRequestTask from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "credential": AddTasksRequestTaskCredential.from_dict(obj["credential"]) if obj.get("credential") is not None else None
        })
        return _obj
