...
class ListTenantSubtenantGroups200ResponseAllOfGroupsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "location", "accountId", "visibility", "active", "dateCreated", "lastUpdated", "zones", "stats", "serverCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTenantSubtenantGroups200ResponseAllOfGroupsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTenantSubtenantGroups200ResponseAllOfGroupsInner from a dict"""
        if obj is None:
            return None
