...
class AddBlueprint200ResponseAllOfBlueprintConfigOneOf3(BaseModel):
    """
    ...
    kubernetes: Optional[AddBlueprintRequestOneOf3Kubernetes] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "type", "kubernetes", "config", "visibility", "resourcePermission", "owner", "tenant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf3 from a dict"""
        if obj is None:
            return None
