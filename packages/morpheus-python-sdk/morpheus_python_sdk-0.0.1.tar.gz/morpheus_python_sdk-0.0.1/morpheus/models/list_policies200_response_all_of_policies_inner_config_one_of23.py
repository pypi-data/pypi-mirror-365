...
class ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf23(BaseModel):
    """
    - Shutdown 
    """ # noqa: E501
    shutdown_type: StrictStr = Field(alias="shutdownType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf23 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf23 from a dict"""
        if obj is None:
            return None
