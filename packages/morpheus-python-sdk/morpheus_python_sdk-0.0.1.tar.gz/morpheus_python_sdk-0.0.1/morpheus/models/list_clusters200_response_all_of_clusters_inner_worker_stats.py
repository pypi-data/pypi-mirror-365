...
class ListClusters200ResponseAllOfClustersInnerWorkerStats(BaseModel):
    """
    ...
    used_cpu: Optional[StrictInt] = Field(default=None, alias="usedCpu")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListClusters200ResponseAllOfClustersInnerWorkerStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListClusters200ResponseAllOfClustersInnerWorkerStats from a dict"""
        if obj is None:
            return None
