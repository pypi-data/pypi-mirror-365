...
class ListScaleThresholds200ResponseAllOfScaleThresholdsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "autoUp", "autoDown", "minCount", "maxCount", "scaleIncrement", "cpuEnabled", "minCpu", "maxCpu", "memoryEnabled", "minMemory", "maxMemory", "diskEnabled", "minDisk", "maxDisk", "dateCreated", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListScaleThresholds200ResponseAllOfScaleThresholdsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListScaleThresholds200ResponseAllOfScaleThresholdsInner from a dict"""
        if obj is None:
            return None
