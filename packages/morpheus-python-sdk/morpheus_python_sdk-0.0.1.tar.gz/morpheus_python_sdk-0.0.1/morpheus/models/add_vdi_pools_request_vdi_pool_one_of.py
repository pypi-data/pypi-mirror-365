...
class AddVDIPoolsRequestVdiPoolOneOf(BaseModel):
    """
    ...
    instance_config: StrictStr = Field(description="Instance Config JSON. Passing as a string will preserve property order.  See `config` object for required values.", alias="instanceConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddVDIPoolsRequestVdiPoolOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddVDIPoolsRequestVdiPoolOneOf from a dict"""
        if obj is None:
            return None
