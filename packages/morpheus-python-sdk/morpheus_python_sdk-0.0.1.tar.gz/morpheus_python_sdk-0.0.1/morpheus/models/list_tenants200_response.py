...
class ListTenants200Response(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[ListTenants200ResponseAllOfAccountsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["accounts", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [ListTenants200ResponseAllOfAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
