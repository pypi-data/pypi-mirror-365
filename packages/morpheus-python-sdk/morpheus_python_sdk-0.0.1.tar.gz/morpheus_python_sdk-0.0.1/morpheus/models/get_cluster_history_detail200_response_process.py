...
class GetClusterHistoryDetail200ResponseProcess(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "uniqueId", "processType", "description", "subType", "subId", "zoneId", "integrationId", "appId", "instanceId", "containerId", "serverId", "containerName", "displayName", "status", "reason", "percent", "statusEta", "message", "output", "error", "startDate", "endDate", "duration", "dateCreated", "lastUpdated", "createdBy", "updatedBy", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetClusterHistoryDetail200ResponseProcess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetClusterHistoryDetail200ResponseProcess from a dict"""
        if obj is None:
            return None
