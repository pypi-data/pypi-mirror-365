...
class ListTasks200ResponseAllOfTasksInnerAnyOf13TaskOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["password", "passwordHash", "localScriptGitRef", "host", "username", "localScriptGitId", "sshKey", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf13TaskOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf13TaskOptions from a dict"""
        if obj is None:
            return None
