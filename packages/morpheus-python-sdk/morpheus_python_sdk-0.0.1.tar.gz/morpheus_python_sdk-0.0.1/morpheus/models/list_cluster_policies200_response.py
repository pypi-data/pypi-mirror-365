...
class ListClusterPolicies200Response(BaseModel):
    """
    ListClusterPolicies200Response
    """ # noqa: E501
    policies: Optional[List[ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListClusterPolicies200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListClusterPolicies200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "policies": [ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
