...
class GetClusterMasters200ResponseMastersInnerInterfacesInner(BaseModel):
    """
    ...
    network_pool: Optional[StrictStr] = Field(default=None, alias="networkPool")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetClusterMasters200ResponseMastersInnerInterfacesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetClusterMasters200ResponseMastersInnerInterfacesInner from a dict"""
        if obj is None:
            return None
