...
class ListPolicies200Response(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[List[ListPolicies200ResponseAllOfPoliciesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [ListPolicies200ResponseAllOfPoliciesInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
