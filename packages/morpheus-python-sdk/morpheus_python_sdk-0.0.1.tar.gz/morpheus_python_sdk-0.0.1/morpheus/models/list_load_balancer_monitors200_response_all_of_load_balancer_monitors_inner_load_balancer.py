...
class ListLoadBalancerMonitors200ResponseAllOfLoadBalancerMonitorsInnerLoadBalancer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "ip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListLoadBalancerMonitors200ResponseAllOfLoadBalancerMonitorsInnerLoadBalancer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListLoadBalancerMonitors200ResponseAllOfLoadBalancerMonitorsInnerLoadBalancer from a dict"""
        if obj is None:
            return None
