...
class ListOsTypes200ResponseAllOfOsTypesInnerImagesInner(BaseModel):
    """
    ListOsTypes200ResponseAllOfOsTypesInnerImagesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    virtual_image_id: Optional[StrictInt] = Field(default=None, alias="virtualImageId")
    virtual_image_name: Optional[StrictStr] = Field(default=None, alias="virtualImageName")
    account: Optional[StrictInt] = None
    provision_type: Optional[StrictInt] = Field(default=None, alias="provisionType")
    compute_zone_type: Optional[StrictInt] = Field(default=None, alias="computeZoneType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListOsTypes200ResponseAllOfOsTypesInnerImagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListOsTypes200ResponseAllOfOsTypesInnerImagesInner from a dict"""
        if obj is None:
            return None
