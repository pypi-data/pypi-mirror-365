...
class NetworkPoolServerCreatePhpIpam(BaseModel):
    """
    NetworkPoolServerCreatePhpIpam
    """ # noqa: E501
    type: StrictStr = Field(description="Type Code (phpIPAM)")
    ...
    config: PhpIPAMNetworkPoolServerConfig
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkPoolServerCreatePhpIpam from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkPoolServerCreatePhpIpam from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": PhpIPAMNetworkPoolServerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
