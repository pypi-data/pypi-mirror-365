...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf4(BaseModel):
    """
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf4Config] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['cherwell']):
            raise ValueError("must be one of enum values ('cherwell')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf4 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf4Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
