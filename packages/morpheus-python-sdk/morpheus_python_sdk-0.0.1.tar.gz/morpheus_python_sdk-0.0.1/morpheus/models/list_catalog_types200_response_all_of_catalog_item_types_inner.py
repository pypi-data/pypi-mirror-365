...
class ListCatalogTypes200ResponseAllOfCatalogItemTypesInner(BaseModel):
    """
    ...
    allow_quantity: Optional[StrictBool] = Field(default=None, alias="allowQuantity")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "context", "featured", "allowQuantity", "imagePath", "darkImagePath", "formType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCatalogTypes200ResponseAllOfCatalogItemTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCatalogTypes200ResponseAllOfCatalogItemTypesInner from a dict"""
        if obj is None:
            return None
