...
class ListServerServicePlans200ResponsePlansInner(BaseModel):
    """
    ...
    max_data_storage: Optional[StrictInt] = Field(default=None, alias="maxDataStorage")
    ...
    storage_types: Optional[List[Dict[str, Any]]] = Field(default=None, alias="storageTypes")
    root_storage_types: Optional[List[Dict[str, Any]]] = Field(default=None, alias="rootStorageTypes")
    ...
    has_datastore: Optional[StrictStr] = Field(default=None, alias="hasDatastore")
    lvm_supported: Optional[StrictStr] = Field(default=None, alias="lvmSupported")
    min_disk: Optional[StrictStr] = Field(default=None, alias="minDisk")
    max_disk: Optional[StrictStr] = Field(default=None, alias="maxDisk")
    datastores: Optional[ListServerServicePlans200ResponsePlansInnerDatastores] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListServerServicePlans200ResponsePlansInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if host_disk_mode (nullable) is None
        # and model_fields_set contains the field
        if self.host_disk_mode is None and "host_disk_mode" in self.model_fields_set:
            _dict['hostDiskMode'] = None

        # set to None if has_datastore (nullable) is None
        # and model_fields_set contains the field
        if self.has_datastore is None and "has_datastore" in self.model_fields_set:
            _dict['hasDatastore'] = None

        # set to None if lvm_supported (nullable) is None
        # and model_fields_set contains the field
        if self.lvm_supported is None and "lvm_supported" in self.model_fields_set:
            _dict['lvmSupported'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListServerServicePlans200ResponsePlansInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "maxDataStorage": obj.get("maxDataStorage"),
            ...
            "storageTypes": obj.get("storageTypes"),
            "rootStorageTypes": obj.get("rootStorageTypes"),
            ...
            "datastores": ListServerServicePlans200ResponsePlansInnerDatastores.from_dict(obj["datastores"]) if obj.get("datastores") is not None else None,
