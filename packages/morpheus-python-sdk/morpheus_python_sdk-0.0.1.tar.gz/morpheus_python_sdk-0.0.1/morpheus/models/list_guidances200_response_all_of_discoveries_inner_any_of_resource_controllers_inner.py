...
class ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfResourceControllersInner(BaseModel):
    """
    ...
    reserved_unit_number: Optional[StrictInt] = Field(default=None, alias="reservedUnitNumber")
    __properties: ClassVar[List[str]] = ["id", "name", "type", "maxDevices", "reservedUnitNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfResourceControllersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfResourceControllersInner from a dict"""
        if obj is None:
            return None
