...
class ListEmailTemplates200ResponseAllOfEmailTemplatesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEmailTemplates200ResponseAllOfEmailTemplatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEmailTemplates200ResponseAllOfEmailTemplatesInner from a dict"""
        if obj is None:
            return None
