...
class UpdateCloudDatastores200ResponseDatastore(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "zone", "type", "freeSpace", "online", "active", "visibility", "tenants", "resourcePermission", "success"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCloudDatastores200ResponseDatastore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCloudDatastores200ResponseDatastore from a dict"""
        if obj is None:
            return None
