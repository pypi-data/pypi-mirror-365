...
class ListPowerSchedules200Response(BaseModel):
    """
    ListPowerSchedules200Response
    """ # noqa: E501
    schedules: Optional[List[ListPowerSchedules200ResponseAllOfSchedulesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPowerSchedules200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPowerSchedules200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schedules": [ListPowerSchedules200ResponseAllOfSchedulesInner.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None,
