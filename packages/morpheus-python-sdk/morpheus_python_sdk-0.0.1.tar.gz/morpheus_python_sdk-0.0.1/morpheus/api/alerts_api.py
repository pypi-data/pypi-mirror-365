...
class AlertsApi:
    ...
    def add_alerts(
        self,
        add_alerts_request: Optional[AddAlertsRequest] = None,
        ...
        :param add_alerts_request:
        :type add_alerts_request: AddAlertsRequest
        ...
        _param = self._add_alerts_serialize(
            add_alerts_request=add_alerts_request,
    ...
    def add_alerts_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddAlerts200Response]:
        """Create a New Alert
    ...
    @validate_call
    def add_alerts_without_preload_content(
        self,
        add_alerts_request: Optional[AddAlertsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_alerts_serialize(
        ...
        if add_alerts_request is not None:
            _body_params = add_alerts_request
    ...
    def _delete_alerts_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/monitoring/alerts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_alerts(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_alerts_request: Optional[UpdateAlertsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Morpheus ID of the Object being referenced (required)
        :type id: int
        :param update_alerts_request:
        :type update_alerts_request: UpdateAlertsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_alerts_serialize(
            id=id,
            update_alerts_request=update_alerts_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_alerts_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_alerts_request is not None:
            _body_params = update_alerts_request
