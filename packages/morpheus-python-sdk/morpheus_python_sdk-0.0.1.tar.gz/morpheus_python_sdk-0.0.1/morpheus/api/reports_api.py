...
class ReportsApi:
    ...
    def download_reports(
        ...
        format: Annotated[StrictStr, Field(description="Format of the rendered report file, `.json` or `.csv`.")],
        ...
        _param = self._download_reports_serialize(
            id=id,
            format=format,
    ...
    @validate_call
    def download_reports_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        format: Annotated[StrictStr, Field(description="Format of the rendered report file, `.json` or `.csv`.")],
        _request_timeout: Union[
    ...
    @validate_call
    def download_reports_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        format: Annotated[StrictStr, Field(description="Format of the rendered report file, `.json` or `.csv`.")],
        _request_timeout: Union[
    ...
    def _download_reports_serialize(
        self,
        id,
        format,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/reports/download/{id}{format}',
    ...
    def get_report_types_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReportTypes200Response]:
        """This endpoint retrieves all available report types
    ...
    def _get_report_types_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/report-types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_reports(
        ...
        phrase: Annotated[Optional[StrictStr], Field(description="Search phrase for partial matches on name or description")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter by name")] = None,
        report_type: Annotated[Optional[StrictStr], Field(description="If specified will return an exact match on report type code, accepts multiple values")] = None,
        category: Annotated[Optional[StrictStr], Field(description="If specified will return an exact match on category")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param name: Filter by name
        :type name: str
        :param report_type: If specified will return an exact match on report type code, accepts multiple values
    ...
    def remove_reports(
        ...
        _param = self._remove_reports_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remove_reports_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def remove_reports_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    def run_reports(
        self,
        run_reports_request: Optional[RunReportsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param run_reports_request:
        :type run_reports_request: RunReportsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._run_reports_serialize(
            run_reports_request=run_reports_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def run_reports_with_http_info(
        self,
        run_reports_request: Optional[RunReportsRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RunReports200Response]:
        """Run specified report
    ...
    @validate_call
    def run_reports_without_preload_content(
        self,
        run_reports_request: Optional[RunReportsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _run_reports_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if run_reports_request is not None:
            _body_params = run_reports_request
