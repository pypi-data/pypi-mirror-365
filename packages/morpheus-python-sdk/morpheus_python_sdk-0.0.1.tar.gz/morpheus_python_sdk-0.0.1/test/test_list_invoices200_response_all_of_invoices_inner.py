...
class TestListInvoices200ResponseAllOfInvoicesInner(unittest.TestCase):
    """ListInvoices200ResponseAllOfInvoicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInvoices200ResponseAllOfInvoicesInner:
        """Test ListInvoices200ResponseAllOfInvoicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInvoices200ResponseAllOfInvoicesInner`
        """
        model = ListInvoices200ResponseAllOfInvoicesInner()
        if include_optional:
            return ListInvoices200ResponseAllOfInvoicesInner(
                id = 56,
                owner_id = 56,
    ...
    def testListInvoices200ResponseAllOfInvoicesInner(self):
        """Test ListInvoices200ResponseAllOfInvoicesInner"""
