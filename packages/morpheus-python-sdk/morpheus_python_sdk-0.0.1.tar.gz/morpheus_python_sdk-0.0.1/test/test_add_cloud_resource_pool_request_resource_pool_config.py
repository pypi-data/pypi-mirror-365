...
class TestAddCloudResourcePoolRequestResourcePoolConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddCloudResourcePoolRequestResourcePoolConfig:
        """Test AddCloudResourcePoolRequestResourcePoolConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCloudResourcePoolRequestResourcePoolConfig`
        """
        model = AddCloudResourcePoolRequestResourcePoolConfig()
        if include_optional:
            return AddCloudResourcePoolRequestResourcePoolConfig(
                cidr_block = '',
                tenancy = 'default',
                managers = [
                    ''
