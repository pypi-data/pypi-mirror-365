...
class TestUpdateRoleRequestRole(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateRoleRequestRole:
        """Test UpdateRoleRequestRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateRoleRequestRole`
        """
        model = UpdateRoleRequestRole()
        if include_optional:
            return UpdateRoleRequestRole(
                authority = '',
                description = '',
                landing_url = '',
                ...
                persona_permissions = [
                    morpheus.models.update_role_request_role_persona_permissions_inner.updateRole_request_role_personaPermissions_inner(
                        code = 'standard', 
                        access = 'default', )
                    ],
