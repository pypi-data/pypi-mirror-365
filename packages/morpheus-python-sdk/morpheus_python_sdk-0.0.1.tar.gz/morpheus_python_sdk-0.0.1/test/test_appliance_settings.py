...
class TestApplianceSettings(unittest.TestCase):
    """ApplianceSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplianceSettings:
        """Test ApplianceSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplianceSettings`
        """
    ...
    def testApplianceSettings(self):
        """Test ApplianceSettings"""
