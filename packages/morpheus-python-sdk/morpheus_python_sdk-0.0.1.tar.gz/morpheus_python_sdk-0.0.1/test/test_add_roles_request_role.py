...
class TestAddRolesRequestRole(unittest.TestCase):
    """AddRolesRequestRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddRolesRequestRole:
        """Test AddRolesRequestRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddRolesRequestRole`
        """
        model = AddRolesRequestRole()
        if include_optional:
            return AddRolesRequestRole(
                authority = '',
                description = '',
                landing_url = '',
                role_type = 'user',
    ...
    def testAddRolesRequestRole(self):
        """Test AddRolesRequestRole"""
