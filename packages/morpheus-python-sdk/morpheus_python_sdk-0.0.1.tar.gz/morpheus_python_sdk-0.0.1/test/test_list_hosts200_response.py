...
class TestListHosts200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListHosts200Response:
        """Test ListHosts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListHosts200Response`
        """
        model = ListHosts200Response()
        if include_optional:
            return ListHosts200Response(
                servers = [
                    morpheus.models.list_hosts_200_response_all_of_servers_inner.listHosts_200_response_allOf_servers_inner(
                        id = 56, 
                        uuid = '', 
                        external_id = '', 
                        internal_id = '', 
