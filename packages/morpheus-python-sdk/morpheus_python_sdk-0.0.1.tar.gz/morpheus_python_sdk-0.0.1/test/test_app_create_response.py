...
class TestAppCreateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AppCreateResponse:
        """Test AppCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppCreateResponse`
        """
        model = AppCreateResponse()
        if include_optional:
    ...
    def testAppCreateResponse(self):
        """Test AppCreateResponse"""
