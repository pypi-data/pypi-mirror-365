...
class TestListHosts200ResponseAllOfServersInnerInterfacesInner(unittest.TestCase):
    """ListHosts200ResponseAllOfServersInnerInterfacesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListHosts200ResponseAllOfServersInnerInterfacesInner:
        """Test ListHosts200ResponseAllOfServersInnerInterfacesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListHosts200ResponseAllOfServersInnerInterfacesInner`
        """
        model = ListHosts200ResponseAllOfServersInnerInterfacesInner()
        if include_optional:
            return ListHosts200ResponseAllOfServersInnerInterfacesInner(
                id = 56,
                ref_type = '',
                ref_id = '',
                name = '',
    ...
    def testListHosts200ResponseAllOfServersInnerInterfacesInner(self):
        """Test ListHosts200ResponseAllOfServersInnerInterfacesInner"""
