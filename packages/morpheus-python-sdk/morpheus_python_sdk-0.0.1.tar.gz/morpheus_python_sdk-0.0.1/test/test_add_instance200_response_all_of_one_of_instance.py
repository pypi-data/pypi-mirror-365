...
class TestAddInstance200ResponseAllOfOneOfInstance(unittest.TestCase):
    """AddInstance200ResponseAllOfOneOfInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddInstance200ResponseAllOfOneOfInstance:
        """Test AddInstance200ResponseAllOfOneOfInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddInstance200ResponseAllOfOneOfInstance`
        """
        model = AddInstance200ResponseAllOfOneOfInstance()
        if include_optional:
            return AddInstance200ResponseAllOfOneOfInstance(
                id = 56,
                uuid = '',
                account_id = 56,
    ...
    def testAddInstance200ResponseAllOfOneOfInstance(self):
        """Test AddInstance200ResponseAllOfOneOfInstance"""
