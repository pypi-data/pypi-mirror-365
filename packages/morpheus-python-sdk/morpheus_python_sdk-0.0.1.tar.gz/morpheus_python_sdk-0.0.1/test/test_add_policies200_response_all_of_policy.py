...
class TestAddPolicies200ResponseAllOfPolicy(unittest.TestCase):
    """AddPolicies200ResponseAllOfPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddPolicies200ResponseAllOfPolicy:
        """Test AddPolicies200ResponseAllOfPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddPolicies200ResponseAllOfPolicy`
        """
        model = AddPolicies200ResponseAllOfPolicy()
        if include_optional:
            return AddPolicies200ResponseAllOfPolicy(
                id = 56,
                name = '',
                description = '',
    ...
    def testAddPolicies200ResponseAllOfPolicy(self):
        """Test AddPolicies200ResponseAllOfPolicy"""
