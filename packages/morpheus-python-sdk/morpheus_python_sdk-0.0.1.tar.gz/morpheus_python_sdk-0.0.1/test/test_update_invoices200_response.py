...
class TestUpdateInvoices200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateInvoices200Response:
        """Test UpdateInvoices200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoices200Response`
        """
        model = UpdateInvoices200Response()
        if include_optional:
            return UpdateInvoices200Response(
                user = morpheus.models.list_invoices_200_response_all_of_invoices_inner.listInvoices_200_response_allOf_invoices_inner(
                    id = 56, 
                    owner_id = 56, 
