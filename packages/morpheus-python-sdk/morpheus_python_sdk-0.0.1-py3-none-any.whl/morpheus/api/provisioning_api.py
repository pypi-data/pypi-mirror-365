...
class ProvisioningApi:
    ...
    def get_provision_types(
        ...
        _param = self._get_provision_types_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProvisionTypes200Response",
    ...
    @validate_call
    def get_provision_types_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProvisionTypes200Response]:
        """Retrieves a Specific Provision Type
    ...
    @validate_call
    def get_provision_types_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    def _get_provision_types_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/provision-types/{id}',
    ...
    def list_provision_types(
        ...
        _param = self._list_provision_types_serialize(
            max=max,
            offset=offset,
            sort=sort,
            direction=direction,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListProvisionTypes200Response",
            '4XX': "ListActivity4XXResponse",
            '5XX': "ListActivity5XXResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_provision_types_with_http_info(
        self,
        max: Annotated[Optional[StrictInt], Field(description="Maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset records, the number of records to skip, for paginating requests")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort order, the name of the property to sort by")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListProvisionTypes200Response]:
        """Retrieves all Provision Types
    ...
    @validate_call
    def list_provision_types_without_preload_content(
        self,
        max: Annotated[Optional[StrictInt], Field(description="Maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset records, the number of records to skip, for paginating requests")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort order, the name of the property to sort by")] = None,
    ...
    def _list_provision_types_serialize(
        self,
        max,
        offset,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/provision-types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
