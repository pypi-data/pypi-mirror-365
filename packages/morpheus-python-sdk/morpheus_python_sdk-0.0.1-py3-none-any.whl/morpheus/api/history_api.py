...
class HistoryApi:
    ...
    def cancel_process(
        self,
        id: Annotated[StrictInt, Field(description="Process ID")],
        ...
        _param = self._cancel_process_serialize(
            id=id,
    ...
    @validate_call
    def cancel_process_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Process ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_process_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Process ID")],
        _request_timeout: Union[
            None,
    ...
    def _cancel_process_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/processes/{id}/cancel',
    ...
    def _get_history_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/processes/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_history(
        ...
        app_id: Annotated[Optional[StrictInt], Field(description="The App ID for Filtering")] = None,
        phrase: Annotated[Optional[StrictStr], Field(description="Search phrase for partial matches on message, displayName, output, event.message, event.output or event.error")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type zone_id: int
        :param app_id: The App ID for Filtering
        :type app_id: int
        :param phrase: Search phrase for partial matches on message, displayName, output, event.message, event.output or event.error
        :type phrase: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_history_serialize(
    ...
    @validate_call
    def list_history_with_http_info(
        self,
        instance_id: Annotated[Optional[StrictInt], Field(description="The Instance ID for Filtering")] = None,
        container_id: Annotated[Optional[StrictInt], Field(description="The Container ID for Filtering")] = None,
        server_id: Annotated[Optional[StrictInt], Field(description="The Server ID for Filtering")] = None,
    ...
    @validate_call
    def list_history_without_preload_content(
        self,
        instance_id: Annotated[Optional[StrictInt], Field(description="The Instance ID for Filtering")] = None,
        container_id: Annotated[Optional[StrictInt], Field(description="The Container ID for Filtering")] = None,
        server_id: Annotated[Optional[StrictInt], Field(description="The Server ID for Filtering")] = None,
    ...
    def retry_process(
        ...
        _param = self._retry_process_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retry_process_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Process ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retry_process_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Process ID")],
        _request_timeout: Union[
            None,
    ...
    def _retry_process_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/processes/{id}/retry',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
