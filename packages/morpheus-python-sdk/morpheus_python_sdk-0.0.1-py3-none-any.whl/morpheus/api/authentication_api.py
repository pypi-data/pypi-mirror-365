...
class AuthenticationApi:
    ...
    def _forgot_password_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/forgot/send-email',
    ...
    def get_access_token(
        self,
        client_id: Annotated[StrictStr, Field(description="Client ID, use morph-api. Users may only have one access token per Client ID. The CLI uses morph-cli.")],
        grant_type: Annotated[StrictStr, Field(description="OAuth Grant Type, use password.")],
        scope: Annotated[StrictStr, Field(description="OAuth token scope, use write.")],
        username: Annotated[Optional[StrictStr], Field(description="Specified as \\\"username\\\" or \\\"tenantId\\\\username\\\" with proper HTML encoding and used in conjunction with `password`. Not utilized with `refresh_token`.")] = None,
        password: Annotated[Optional[StrictStr], Field(description="The Password for defined `username`. Must have proper HTML encoding")] = None,
        ...
        :param client_id: Client ID, use morph-api. Users may only have one access token per Client ID. The CLI uses morph-cli. (required)
        :type client_id: str
        :param grant_type: OAuth Grant Type, use password. (required)
        :type grant_type: str
        :param scope: OAuth token scope, use write. (required)
        :type scope: str
        :param username: Specified as \\\"username\\\" or \\\"tenantId\\\\username\\\" with proper HTML encoding and used in conjunction with `password`. Not utilized with `refresh_token`.
        :type username: str
        :param password: The Password for defined `username`. Must have proper HTML encoding
        :type password: str
        :param refresh_token:
        :type refresh_token: object
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def reset_password(
        self,
        reset_password_request: Optional[ResetPasswordRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _reset_password_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/forgot/reset-password',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
