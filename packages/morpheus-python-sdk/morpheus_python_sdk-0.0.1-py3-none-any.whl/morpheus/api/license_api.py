...
class LicenseApi:
    ...
    def install_license(
        self,
        install_license_request: Optional[InstallLicenseRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def test_license(
        ...
        _param = self._test_license_serialize(
            install_license_request=install_license_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def test_license_with_http_info(
        self,
        install_license_request: Optional[InstallLicenseRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def test_license_without_preload_content(
        self,
        install_license_request: Optional[InstallLicenseRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _test_license_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/license/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def uninstall_license(
        self,
        key_id: Annotated[Optional[StrictInt], Field(description="Key ID (only the first 8 characters are required to identify license to uninstall).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param key_id: Key ID (only the first 8 characters are required to identify license to uninstall).
        :type key_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._uninstall_license_serialize(
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def uninstall_license_with_http_info(
        self,
        key_id: Annotated[Optional[StrictInt], Field(description="Key ID (only the first 8 characters are required to identify license to uninstall).")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def uninstall_license_without_preload_content(
        self,
        key_id: Annotated[Optional[StrictInt], Field(description="Key ID (only the first 8 characters are required to identify license to uninstall).")] = None,
        _request_timeout: Union[
            None,
    ...
    def _uninstall_license_serialize(
        self,
        key_id,
        _request_auth,
        _content_type,
