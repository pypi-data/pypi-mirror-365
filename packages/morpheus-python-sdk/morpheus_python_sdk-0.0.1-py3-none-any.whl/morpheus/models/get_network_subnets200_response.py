...
class GetNetworkSubnets200Response(BaseModel):
    """
    GetNetworkSubnets200Response
    """ # noqa: E501
    subnets: Optional[List[GetNetworkSubnets200ResponseAllOfSubnetsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["subnets", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkSubnets200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkSubnets200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "subnets": [GetNetworkSubnets200ResponseAllOfSubnetsInner.from_dict(_item) for _item in obj["subnets"]] if obj.get("subnets") is not None else None,
