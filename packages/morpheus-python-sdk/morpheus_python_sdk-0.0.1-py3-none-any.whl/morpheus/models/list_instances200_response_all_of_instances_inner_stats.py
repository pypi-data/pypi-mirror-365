...
class ListInstances200ResponseAllOfInstancesInnerStats(BaseModel):
    """
    ...
    used_cpu: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usedCpu")
    cpu_usage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="cpuUsage")
    cpu_usage_peak: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="cpuUsagePeak")
    cpu_usage_avg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="cpuUsageAvg")
    __properties: ClassVar[List[str]] = ["usedStorage", "maxStorage", "usedMemory", "maxMemory", "usedCpu", "cpuUsage", "cpuUsagePeak", "cpuUsageAvg"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListInstances200ResponseAllOfInstancesInnerStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListInstances200ResponseAllOfInstancesInnerStats from a dict"""
        if obj is None:
            return None
