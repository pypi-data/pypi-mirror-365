...
class UpdateRoleRequestRole(BaseModel):
    """
    Payload for updating an existing role
    """ # noqa: E501
    authority: Optional[StrictStr] = Field(default=None, description="Authority (Name)")
    ...
    persona_permissions: Optional[List[UpdateRoleRequestRolePersonaPermissionsInner]] = Field(default=None, description="Set the access level for the specified personas", alias="personaPermissions")
    ...
    def global_site_access_validate_enum(cls, value):
        ...
        if value not in set(['full', 'read', 'none']):
            raise ValueError("must be one of enum values ('full', 'read', 'none')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateRoleRequestRole from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateRoleRequestRole from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "personaPermissions": [UpdateRoleRequestRolePersonaPermissionsInner.from_dict(_item) for _item in obj["personaPermissions"]] if obj.get("personaPermissions") is not None else None,
