...
class ListImageBuilds200ResponseAllOfImageBuildsInnerConfigInstance(BaseModel):
    """
    ListImageBuilds200ResponseAllOfImageBuildsInnerConfigInstance
    """ # noqa: E501
    layout: Optional[ListBackupSettings200ResponseBackupSettingsDefaultSchedule] = None
    site: Optional[GetAlerts200ResponseAllOfChecksInnerAccount] = None
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["layout", "site", "name", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListImageBuilds200ResponseAllOfImageBuildsInnerConfigInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListImageBuilds200ResponseAllOfImageBuildsInnerConfigInstance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "layout": ListBackupSettings200ResponseBackupSettingsDefaultSchedule.from_dict(obj["layout"]) if obj.get("layout") is not None else None,
