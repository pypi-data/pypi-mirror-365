...
class AddInstance200ResponseAllOfOneOfInstanceConfig(BaseModel):
    """
    ...
    no_agent: Optional[AddInstance200ResponseAllOfOneOfInstanceConfigNoAgent] = Field(default=None, alias="noAgent")
    security_groups: Optional[List[ListInstances200ResponseAllOfInstancesInnerConfigUserGroup]] = Field(default=None, alias="securityGroups")
    ...
    resource_pool_id: Optional[AddInstance200ResponseAllOfOneOfInstanceConfigResourcePoolId] = Field(default=None, alias="resourcePoolId")
    ...
    instance_type: Optional[AddInstance200ResponseAllOfOneOfInstanceConfigInstanceType] = Field(default=None, alias="instanceType")
    ...
    replication_group: Optional[AddInstance200ResponseAllOfOneOfInstanceConfigReplicationGroup] = Field(default=None, alias="replicationGroup")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddInstance200ResponseAllOfOneOfInstanceConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddInstance200ResponseAllOfOneOfInstanceConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "noAgent": AddInstance200ResponseAllOfOneOfInstanceConfigNoAgent.from_dict(obj["noAgent"]) if obj.get("noAgent") is not None else None,
            "securityGroups": [ListInstances200ResponseAllOfInstancesInnerConfigUserGroup.from_dict(_item) for _item in obj["securityGroups"]] if obj.get("securityGroups") is not None else None,
            ...
            "resourcePoolId": AddInstance200ResponseAllOfOneOfInstanceConfigResourcePoolId.from_dict(obj["resourcePoolId"]) if obj.get("resourcePoolId") is not None else None,
            ...
            "instanceType": AddInstance200ResponseAllOfOneOfInstanceConfigInstanceType.from_dict(obj["instanceType"]) if obj.get("instanceType") is not None else None,
            ...
            "replicationGroup": AddInstance200ResponseAllOfOneOfInstanceConfigReplicationGroup.from_dict(obj["replicationGroup"]) if obj.get("replicationGroup") is not None else None,
