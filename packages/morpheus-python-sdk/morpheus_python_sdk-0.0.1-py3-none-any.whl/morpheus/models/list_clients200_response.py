...
class ListClients200Response(BaseModel):
    ...
    """ # noqa: E501
    clients: Optional[List[ListClients200ResponseAllOfClientsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["clients", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clients": [ListClients200ResponseAllOfClientsInner.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None,
