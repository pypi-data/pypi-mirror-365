...
class UpdateInstanceNetworkInterface200ResponseAllOfOneOfServerInterfacesInner(BaseModel):
    """
    UpdateInstanceNetworkInterface200ResponseAllOfOneOfServerInterfacesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    addresses: Optional[List[GetAlerts200ResponseAllOfChecksInnerAccount]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateInstanceNetworkInterface200ResponseAllOfOneOfServerInterfacesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateInstanceNetworkInterface200ResponseAllOfOneOfServerInterfacesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "addresses": [GetAlerts200ResponseAllOfChecksInnerAccount.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
