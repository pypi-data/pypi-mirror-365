...
class GetInstanceThreshold200ResponseInstanceSchedulesInnerThreshold(BaseModel):
    """
    ...
    scale_increment: Optional[StrictInt] = Field(default=1, description="The number of nodes that are added or removed at one time when scaling up or down", alias="scaleIncrement")
    ...
    __properties: ClassVar[List[str]] = ["autoUp", "autoDown", "minCount", "maxCount", "scaleIncrement", "cpuEnabled", "minCpu", "maxCpu", "memoryEnabled", "minMemory", "maxMemory", "diskEnabled", "minDisk", "maxDisk"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInstanceThreshold200ResponseInstanceSchedulesInnerThreshold from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInstanceThreshold200ResponseInstanceSchedulesInnerThreshold from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scaleIncrement": obj.get("scaleIncrement") if obj.get("scaleIncrement") is not None else 1,
