...
class ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanBeforeActionConfigRanges(BaseModel):
    """
    ...
    min_memory: Optional[StrictStr] = Field(default=None, alias="minMemory")
    ...
    __properties: ClassVar[List[str]] = ["minStorage", "maxStorage", "minMemory", "maxMemory", "minCores", "maxCores"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanBeforeActionConfigRanges from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanBeforeActionConfigRanges from a dict"""
        if obj is None:
            return None
