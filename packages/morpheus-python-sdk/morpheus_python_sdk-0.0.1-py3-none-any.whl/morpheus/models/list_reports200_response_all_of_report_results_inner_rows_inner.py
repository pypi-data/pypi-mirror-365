...
class ListReports200ResponseAllOfReportResultsInnerRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "section", "data", "displayOrder"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListReports200ResponseAllOfReportResultsInnerRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListReports200ResponseAllOfReportResultsInnerRowsInner from a dict"""
        if obj is None:
            return None
