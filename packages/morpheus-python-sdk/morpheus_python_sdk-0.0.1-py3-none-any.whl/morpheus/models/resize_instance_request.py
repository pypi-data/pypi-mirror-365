...
class ResizeInstanceRequest(BaseModel):
    """
    ResizeInstanceRequest
    """ # noqa: E501
    instance: Optional[ResizeInstanceRequestInstance] = None
    ...
    volumes: Optional[List[AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigVolumesInner]] = Field(default=None, description="Can be used to grow just the logical volume of the instance instead of choosing a plan")
    ...
    network_interfaces: Optional[List[AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigNetworkInterfacesInner]] = Field(default=None, description="Key for network configuration. Include id to update an existing interface. The existing interfaces and their id can be retrieved with the hosts API.", alias="networkInterfaces")
    __properties: ClassVar[List[str]] = ["instance", "servicePlanOptions", "volumes", "deleteOriginalVolumes", "networkInterfaces"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResizeInstanceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResizeInstanceRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "instance": ResizeInstanceRequestInstance.from_dict(obj["instance"]) if obj.get("instance") is not None else None,
