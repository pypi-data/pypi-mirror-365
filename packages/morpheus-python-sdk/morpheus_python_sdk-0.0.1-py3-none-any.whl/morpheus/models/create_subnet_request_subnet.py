...
class CreateSubnetRequestSubnet(BaseModel):
    """
    CreateSubnetRequestSubnet
    """ # noqa: E501
    type: Optional[CreateSubnetRequestSubnetType] = None
    config: Optional[Dict[str, Any]] = Field(default=None, description="Configuration object. Settings vary by type.")
    tenants: Optional[List[GetAlerts200ResponseAllOfChecksInnerAccount]] = Field(default=None, description="Array of tenant account ID objects that are allowed access")
    ...
    __properties: ClassVar[List[str]] = ["type", "config", "tenants", "visibility", "labels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSubnetRequestSubnet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSubnetRequestSubnet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": CreateSubnetRequestSubnetType.from_dict(obj["type"]) if obj.get("type") is not None else None,
