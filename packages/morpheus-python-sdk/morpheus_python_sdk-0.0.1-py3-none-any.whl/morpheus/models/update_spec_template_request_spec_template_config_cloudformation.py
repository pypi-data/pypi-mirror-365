...
class UpdateSpecTemplateRequestSpecTemplateConfigCloudformation(BaseModel):
    """
    UpdateSpecTemplateRequestSpecTemplateConfigCloudformation
    """ # noqa: E501
    iam: Optional[AddSpecTemplateRequestSpecTemplateConfigCloudformationIAM] = Field(default=None, alias="IAM")
    capability_named_iam: Optional[AddSpecTemplateRequestSpecTemplateConfigCloudformationCAPABILITYNAMEDIAM] = Field(default=None, alias="CAPABILITY_NAMED_IAM")
    capability_auto_expand: Optional[AddSpecTemplateRequestSpecTemplateConfigCloudformationCAPABILITYAUTOEXPAND] = Field(default=None, alias="CAPABILITY_AUTO_EXPAND")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSpecTemplateRequestSpecTemplateConfigCloudformation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSpecTemplateRequestSpecTemplateConfigCloudformation from a dict"""
        if obj is None:
            return None
