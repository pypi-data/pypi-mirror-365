...
class ListStorageVolumes200Response(BaseModel):
    """
    ListStorageVolumes200Response
    """ # noqa: E501
    storage_volumes: Optional[List[ListClusterVolumes200ResponseAllOfVolumesInner]] = Field(default=None, alias="storageVolumes")
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    __properties: ClassVar[List[str]] = ["storageVolumes", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListStorageVolumes200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListStorageVolumes200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "storageVolumes": [ListClusterVolumes200ResponseAllOfVolumesInner.from_dict(_item) for _item in obj["storageVolumes"]] if obj.get("storageVolumes") is not None else None,
