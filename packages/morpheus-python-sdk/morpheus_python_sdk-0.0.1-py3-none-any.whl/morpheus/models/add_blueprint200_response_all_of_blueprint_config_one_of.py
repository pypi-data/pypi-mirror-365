...
class AddBlueprint200ResponseAllOfBlueprintConfigOneOf(BaseModel):
    """
    ...
    arm: Optional[AddBlueprintRequestOneOfArm] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "type", "arm", "visibility", "resourcePermission", "owner", "tenant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf from a dict"""
        if obj is None:
            return None
