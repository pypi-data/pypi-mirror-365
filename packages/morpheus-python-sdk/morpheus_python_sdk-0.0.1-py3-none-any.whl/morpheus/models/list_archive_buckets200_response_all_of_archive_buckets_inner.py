...
class ListArchiveBuckets200ResponseAllOfArchiveBucketsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListArchiveBuckets200ResponseAllOfArchiveBucketsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListArchiveBuckets200ResponseAllOfArchiveBucketsInner from a dict"""
        if obj is None:
            return None
