...
class ListServicePlans200ResponseAllOfServicePlansInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "active", "sortOrder", "description", "maxStorage", "maxMemory", "maxCpu", "maxCores", "maxDisks", "coresPerSocket", "customCpu", "customCores", "customMaxStorage", "customMaxDataStorage", "customMaxMemory", "addVolumes", "memoryOptionSource", "cpuOptionSource", "dateCreated", "lastUpdated", "regionCode", "visibility", "editable", "provisionType", "tenants", "priceSets", "config", "zones"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListServicePlans200ResponseAllOfServicePlansInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListServicePlans200ResponseAllOfServicePlansInner from a dict"""
        if obj is None:
            return None
