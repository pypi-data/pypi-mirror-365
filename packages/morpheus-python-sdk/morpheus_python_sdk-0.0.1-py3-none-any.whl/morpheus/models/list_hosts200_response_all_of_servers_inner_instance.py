...
class ListHosts200ResponseAllOfServersInnerInstance(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "displayName", "isVpcSelectable", "accountId", "accountName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListHosts200ResponseAllOfServersInnerInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListHosts200ResponseAllOfServersInnerInstance from a dict"""
        if obj is None:
            return None
