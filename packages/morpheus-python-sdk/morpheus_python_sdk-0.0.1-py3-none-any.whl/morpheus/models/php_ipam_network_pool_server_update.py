...
class PhpIPAMNetworkPoolServerUpdate(BaseModel):
    """
    ...
    config: Optional[PhpIPAMNetworkPoolServerUpdateConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhpIPAMNetworkPoolServerUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhpIPAMNetworkPoolServerUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": PhpIPAMNetworkPoolServerUpdateConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
