...
class ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInner(BaseModel):
    """
    ...
    usages: Optional[List[ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInnerUsagesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["refType", "refUUID", "refId", "startDate", "endDate", "cost", "price", "numUnits", "unit", "currency", "usages", "numUsages", "totalUsages", "hasMoreUsages", "foundPricing", "name", "serverId", "serverUUID", "serverUniqueId", "serverExternalId", "serverInternalId", "resourcePoolId", "resourcePoolName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "usages": [ListBillingInstances200ResponseAllOfBillingInfoInstancesInnerContainersInnerUsagesInner.from_dict(_item) for _item in obj["usages"]] if obj.get("usages") is not None else None,
