...
class AddPreseedScript200Response(BaseModel):
    """
    AddPreseedScript200Response
    """ # noqa: E501
    preseed_script: Optional[ListPreseedScripts200ResponseAllOfPreseedScriptsInner] = Field(default=None, alias="preseedScript")
    ...
    __properties: ClassVar[List[str]] = ["preseedScript", "errorCode", "success", "msg", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddPreseedScript200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddPreseedScript200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "preseedScript": ListPreseedScripts200ResponseAllOfPreseedScriptsInner.from_dict(obj["preseedScript"]) if obj.get("preseedScript") is not None else None,
