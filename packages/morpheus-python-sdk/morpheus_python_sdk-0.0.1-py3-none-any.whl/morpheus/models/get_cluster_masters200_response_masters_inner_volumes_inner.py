...
class GetClusterMasters200ResponseMastersInnerVolumesInner(BaseModel):
    """
    GetClusterMasters200ResponseMastersInnerVolumesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    controller_id: Optional[StrictStr] = Field(default=None, alias="controllerId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetClusterMasters200ResponseMastersInnerVolumesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetClusterMasters200ResponseMastersInnerVolumesInner from a dict"""
        if obj is None:
            return None
