...
class UpdateSecurityGroupsRequestSecurityGroup(BaseModel):
    """
    UpdateSecurityGroupsRequestSecurityGroup
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name for your security group")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "active", "tenantPermissions", "resourcePermissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSecurityGroupsRequestSecurityGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSecurityGroupsRequestSecurityGroup from a dict"""
        if obj is None:
            return None
