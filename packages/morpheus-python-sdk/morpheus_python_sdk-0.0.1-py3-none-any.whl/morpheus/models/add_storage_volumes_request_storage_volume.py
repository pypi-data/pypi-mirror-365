...
class AddStorageVolumesRequestStorageVolume(BaseModel):
    """
    AddStorageVolumesRequestStorageVolume
    """ # noqa: E501
    name: StrictStr = Field(description="A unique name scoped to your account for the storage volume")
    type: StrictStr = Field(description="Storage Type Code or ID")
    config: Optional[Dict[str, Any]] = Field(default=None, description="Configuration object with parameters that vary by `type`.")
    storage_server: AddClusterLayoutsRequestLayoutMastersInnerContainerType = Field(alias="storageServer")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddStorageVolumesRequestStorageVolume from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddStorageVolumesRequestStorageVolume from a dict"""
        if obj is None:
            return None
