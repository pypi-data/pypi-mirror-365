...
class GetNetworkGroups200ResponseNetworkGroupsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "visibility", "active", "networks", "subnets", "tenants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkGroups200ResponseNetworkGroupsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkGroups200ResponseNetworkGroupsInner from a dict"""
        if obj is None:
            return None
