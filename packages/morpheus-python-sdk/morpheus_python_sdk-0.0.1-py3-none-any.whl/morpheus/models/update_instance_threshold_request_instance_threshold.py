...
class UpdateInstanceThresholdRequestInstanceThreshold(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["autoUp", "autoDown", "minCount", "maxCount", "cpuEnabled", "minCpu", "maxCpu", "memoryEnabled", "minMemory", "maxMemory", "diskEnabled", "minDisk", "maxDisk"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateInstanceThresholdRequestInstanceThreshold from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateInstanceThresholdRequestInstanceThreshold from a dict"""
        if obj is None:
            return None
