...
class ResetPasswordRequest(BaseModel):
    ...
    """ # noqa: E501
    token: StrictStr = Field(description="The secret Reset Password token that was included in the **Forgot Password Email**.")
    password: SecretStr = Field(description="User new password. This is the new password for your user.")
