...
class ListArchiveFiles200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["archiveBucket", "isOwner", "parentDirectory", "archiveFiles", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListArchiveFiles200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListArchiveFiles200Response from a dict"""
        if obj is None:
            return None
