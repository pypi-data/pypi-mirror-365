...
class AddChecksRequestCheckOneOfConfigAllOfAnyOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sshPort", "checkUser", "tunnelOn", "textCheckOn", "checkPassword", "sshHost", "sshUser", "webTextMatch", "checkPasswordHash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOfConfigAllOfAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOfConfigAllOfAnyOf from a dict"""
        if obj is None:
            return None
