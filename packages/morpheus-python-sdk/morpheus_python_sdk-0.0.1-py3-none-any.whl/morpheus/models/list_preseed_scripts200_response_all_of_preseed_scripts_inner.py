...
class ListPreseedScripts200ResponseAllOfPreseedScriptsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "account", "fileName", "description", "content", "createdBy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPreseedScripts200ResponseAllOfPreseedScriptsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPreseedScripts200ResponseAllOfPreseedScriptsInner from a dict"""
        if obj is None:
            return None
