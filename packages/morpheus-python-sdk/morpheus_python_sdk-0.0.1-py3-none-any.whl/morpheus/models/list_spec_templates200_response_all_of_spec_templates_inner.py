...
class ListSpecTemplates200ResponseAllOfSpecTemplatesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSpecTemplates200ResponseAllOfSpecTemplatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSpecTemplates200ResponseAllOfSpecTemplatesInner from a dict"""
        if obj is None:
            return None
