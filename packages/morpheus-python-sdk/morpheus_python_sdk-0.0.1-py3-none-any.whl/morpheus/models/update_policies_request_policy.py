...
class UpdatePoliciesRequestPolicy(BaseModel):
    """
    ...
    config: Optional[UpdatePoliciesRequestPolicyConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "config", "enabled", "refType", "refId", "accounts", "eachUser"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePoliciesRequestPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePoliciesRequestPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": UpdatePoliciesRequestPolicyConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
