...
class ListOptionForms200ResponseAllOfOptionTypesInner(BaseModel):
    """
    ...
    field_groups: Optional[List[ListOptionForms200ResponseAllOfOptionTypesInnerFieldGroupsInner]] = Field(default=None, alias="fieldGroups")
    __properties: ClassVar[List[str]] = ["id", "name", "code", "description", "context", "locked", "labels", "options", "fieldGroups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListOptionForms200ResponseAllOfOptionTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListOptionForms200ResponseAllOfOptionTypesInner from a dict"""
        if obj is None:
            return None
