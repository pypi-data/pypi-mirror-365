...
class ListTasks200ResponseAllOfTasksInnerAnyOf3TaskOptions(BaseModel):
    """
    ...
    email_skip_template: Optional[StrictStr] = Field(default=None, alias="emailSkipTemplate")
    ...
    __properties: ClassVar[List[str]] = ["localScriptGitId", "emailSkipTemplate", "username", "emailSubject", "host", "password", "passwordHash", "emailAddress", "port", "sshKey", "localScriptGitRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf3TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if email_skip_template (nullable) is None
        # and model_fields_set contains the field
        if self.email_skip_template is None and "email_skip_template" in self.model_fields_set:
            _dict['emailSkipTemplate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf3TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "emailSkipTemplate": obj.get("emailSkipTemplate"),
