...
class ListTasks200ResponseAllOfTasksInnerAnyOf7TaskOptions(BaseModel):
    """
    ...
    container_script_id: Optional[StrictStr] = Field(default=None, alias="containerScriptId")
    ssh_key: Optional[StrictStr] = Field(default=None, alias="sshKey")
    container_script: Optional[StrictStr] = Field(default=None, alias="containerScript")
    port: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["host", "username", "password", "passwordHash", "localScriptGitRef", "localScriptGitId", "containerScriptId", "sshKey", "containerScript", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf7TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if container_script_id (nullable) is None
        # and model_fields_set contains the field
        if self.container_script_id is None and "container_script_id" in self.model_fields_set:
            _dict['containerScriptId'] = None
        ...
        # set to None if container_script (nullable) is None
        # and model_fields_set contains the field
        if self.container_script is None and "container_script" in self.model_fields_set:
            _dict['containerScript'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf7TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "containerScriptId": obj.get("containerScriptId"),
            "sshKey": obj.get("sshKey"),
            "containerScript": obj.get("containerScript"),
            "port": obj.get("port")
        })
