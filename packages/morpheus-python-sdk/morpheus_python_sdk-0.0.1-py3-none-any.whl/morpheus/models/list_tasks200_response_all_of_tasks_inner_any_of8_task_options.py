...
class ListTasks200ResponseAllOfTasksInnerAnyOf8TaskOptions(BaseModel):
    """
    ...
    container_template_id: Optional[StrictStr] = Field(default=None, alias="containerTemplateId")
    container_template: Optional[StrictStr] = Field(default=None, alias="containerTemplate")
    local_script_git_ref: Optional[StrictStr] = Field(default=None, alias="localScriptGitRef")
    host: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["username", "localScriptGitId", "sshKey", "port", "password", "passwordHash", "containerTemplateId", "containerTemplate", "localScriptGitRef", "host"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf8TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if container_template_id (nullable) is None
        # and model_fields_set contains the field
        if self.container_template_id is None and "container_template_id" in self.model_fields_set:
            _dict['containerTemplateId'] = None

        # set to None if container_template (nullable) is None
        # and model_fields_set contains the field
        if self.container_template is None and "container_template" in self.model_fields_set:
            _dict['containerTemplate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf8TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "containerTemplateId": obj.get("containerTemplateId"),
            "containerTemplate": obj.get("containerTemplate"),
