...
class NSXNetworkServerUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "serviceUrl", "serviceUsername", "servicePassword", "visibility", "tenants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NSXNetworkServerUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NSXNetworkServerUpdate from a dict"""
        if obj is None:
            return None
