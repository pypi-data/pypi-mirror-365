...
class FeatureServerCacheUsageMetadata(_message.Message):
    __slots__ = ["instance_type", "region", "replication_group_id"]
    ...
    def __init__(self, region: _Optional[str] = ..., instance_type: _Optional[str] = ..., replication_group_id: _Optional[str] = ...) -> None: ...
