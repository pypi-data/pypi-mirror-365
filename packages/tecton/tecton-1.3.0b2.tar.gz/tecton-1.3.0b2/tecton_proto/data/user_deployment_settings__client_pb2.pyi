...
class AwsSettings(_message.Message):
    __slots__ = ["compute_extra_tags", "dynamo_extra_tags", "dynamo_role", "dynamo_table_names", "ec2_settings", "ecr_settings", "elasticache_extra_tags", "elasticache_settings", "emr_settings", "object_store_locations"]
