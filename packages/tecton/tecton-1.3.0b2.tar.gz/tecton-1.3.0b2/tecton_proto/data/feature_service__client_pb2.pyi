...
class FeatureService(_message.Message):
    __slots__ = ["enable_online_caching", "fco_metadata", "feature_server_group", "feature_service_id", "feature_set_items", "logging", "online_serving_enabled", "options", "realtime_environment", "transform_server_group", "transform_server_group_id", "transform_server_group_name", "validation_args"]
