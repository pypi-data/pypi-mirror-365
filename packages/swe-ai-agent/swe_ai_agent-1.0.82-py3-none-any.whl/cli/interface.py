...
class SWEInterface:
    ...
    def __init__(self, settings: Settings):
        ...
        self.workflow = CleanSWEWorkflow(settings.repo_path, settings.output_dir, settings.use_planner, settings.enable_mcp, settings.show_diffs, settings.debug_mode)
