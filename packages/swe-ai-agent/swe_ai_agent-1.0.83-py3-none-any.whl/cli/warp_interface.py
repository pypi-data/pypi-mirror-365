...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'swe_agent'))
...
class WarpInterface:
    ...
    def __init__(self, repo_path: str = ".", output_dir: str = "output", enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = False, debug_mode: bool = False):
    ...
    def _initialize_workflow(self):
        ...
        try:
            self.workflow = CleanSWEWorkflow(
                ...
                no_shell_approval=self.no_shell_approval
            )
    ...
    def _create_command_panel(self) -> Panel:
        ...
        if self.ai_mode:
            prompt_text.append("🤖 AI: ", style="bright_magenta")
        else:
