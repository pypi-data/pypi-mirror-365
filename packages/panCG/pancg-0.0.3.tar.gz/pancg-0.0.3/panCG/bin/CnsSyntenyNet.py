...
def run_CNS_synteny_net(logger, panCns, cnsConfig, workDir, reference, geneWorkDir, geneConfig, args_dict):
    ...
    run_cnsMapMerge(logger, new_cnsConfig_file, workDir, geneWorkDir, geneConfig, reference, args_dict)
