...
class MyStart:
    ...
    def run_pangene(self):
        ...
        self.decorated_func(run_pangeneAssign, self.logger, self.logger, config, workDir, reference, args_dict)
    ...
    def run_pancns(self):
        ...
        self.decorated_func(run_pancnsAssign, self.logger, self.logger, config, workDir, reference, args_dict)
        self.decorated_func(run_pancnsMerge, self.logger, self.logger, config, workDir, reference, args_dict)
        self.decorated_func(run_cnsRecall, self.logger, self.logger, config, workDir, reference, args_dict)
        self.decorated_func(run_pancnsSort, self.logger, self.logger, config, workDir, reference)
