...
def parse_gff(longest_gff_file, out_gff_file):
    li = ["mRNA", "exon", "CDS"]
...
def run_callCNS(logger, config, workDir, Reference, args_dict):
    ...
    mafFilter_cmd = os.path.join(UCSC_PATH, "mafFilter")
    wigToBigWig_cmd = os.path.join(UCSC_PATH, "wigToBigWig")
    mafSplit_cmd = os.path.join(UCSC_PATH, "mafSplit")
    msa_view_cmd = os.path.join(PHAST_PATH, "msa_view")
    phyloFit_cmd = os.path.join(PHAST_PATH, "phyloFit")
    msa_split_cmd = os.path.join(PHAST_PATH, "msa_split")
    phastCons_cmd = os.path.join(PHAST_PATH, "phastCons")
    phyloBoot_cmd = os.path.join(PHAST_PATH, "phyloBoot")
