...
ABOUT = (
    ...
    "It supports seamless integration with OpenAI, Google, Groq, and Anthropic with more coming soon, and includes utilities for structured prompts,\n"
...
LEGAL_NOTICE = (
    ...
    "All AI models used with HoloAI (such as those from OpenAI, Google, Anthropic, Groq, etc.) are created, trained, and maintained by their respective providers.\n"
