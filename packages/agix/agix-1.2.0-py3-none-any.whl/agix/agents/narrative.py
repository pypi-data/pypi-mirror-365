...
from src.agix.memory.narrative import NarrativeMemoryTree, MemoryNode
...
class NarrativeAgent(AGIAgent):
    ...
    def __init__(self, k: int = 2, depth: int = 3, dim: int = 16):
        super().__init__(name="NarrativeAgent")
        self.memory = NarrativeMemoryTree(k=k, depth=depth)
