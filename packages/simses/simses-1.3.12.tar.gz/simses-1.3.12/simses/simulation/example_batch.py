...
from simses.simulation.batch import Batch


class ExampleBatch(Batch):
    def __init__(self, path, do_simulation=True, do_analysis=True) -> None:
        super().__init__(path, do_simulation=do_simulation, do_analysis=do_analysis)
    ...
    def set_analysis_config(self) -> ConfigParser:
...
if __name__ == "__main__":
    ...
    batch = ExampleBatch(path, do_analysis=True)
