...
df1.to_csv('cell_voltage_lookup_no_current_influence_on_part_pressure.csv', index=False)
...
df2.to_csv('cell_currentdensity_lookup_no_current_influence_on_part_pressure_with_alpha.csv', index=False)
