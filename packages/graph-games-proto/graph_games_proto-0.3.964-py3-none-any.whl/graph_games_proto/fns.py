...
def getinitialstate(game_config):
    ...
    return run_state_hooks(state, INITIALIZATION_HOOKS, True)
...
def default_after_accept_action(game, action):
    ...
    print("*&*&*&*&*& action.legal_action: ", action.legal_action)
    ...
    if player_idx < 0 or player_idx >= len(game.players):
        return game
    print("*&*&*&*&*& game.legal_actions_2 before: ", game.legal_actions_2)
    game.legal_actions_2 = [
        la for la in game.legal_actions_2 if la.player_idx != player_idx
    ]
    print("*&*&*&*&*& game.legal_actions_2 after: ", game.legal_actions_2)
...
def getnextstate2(s, a, log=False):
    ...
    return run_state_action_hooks(s, a, HANDLE_ACTION_HOOKS, log)
