...
class Player(PClass):
    faceup_cards = field(type=list)  # List[DeckCard]
    ...
    state = State(
        ...
        decks=[
            Deck(
                ...
                cards=[],
                cards=[
                    Card(uuid=str(uuid4()), is_wild=False, unit_idx=i) for i in range(gettotaldeckcards(fig))
                ],
            ),
            Deck(
                uuid=str(uuid4()),
                cards=[],
                cards=[
                    Card(uuid=str(uuid4()), is_wild=False, unit_idx=i) for i in range(getnumroutecards(fig))
                ],
            )
        ],
