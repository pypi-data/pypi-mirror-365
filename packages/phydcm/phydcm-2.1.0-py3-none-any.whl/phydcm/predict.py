...
class PyHDCMPredictor:
    def __init__(self, model_dir=None, img_size=(224, 224), scan_type_filter=None):
        # إذا لم يتم تحديد مسار، استخدم المسار الافتراضي داخل المكتبة
        if model_dir is None:
            # الحصول على مسار المجلد الحالي للمكتبة
...
if __name__ == "__main__":
    ...
    test_image_path = r"C:\Users\lenovo\Desktop\phydcm\data/pet/val/follicular_lymphoma/image_16.bmp"  # ← غيّره حسب بياناتك
