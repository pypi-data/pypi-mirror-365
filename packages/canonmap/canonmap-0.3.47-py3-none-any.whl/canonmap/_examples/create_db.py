...
def main():
    ...
    database_manager.create_database(database_name=database_to_create.database_name)

    #### CREATE NEW TABLE (with data) ####
    table_to_create = Table(table_name="test_table", database=database_to_create)
