...
from resource_manager import ConfigManager, DBView, ResourceDBFactory, ResourceRecord, ResourceDB, ID, NAME
from resource_manager_mmdetection.task import env_config
...
class DatasetResourceFactory(ResourceDBFactory[DatasetConfigManager, DatasetRecord, DatasetDB, DatasetDBView]):
    dir_path:Path = env_config.dataset_dir
