...
from rm.resource_db.config_manager import PathHandling_PropertyManager
...
@dataclass
class MainConfig_PropertyManager(PathHandling_PropertyManager):
    ...
    def config_file_path(self, value:Path)->None:
        self.set_as_absolute_path(MainConfig_PropertyKey.MAIN_CONFIG_FILE_PATH, value)
...
class MainConfigDB(ResourceDB[MainConfigRecord]):
    ...
    def create(self, name:NAME)->MainConfigRecord:
        ...
        record.property_manager.set(MainConfig_PropertyKey.MAIN_CONFIG_FILE_PATH, (record.dir_path / "main_config.py").as_posix())
        return record
...
class MainConfig_ResourceFactory(ResourceDBFactory[MainConfig_PropertyManager, MainConfigRecord, MainConfigDB, MainConfigDBView]):
    ...
    CONFIG_NAME:str = field(default="properties")