...
class TaskConfigManager(PathHandling_PropertyManager):
    ...
    def config_id(self)->ID:
        ...
        return get_root_factory().work_factory.resource_db.get(self.work_id).property_manager.config_id
    ...
    def mmdet_config_file_path(self)->Path:
        from mmdet_rm.factory import get_root_factory
        return get_root_factory().config_factory.resource_db.get(self.config_id).property_manager.config_file_path
