...
from mcp_python_analyzer.analyzers.ruff import RuffAnalyzer
from mcp_python_analyzer.analyzers.vulture import VultureAnalyzer
from mcp_python_analyzer.models import RuffCheckResult, VultureScanResult
...
class TestAnalyzers:
    ...
    def test_quality_score_calculation(self) -> None:
        ...
        from mcp_python_analyzer.server import _calculate_quality_score
