...
class BollingerModel:
    ...
    async def get_bollinger_bands(self, alpha_code:str=None, 
        ...
        try:
            ...
            logging.error(f"ERROR BollingerModel -> (get_bollinger_bands): {e}")
            return None
    ...
    async def get_bollinger_bands_multiple(self, alpha_codes: List[str] = None, 
        ...
        try:
            ...
            if not data_df_dict:
                logging.error("Failed to retrieve financial ratios.")
                return None
            ...
            logging.error(f"ERROR BollingerModel -> (get_bollinger_bands_multiple): {e}")
            return None
    ...
    async def _save_to_file(self, df:pd.DataFrame=None, alpha_code:str=None, k:int=None, window_size:int=None, is_ratio:bool=False) -> str | None:
        ...
        try:
            if df is None or alpha_code is None:
                logging.error("Missing required data or alpha_code.")
                return None
            ...
            logging.info(f"Saved file to {full_path}")

            return full_path

        except Exception as e:
            logging.error(f"ERROR BollingerModel -> (_save_to_file): {e}")
            return None
    ...
    async def get_financial_ratios(self, alpha_code:str=None, to_file:bool=False) -> pd.DataFrame | None:
        ...
        if alpha_code is None:
            logging.error(f"Company alpha_code not passed")
            return None
        ...
        try:
            ...
            if financial_ratios is None:
                logging.error(f'Error processing Financial ratios on alpha_code : {alpha_code}')
                return None
            ...
            logging.info("Dataframe added to model!")
            return data_df
        
        except Exception as e:
            logging.error(f"ERROR BollingerModel -> (get_financial_ratios): {e}")
            return None
    ...
    async def get_financial_ratios_multiple(self, alpha_codes:List[str]=None, to_file:bool=False) -> Dict[str, pd.DataFrame] | None:
        ...
        try:
            ...
            if financial_ratios_dict is None:
                logging.error(f'Error processing Financial ratios on alpha_codes')
                return False
            ...
            logging.error(f"ERROR BollingerModel -> (get_financial_ratios_multiple): {e}")
            return None