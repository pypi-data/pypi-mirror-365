 ...
 */
extern PyObject *modulecode_core_c(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"core_c", modulecode_core_c, 0, 0, NUITKA_TRANSLATED_FLAG
