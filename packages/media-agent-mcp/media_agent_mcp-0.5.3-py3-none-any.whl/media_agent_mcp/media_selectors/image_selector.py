...
→ Outpur: {{
    "reason": [
        {"image": "1", "reason": "1 is the most suitable image, as it aligns with the description", "score": "0.88"},
        {"image": "2", "reason": "the person in this image has three legs, which is not consistent with the description of a Nasi Padang takeaway box.", "score": "0.2"},
        {"image": "3", "reason": "The image's background is a busy street, which is not consistent with the description", "score": "0.1"}
    ],
    "choice": 0
}}
        """
