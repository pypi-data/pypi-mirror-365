...
@async_wrapper
@json_response_wrapper
def _sync_seededit(image_url: str, prompt: str, charactor_keep: str = 'false') -> str:
...
async def async_seededit_tool(image_url: str, prompt: str, charactor_keep: str = 'false') -> str:
